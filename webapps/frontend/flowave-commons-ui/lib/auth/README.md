...
require.config({
  ...
  paths: {
    ...
    'flowave-commons-ui':       'path/to/flowave-commons-ui/lib'
  },
  ...
  shim: {
    ...
    'flowave-commons-ui/util': ['angular'],
    'flowave-commons-ui/auth': ['flowave-commons-ui-util']
  },
