...
Common frontend / UI resources, widgets and libraries for the [Flowave web application][webapp]:
...
```
vim /flowave-commons-ui/node_modules/protractor/bin/webdriver-manager
```
Run chrome update for protractor
```
flowave-commons-ui/node_modules/protractor/bin/webdriver-manager --chrome update
```
