...
public class SessionCookieTest {
  ...
  public void shouldConfigureDefault() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches(headerRule.getSessionCookieRegex("fluxnova", "Lax", false));
  }
  ...
  public void shouldConfigureSecureEnabled() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches(headerRule.getSessionCookieRegex("fluxnova", "Lax", true));
  }
  ...
  public void shouldConfigureSameSiteDisabled() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches(headerRule.getSessionCookieRegex("fluxnova", null, false));
  }
  ...
  public void shouldConfigureSameSiteOptionStrict() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches(headerRule.getSessionCookieRegex("fluxnova", "Strict", false));
  }
  ...
  public void shouldConfigureSameSiteCustomValue() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches(headerRule.getSessionCookieRegex("fluxnova", "aCustomValue", false));
  }
  ...
  public void shouldConfigureCookieName() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches(headerRule.getSessionCookieRegex("fluxnova", "MYCOOKIENAME", "Lax", false));
  }
