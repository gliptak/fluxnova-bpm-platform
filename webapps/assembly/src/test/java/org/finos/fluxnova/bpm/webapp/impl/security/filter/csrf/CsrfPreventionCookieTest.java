...
public class CsrfPreventionCookieTest {
  ...
  public void shouldConfigureDefault() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches("XSRF-TOKEN=[A-Z0-9]{32};Path=/fluxnova;SameSite=Lax");
  }
  ...
  public void shouldConfigureSecureEnabled() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches("XSRF-TOKEN=[A-Z0-9]{32};Path=/fluxnova;SameSite=Lax;Secure");
  }
  ...
  public void shouldConfigureSameSiteDisabled() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches("XSRF-TOKEN=[A-Z0-9]{32};Path=/fluxnova");
  }
  ...
  public void shouldConfigureSameSiteOptionStrict() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches("XSRF-TOKEN=[A-Z0-9]{32};Path=/fluxnova;SameSite=Strict");
  }
  ...
  public void shouldConfigureSameSiteCustomValue() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches("XSRF-TOKEN=[A-Z0-9]{32};Path=/fluxnova;SameSite=aCustomValue");
  }
  ...
  public void shouldConfigureCookieName() {
    ...
    assertThat(headerRule.getCookieHeader())
      .matches("myCookieName=[A-Z0-9]{32};Path=/fluxnova;SameSite=Lax");
  }
