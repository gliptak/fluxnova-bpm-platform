 ...
 */
package org.finos.fluxnova.bpm.webapp.impl.util;
...
public class ServletContextUtil {
  ...
  protected static final String APP_PATH_ATTR_NAME =
    "org.finos.fluxnova.bpm.spring.boot.starter.webapp.applicationPath";

  protected static final String SUCCESSFUL_ET_ATTR_NAME =
    "org.finos.fluxnova.bpm.webapp.telemetry.data.stored";

  protected static final String AUTH_CACHE_TTL_ATTR_NAME =
    "org.finos.fluxnova.bpm.webapp.auth.cache.ttl";
