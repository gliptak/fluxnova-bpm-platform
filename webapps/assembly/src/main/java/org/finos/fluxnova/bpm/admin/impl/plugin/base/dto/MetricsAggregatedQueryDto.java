...
public class MetricsAggregatedQueryDto extends AbstractRestQueryParametersDto<MetricsAggregatedQueryDto> {
  ...
  @FluxnovaQueryParam(value = "metrics", converter = StringListConverter.class)
  ...
  @FluxnovaQueryParam(value = "subscriptionStartDate", converter = DateConverter.class)
  ...
  @FluxnovaQueryParam(value = "startDate", converter = DateConverter.class)
  public void setStartDate(Date startDate) {
    this.startDate = startDate;
  }

  @FluxnovaQueryParam(value = "endDate", converter = DateConverter.class)
