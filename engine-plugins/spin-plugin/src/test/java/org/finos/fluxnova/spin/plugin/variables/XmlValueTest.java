...
import org.finos.fluxnova.spin.plugin.variable.type.SpinValueType;
import org.finos.fluxnova.spin.plugin.variable.value.XmlValue;
...
public class XmlValueTest extends PluggableProcessEngineTestCase {
  ...
  public void testTransientXmlSpinVariables() {
    ...
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess("aProcess")
        .startEvent()
        .serviceTask()
          .fluxnovaClass(XmlDelegate.class)
        .userTask()
        .endEvent()
        .done();
