...
import org.finos.fluxnova.bpm.client.variable.impl.value.DeferredFileValueImpl;
import org.finos.fluxnova.bpm.client.variable.value.DeferredFileValue;
  ...
  public void shouldGetLocalAndGlobalVariables() {
    ...
    ProcessDefinitionDto processDefinitionDto = engineRule.deploy(
        ...
        .serviceTask("serviceTaskFoo")
          ...
          .fluxnovaInputParameter(LOCAL_VARIABLE_NAME_FILE, "${execution.getVariableTyped('fileVariable')}")
        .serviceTask("serviceTaskBar")
          .fluxnovaExternalTask(EXTERNAL_TASK_TOPIC_BAR)
        .endEvent("endEvent")
        .done()
    ).get(0);
