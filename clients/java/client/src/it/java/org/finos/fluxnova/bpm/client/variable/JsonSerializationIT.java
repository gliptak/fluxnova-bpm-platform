...
import static org.finos.fluxnova.bpm.engine.variable.Variables.SerializationDataFormats.JSON;
import static org.finos.fluxnova.bpm.engine.variable.type.ValueType.OBJECT;
...
public class JsonSerializationIT {
  ...
  public void shoudSetJsonListVariable() throws JSONException {
    ...
    assertThat(serializedValue.getType()).isEqualTo(OBJECT);
    assertThat(serializedValue.getObjectTypeName()).isEqualTo("java.util.ArrayList<org.finos.fluxnova.bpm.client.variable.JsonSerializable>");

    ObjectValue deserializedValue = task.getVariableTyped(VARIABLE_NAME_JSON);
    assertThat(deserializedValue.isDeserialized()).isTrue();
    assertThat(deserializedValue.getValue()).isEqualTo(variable);
    assertThat(deserializedValue.getType()).isEqualTo(OBJECT);
    assertThat(deserializedValue.getObjectTypeName()).isEqualTo("java.util.ArrayList<org.finos.fluxnova.bpm.client.variable.JsonSerializable>");
