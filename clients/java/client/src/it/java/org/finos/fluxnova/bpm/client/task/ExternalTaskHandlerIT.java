...
import static org.finos.fluxnova.bpm.client.rule.ClientRule.LOCK_DURATION;
import static org.finos.fluxnova.bpm.client.util.ProcessModels.BPMN_ERROR_EXTERNAL_TASK_PROCESS;
import static org.finos.fluxnova.bpm.client.util.ProcessModels.EXTERNAL_TASK_ID;
import static org.finos.fluxnova.bpm.client.util.ProcessModels.EXTERNAL_TASK_PRIORITY;
import static org.finos.fluxnova.bpm.client.util.ProcessModels.EXTERNAL_TASK_TOPIC_FOO;
import static org.finos.fluxnova.bpm.client.util.ProcessModels.PROCESS_KEY;
import static org.finos.fluxnova.bpm.client.util.ProcessModels.PROCESS_KEY_2;
import static org.finos.fluxnova.bpm.client.util.ProcessModels.USER_TASK_AFTER_BPMN_ERROR;
...
import org.finos.fluxnova.bpm.client.util.ProcessModels;
...
public class ExternalTaskHandlerIT {
  ...
  private void adjustProcessToAddErrorMessageVariable() {
    ...
    errorDefinition.setFluxnovaErrorMessageVariable("errorMessage");
  }
