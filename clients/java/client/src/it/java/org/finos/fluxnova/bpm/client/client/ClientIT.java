 ...
 */
package org.finos.fluxnova.bpm.client.client;
...
import static org.finos.fluxnova.bpm.client.util.ProcessModels.TWO_PRIORITISED_EXTERNAL_TASKS_PROCESS;
...
import org.finos.fluxnova.bpm.client.backoff.ErrorAwareBackoffStrategy;
import org.finos.fluxnova.bpm.client.dto.ProcessDefinitionDto;
import org.finos.fluxnova.bpm.client.exception.EngineException;
...
public class ClientIT {
  ...
  static {
    ...
    String engineRest = properties.getProperty(PropertyUtil.FLUXNOVA_ENGINE_REST);
    String engineName = properties.getProperty(PropertyUtil.FLUXNOVA_ENGINE_NAME);
