...
import org.finos.fluxnova.bpm.engine.rest.cache.Cache;
import org.finos.fluxnova.bpm.engine.rest.hal.Hal;
import org.finos.fluxnova.bpm.engine.rest.hal.HalLinkResolver;
import org.finos.fluxnova.bpm.engine.rest.hal.HalResource;
import org.finos.fluxnova.bpm.engine.rest.hal.cache.DefaultHalResourceCache;
import org.finos.fluxnova.bpm.engine.rest.hal.cache.HalRelationCacheBootstrap;
import org.finos.fluxnova.bpm.engine.rest.hal.cache.HalRelationCacheConfiguration;
import org.finos.fluxnova.bpm.engine.rest.hal.cache.HalRelationCacheConfigurationException;
...
public class HalResourceCacheTest extends AbstractRestServiceTest {
  ...
  public void testUnknownCacheImplementationClass() {
    try {
      contextListener.configureCaches("{\"" + CONFIG_CACHE_IMPLEMENTATION +"\": \"org.finos.fluxnova.bpm.UnknownCache\" }");
      fail("Exception expected");
    }
    catch (HalRelationCacheConfigurationException e) {
