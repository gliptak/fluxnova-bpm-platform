...
import org.finos.fluxnova.bpm.engine.ResourceReport;
...
import org.finos.fluxnova.bpm.engine.impl.bpmn.parser.ResourceReportImpl;
...
public class DeploymentRestServiceInteractionTest extends AbstractRestServiceTest {
  ...
  @Test
  public void testGetDeploymentFluxnovaFormResourceData() {
    Resource resource = MockProvider.createMockDeploymentFluxnovaFormResource();
