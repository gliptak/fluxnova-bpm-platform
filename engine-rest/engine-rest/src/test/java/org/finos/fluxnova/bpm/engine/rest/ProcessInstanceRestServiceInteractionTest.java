...
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_PROCESS_INSTANCE_COMMENT_FULL_MESSAGE;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_PROCESS_INSTANCE_COMMENT_ID;
...
import org.finos.fluxnova.bpm.engine.rest.dto.history.HistoricProcessInstanceDto;
...
import org.finos.fluxnova.bpm.engine.rest.helper.ExampleVariableObject;
...
import org.finos.fluxnova.bpm.engine.rest.util.JsonPathUtil;
...
import org.finos.fluxnova.bpm.engine.runtime.MessageCorrelationAsyncBuilder;
import org.finos.fluxnova.bpm.engine.runtime.ProcessInstance;
import org.finos.fluxnova.bpm.engine.runtime.ProcessInstanceModificationInstantiationBuilder;
...
import org.finos.fluxnova.bpm.engine.runtime.UpdateProcessInstanceSuspensionStateTenantBuilder;
import org.finos.fluxnova.bpm.engine.runtime.UpdateProcessInstancesSuspensionStateBuilder;
...
public class ProcessInstanceRestServiceInteractionTest extends AbstractRestServiceTest {
  ...
  public void testGetActivityInstanceTree() {
    ...
    assertEquals(13, response.jsonPath().getMap("").size(),
        "Should return right number of properties");
  }
