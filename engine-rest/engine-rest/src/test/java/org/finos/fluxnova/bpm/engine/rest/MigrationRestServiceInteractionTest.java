...
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_ACTIVITY_ID;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_PROCESS_DEFINITION_ID;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_PROCESS_INSTANCE_ID;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_ID;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOBS_PER_SEED;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOB_DEFINITION_ID;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TOTAL_JOBS;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TYPE;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_INVOCATIONS_PER_BATCH_JOB;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_MONITOR_JOB_DEFINITION_ID;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_SEED_JOB_DEFINITION_ID;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_TENANT_ID;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.NON_EXISTING_ACTIVITY_ID;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.NON_EXISTING_PROCESS_DEFINITION_ID;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.createMockBatch;
import static org.finos.fluxnova.bpm.engine.rest.helper.NoIntermediaryInvocation.immediatelyAfter;
import static org.assertj.core.api.Assertions.assertThat;
import static org.finos.fluxnova.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.*;
...
import org.finos.fluxnova.bpm.engine.migration.MigratingActivityInstanceValidationReport;
import org.finos.fluxnova.bpm.engine.migration.MigratingProcessInstanceValidationException;
import org.finos.fluxnova.bpm.engine.migration.MigratingProcessInstanceValidationReport;
...
import org.finos.fluxnova.bpm.engine.migration.MigrationPlanBuilder;
import org.finos.fluxnova.bpm.engine.migration.MigrationPlanExecutionBuilder;
...
import org.finos.fluxnova.bpm.engine.migration.MigrationVariableValidationReport;
import org.finos.fluxnova.bpm.engine.rest.dto.VariableValueDto;
import org.finos.fluxnova.bpm.engine.rest.dto.migration.MigrationInstructionDto;
import org.finos.fluxnova.bpm.engine.rest.dto.runtime.ProcessInstanceQueryDto;
import org.finos.fluxnova.bpm.engine.rest.helper.FluentAnswer;
import org.finos.fluxnova.bpm.engine.rest.helper.MockMigrationPlanBuilder;
import org.finos.fluxnova.bpm.engine.rest.helper.MockMigrationPlanBuilder.JoinedMigrationPlanBuilderMock;
import org.finos.fluxnova.bpm.engine.rest.util.container.TestContainerRule;
import org.finos.fluxnova.bpm.engine.rest.util.migration.MigrationExecutionDtoBuilder;
import org.finos.fluxnova.bpm.engine.rest.util.migration.MigrationPlanDtoBuilder;
...
import org.finos.fluxnova.bpm.engine.rest.util.migration.MigrationInstructionDtoBuilder;
