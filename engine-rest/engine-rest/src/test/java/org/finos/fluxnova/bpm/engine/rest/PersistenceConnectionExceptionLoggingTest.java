...
import static org.finos.fluxnova.bpm.engine.impl.util.ExceptionUtil.PERSISTENCE_EXCEPTION_MESSAGE;
import static org.finos.fluxnova.bpm.engine.impl.util.ExceptionUtil.wrapPersistenceException;
import static org.finos.fluxnova.bpm.engine.rest.exception.ExceptionLogger.REST_API;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_USER_FIRST_NAME;
