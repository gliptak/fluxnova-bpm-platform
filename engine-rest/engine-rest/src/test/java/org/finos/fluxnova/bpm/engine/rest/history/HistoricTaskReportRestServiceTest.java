...
import org.finos.fluxnova.bpm.engine.history.HistoricTaskInstanceReport;
...
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_END_TIME;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_DURATION_REPORT_AVG;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_DURATION_REPORT_MAX;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_DURATION_REPORT_MIN;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_DURATION_REPORT_PERIOD;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_END_TIME;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_START_TIME;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_COUNT;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_DEFINITION;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_PROC_DEFINITION;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_PROC_DEF_ID;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_PROC_DEF_NAME;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_TASK_NAME;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_START_TIME;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.EXAMPLE_TENANT_ID;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.createMockHistoricTaskInstanceDurationReport;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.createMockHistoricTaskInstanceReport;
import static org.finos.fluxnova.bpm.engine.rest.helper.MockProvider.createMockHistoricTaskInstanceReportWithProcDef;
