...
public class HistoricVariableInstanceQueryDto extends AbstractQueryDto<HistoricVariableInstanceQuery> {
  ...
  @FluxnovaQueryParam("variableValue")
  ...
  @FluxnovaQueryParam(value="caseActivityIdIn", converter = StringArrayConverter.class)
  ...
  @FluxnovaQueryParam(value = "includeDeleted", converter = BooleanConverter.class)
  public void setIncludeDeleted(boolean includeDeleted) {
    this.includeDeleted = includeDeleted;
  }

  @FluxnovaQueryParam(value = "variableNameIn", converter = StringArrayConverter.class)
