...
public class HistoricCaseActivityInstanceQueryDto extends AbstractQueryDto<HistoricCaseActivityInstanceQuery> {
  ...
  @FluxnovaQueryParam("caseActivityInstanceId")
  public void setCaseActivityInstanceId(String caseActivityInstanceId) {
    this.caseActivityInstanceId = caseActivityInstanceId;
  }

  @FluxnovaQueryParam(value = "caseActivityInstanceIdIn", converter = StringListConverter.class)
  ...
  @FluxnovaQueryParam(value = "endedBefore", converter = DateConverter.class)
  public void setEndedBefore(Date endedBefore) {
    this.endedBefore = endedBefore;
  }

  @FluxnovaQueryParam(value = "endedAfter", converter = DateConverter.class)
  public void setEndedAfter(Date endedAfter) {
    this.endedAfter = endedAfter;
  }

  @FluxnovaQueryParam(value = "required", converter = BooleanConverter.class)
  ...
  @FluxnovaQueryParam(value = "available", converter = BooleanConverter.class)
  public void setAvailable(Boolean available) {
    this.available = available;
  }

  @FluxnovaQueryParam(value = "enabled", converter = BooleanConverter.class)
  public void setEnabled(Boolean enabled) {
    this.enabled = enabled;
  }

  @FluxnovaQueryParam(value = "disabled", converter = BooleanConverter.class)
  ...
  @FluxnovaQueryParam(value = "terminated", converter = BooleanConverter.class)
