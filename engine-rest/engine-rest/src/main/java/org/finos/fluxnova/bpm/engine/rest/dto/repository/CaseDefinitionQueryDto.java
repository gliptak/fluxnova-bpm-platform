...
public class CaseDefinitionQueryDto extends AbstractQueryDto<CaseDefinitionQuery> {
  ...
  @FluxnovaQueryParam(value = "caseDefinitionIdIn", converter = StringListConverter.class)
  ...
  @FluxnovaQueryParam(value = "includeCaseDefinitionsWithoutTenantId", converter = BooleanConverter.class)
