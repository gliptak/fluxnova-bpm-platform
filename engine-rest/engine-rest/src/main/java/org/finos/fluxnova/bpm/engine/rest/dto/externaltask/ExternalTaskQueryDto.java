...
public class ExternalTaskQueryDto extends AbstractQueryDto<ExternalTaskQuery> {
  ...
  @FluxnovaQueryParam("externalTaskId")
  public void setExternalTaskId(String externalTaskId) {
    this.externalTaskId = externalTaskId;
  }

  @FluxnovaQueryParam(value = "externalTaskIdIn", converter = StringSetConverter.class)
  ...
  @FluxnovaQueryParam(value = "lockExpirationBefore", converter = DateConverter.class)
  public void setLockExpirationBefore(Date lockExpirationBefore) {
    this.lockExpirationBefore = lockExpirationBefore;
  }

  @FluxnovaQueryParam(value = "lockExpirationAfter", converter = DateConverter.class)
  public void setLockExpirationAfter(Date lockExpirationAfter) {
    this.lockExpirationAfter = lockExpirationAfter;
  }

  @FluxnovaQueryParam("topicName")
  public void setTopicName(String topicName) {
    this.topicName = topicName;
  }

  @FluxnovaQueryParam(value = "locked", converter = BooleanConverter.class)
  public void setLocked(Boolean locked) {
    this.locked = locked;
  }

  @FluxnovaQueryParam(value = "notLocked", converter = BooleanConverter.class)
  ...
  @FluxnovaQueryParam(value="processInstanceIdIn", converter = StringListConverter.class)
