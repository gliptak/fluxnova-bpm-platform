...
public class TaskQueryDto extends AbstractQueryDto<TaskQuery> {
  ...
  @FluxnovaQueryParam(value = "withTaskVariablesInReturn", converter = BooleanConverter.class)
  ...
  @FluxnovaQueryParam(value = "withTaskLocalVariablesInReturn", converter = BooleanConverter.class)
