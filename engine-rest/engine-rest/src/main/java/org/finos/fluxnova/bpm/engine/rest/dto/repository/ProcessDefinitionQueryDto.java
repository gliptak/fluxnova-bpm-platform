...
public class ProcessDefinitionQueryDto extends AbstractQueryDto<ProcessDefinitionQuery> {
  ...
  @FluxnovaQueryParam(value = "processDefinitionIdIn", converter = StringListConverter.class)
  public void setProcessDefinitionIdIn(List<String> processDefinitionIdIn) {
    this.processDefinitionIdIn = processDefinitionIdIn;
  }

  @FluxnovaQueryParam("category")
  public void setCategory(String category) {
    this.category = category;
  }

  @FluxnovaQueryParam("categoryLike")
  ...
  @FluxnovaQueryParam("deploymentId")
  public void setDeploymentId(String deploymentId) {
    this.deploymentId = deploymentId;
  }

  @FluxnovaQueryParam(value = "deployedAfter", converter = DateConverter.class)
  public void setDeployedAfter(Date deployedAfter) {
    this.deployedAfter = deployedAfter;
  }

  @FluxnovaQueryParam(value = "deployedAt", converter = DateConverter.class)
  ...
  @FluxnovaQueryParam(value = "keysIn", converter = StringListConverter.class)
   ...
   */
  @Deprecated
  @FluxnovaQueryParam(value = "ver", converter = IntegerConverter.class)
  public void setVer(Integer ver) {
    setVersion(ver);
  }

  @FluxnovaQueryParam(value = "version", converter = IntegerConverter.class)
   ...
   */
  @Deprecated
  @FluxnovaQueryParam(value = "latest", converter = BooleanConverter.class)
  public void setLatest(Boolean latest) {
    setLatestVersion(latest);
  }

  @FluxnovaQueryParam(value = "latestVersion", converter = BooleanConverter.class)
  public void setLatestVersion(Boolean latestVersion) {
    this.latestVersion = latestVersion;
  }

  @FluxnovaQueryParam("resourceName")
  public void setResourceName(String resourceName) {
    this.resourceName = resourceName;
  }

  @FluxnovaQueryParam("resourceNameLike")
  public void setResourceNameLike(String resourceNameLike) {
    this.resourceNameLike = resourceNameLike;
  }

  @FluxnovaQueryParam("startableBy")
  ...
  @FluxnovaQueryParam(value = "incidentId")
  ...
  @FluxnovaQueryParam(value = "includeProcessDefinitionsWithoutTenantId", converter = BooleanConverter.class)
