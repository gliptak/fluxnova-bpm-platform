...
public class JobDefinitionQueryDto extends AbstractQueryDto<JobDefinitionQuery> {
  ...
  @FluxnovaQueryParam("jobType")
  public void setJobType(String jobType) {
    this.jobType = jobType;
  }

  @FluxnovaQueryParam("jobConfiguration")
  ...
  @FluxnovaQueryParam(value="withOverridingJobPriority", converter = BooleanConverter.class)
  ...
  @FluxnovaQueryParam(value = "includeJobDefinitionsWithoutTenantId", converter = BooleanConverter.class)
