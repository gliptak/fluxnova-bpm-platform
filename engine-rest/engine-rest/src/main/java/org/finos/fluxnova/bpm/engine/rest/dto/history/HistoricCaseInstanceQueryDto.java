...
public class HistoricCaseInstanceQueryDto extends AbstractQueryDto<HistoricCaseInstanceQuery> {
  ...
  @FluxnovaQueryParam(value = "caseInstanceIds", converter = StringSetConverter.class)
  ...
  @FluxnovaQueryParam(value = "caseDefinitionKeyNotIn", converter = StringListConverter.class)
  ...
  @FluxnovaQueryParam(value = "closedBefore", converter = DateConverter.class)
  public void setClosedBefore(Date closedBefore) {
    this.closedBefore = closedBefore;
  }

  @FluxnovaQueryParam(value = "closedAfter", converter = DateConverter.class)
  ...
  @FluxnovaQueryParam(value = "closed", converter = BooleanConverter.class)
  public void setClosed(Boolean closed) {
    this.closed = closed;
  }

  @FluxnovaQueryParam(value = "notClosed", converter = BooleanConverter.class)
