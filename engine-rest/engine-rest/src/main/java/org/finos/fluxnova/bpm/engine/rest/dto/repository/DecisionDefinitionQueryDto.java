...
public class DecisionDefinitionQueryDto extends AbstractQueryDto<DecisionDefinitionQuery> {
  ...
  @FluxnovaQueryParam(value = "decisionDefinitionIdIn", converter = StringListConverter.class)
  ...
  @FluxnovaQueryParam(value = "withoutDecisionRequirementsDefinition", converter = BooleanConverter.class)
  ...
  @FluxnovaQueryParam(value = "includeDecisionDefinitionsWithoutTenantId", converter = BooleanConverter.class)
