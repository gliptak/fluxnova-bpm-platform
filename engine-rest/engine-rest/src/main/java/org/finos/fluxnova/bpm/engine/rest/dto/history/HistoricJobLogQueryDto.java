...
public class HistoricJobLogQueryDto extends AbstractQueryDto<HistoricJobLogQuery> {
  ...
  @FluxnovaQueryParam("jobExceptionMessage")
  ...
  @FluxnovaQueryParam(value="failedActivityIdIn", converter = StringArrayConverter.class)
  ...
  @FluxnovaQueryParam(value="creationLog", converter = BooleanConverter.class)
  public void setCreationLog(Boolean creationLog) {
    this.creationLog = creationLog;
  }

  @FluxnovaQueryParam(value="failureLog", converter = BooleanConverter.class)
  public void setFailureLog(Boolean failureLog) {
    this.failureLog = failureLog;
  }

  @FluxnovaQueryParam(value="successLog", converter = BooleanConverter.class)
  public void setSuccessLog(Boolean successLog) {
    this.successLog = successLog;
  }

  @FluxnovaQueryParam(value="deletionLog", converter = BooleanConverter.class)
  public void setDeletionLog(Boolean deletionLog) {
    this.deletionLog = deletionLog;
  }

  @FluxnovaQueryParam(value="jobPriorityHigherThanOrEquals", converter = LongConverter.class)
  ...
  @FluxnovaQueryParam(value="jobPriorityLowerThanOrEquals", converter = LongConverter.class)
  ...
  @FluxnovaQueryParam(value = "hostname")
