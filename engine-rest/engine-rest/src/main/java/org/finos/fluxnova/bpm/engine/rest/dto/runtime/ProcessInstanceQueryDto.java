...
public class ProcessInstanceQueryDto extends AbstractQueryDto<ProcessInstanceQuery> {
  ...
  @FluxnovaQueryParam("superProcessInstance")
  ...
  @FluxnovaQueryParam("subProcessInstance")
  ...
  @FluxnovaQueryParam("superCaseInstance")
  ...
  @FluxnovaQueryParam("subCaseInstance")
  ...
  @FluxnovaQueryParam(value = "leafProcessInstances", converter = BooleanConverter.class)
  ...
  @FluxnovaQueryParam(value = "processDefinitionWithoutTenantId", converter = BooleanConverter.class)
