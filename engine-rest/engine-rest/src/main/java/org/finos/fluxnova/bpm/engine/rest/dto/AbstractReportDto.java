...
import org.finos.fluxnova.bpm.engine.query.Report;
import org.finos.fluxnova.bpm.engine.rest.dto.converter.PeriodUnitConverter;
...
public abstract class AbstractReportDto<T extends Report> extends AbstractSearchQueryDto {
  ...
  @FluxnovaQueryParam(value = "periodUnit", converter = PeriodUnitConverter.class)
