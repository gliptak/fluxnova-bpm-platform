 ...
 */
package org.finos.fluxnova.bpm.engine.rest.dto.batch;
...
public class BatchStatisticsQueryDto extends AbstractQueryDto<BatchStatisticsQuery> {
  ...
  @FluxnovaQueryParam(value="createdBy")
  ...
  @FluxnovaQueryParam(value = "withFailures", converter = BooleanConverter.class)
  public void setWithFailures(final Boolean withFailures) {
    this.withFailures = withFailures;
  }

  @FluxnovaQueryParam(value = "withoutFailures", converter = BooleanConverter.class)
