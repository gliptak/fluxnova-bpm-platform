...
import org.finos.fluxnova.bpm.engine.rest.sub.task.TaskAttachmentResource;
...
public class TaskResourceImpl implements TaskResource {
  ...
  protected String getTaskFormMediaType(String taskId) {
    ...
    } else if(task.getFluxnovaFormRef() != null) {
      return ContentTypeUtil.getFormContentType(task.getFluxnovaFormRef());
    }
