 ...
 */
package org.finos.fluxnova.bpm.engine.rest.dto.authorization;
...
public class AuthorizationQueryDto extends AbstractQueryDto<AuthorizationQuery> {
  ...
  @FluxnovaQueryParam(value="type", converter = IntegerConverter.class)
  public void setType(Integer type) {
    this.type = type;
  }

  @FluxnovaQueryParam(value="userIdIn", converter = StringArrayConverter.class)
  public void setUserIdIn(String[] userIdIn) {
    this.userIdIn = userIdIn;
  }

  @FluxnovaQueryParam(value="groupIdIn", converter = StringArrayConverter.class)
  public void setGroupIdIn(String[] groupIdIn) {
    this.groupIdIn = groupIdIn;
  }

  @FluxnovaQueryParam(value="resourceType", converter = IntegerConverter.class)
  public void setResourceType(int resourceType) {
    this.resourceType = resourceType;
  }

  @FluxnovaQueryParam("resourceId")
