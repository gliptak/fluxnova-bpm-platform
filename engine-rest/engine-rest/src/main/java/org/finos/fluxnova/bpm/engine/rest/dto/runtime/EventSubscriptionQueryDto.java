...
public class EventSubscriptionQueryDto extends AbstractQueryDto<EventSubscriptionQuery> {
  ...
  @FluxnovaQueryParam("eventSubscriptionId")
  ...
  @FluxnovaQueryParam(value = "includeEventSubscriptionsWithoutTenantId", converter = BooleanConverter.class)
