...
import org.finos.fluxnova.bpm.engine.rest.history.HistoricActivityInstanceRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricProcessDefinitionRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricBatchRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricCaseActivityInstanceRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricCaseDefinitionRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricCaseInstanceRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricDecisionDefinitionRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricDecisionInstanceRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricDecisionStatisticsRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricDetailRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricExternalTaskLogRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricIdentityLinkLogRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricIncidentRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricJobLogRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricProcessInstanceRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricTaskInstanceRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoricVariableInstanceRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoryCleanupRestService;
import org.finos.fluxnova.bpm.engine.rest.history.HistoryRestService;
import org.finos.fluxnova.bpm.engine.rest.history.UserOperationLogRestService;
