...
public class UserOperationLogQueryDto extends AbstractQueryDto<UserOperationLogQuery> {
  ...
  @FluxnovaQueryParam("batchId")
  public void setBatchId(String batchId) {
    this.batchId = batchId;
  }

  @FluxnovaQueryParam("userId")
  public void setUserId(String userId) {
    this.userId = userId;
  }

  @FluxnovaQueryParam("operationId")
  ...
  @FluxnovaQueryParam("operationType")
  public void setOperationType(String operationType) {
    this.operationType = operationType;
  }

  @FluxnovaQueryParam("entityType")
  public void setEntityType(String entityType) {
    this.entityType = entityType;
  }

  @FluxnovaQueryParam(value = "entityTypeIn", converter = StringArrayConverter.class)
  ...
  @FluxnovaQueryParam(value = "categoryIn", converter = StringArrayConverter.class)
  public void setCategoryIn(String[] categories) {
    this.categories = categories;
  }
  
  @FluxnovaQueryParam("property")
  public void setProperty(String property) {
    this.property = property;
  }

  @FluxnovaQueryParam(value = "afterTimestamp", converter = DateConverter.class)
  public void setAfterTimestamp(Date after) {
    this.afterTimestamp = after;
  }

  @FluxnovaQueryParam(value = "beforeTimestamp", converter = DateConverter.class)
