...
<#-- Generated From File: fluxnova-docs-manual/public/reference/rest/execution/get-query/index.html -->
{
  <@lib.endpointInfo
      id = "getExecutions"
      tag = "Execution"
  ...
  "responses": {
    ...
    <@lib.response
        ...
        examples = ['"example-1": {
                       "summary": "Status 200.",
                       "description": "GET `/execution?variables=myVariable_eq_fluxnova`",
                       "value": [
                         {
                           "id": "anId",
