...
public abstract class AbstractPaLocalScriptEngineTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static final String DUMMY_SCRIPT_ENGINE_FACTORY_SPI = "org.finos.fluxnova.bpm.integrationtest.functional.scriptengine.engine.DummyScriptEngineFactory";
  ...
  protected static StringAsset createScriptTaskProcess(String scriptFormat, String scriptText) {
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess(PROCESS_ID)
      ...
      .scriptTask()
        ...
        .fluxnovaResultVariable("scriptValue")
        .userTask()
      .endEvent()
      .done();
