...
import org.finos.fluxnova.bpm.integrationtest.functional.context.beans.NoOpJavaDelegate;
import org.finos.fluxnova.bpm.integrationtest.functional.context.beans.SignalableTask;
...
public class InvocationContextTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createDeployment() {
    return ShrinkWrap.create(WebArchive.class, "app.war")
        ...
        .addAsResource("org/finos/fluxnova/bpm/integrationtest/functional/context/InvocationContextTest-timer.bpmn")
        .addAsResource("org/finos/fluxnova/bpm/integrationtest/functional/context/InvocationContextTest-message.bpmn")
        .addAsResource("org/finos/fluxnova/bpm/integrationtest/functional/context/InvocationContextTest-signalTask.bpmn");
  }
  ...
  public void testInvokeProcessApplicationWithContextOnStart() {
    ...
    assertNotNull(invocationContext);
    assertNotNull(invocationContext.getExecution());
    assertEquals(pi.getId(), invocationContext.getExecution().getId());
  }
  ...
  public void testInvokeProcessApplicationWithContextOnAsyncExecution() {
    ...
    assertNotNull(invocationContext);
    assertNotNull(invocationContext.getExecution());
    assertEquals(timer.getExecutionId(), invocationContext.getExecution().getId());
  }
  ...
  public void testInvokeProcessApplicationWithContextOnMessageReceived() {
    ...
    assertNotNull(messageSubscription);
    ...
    assertNotNull(invocationContext);
    assertNotNull(invocationContext.getExecution());
    assertEquals(messageSubscription.getExecutionId(), invocationContext.getExecution().getId());
  }
  ...
  public void testInvokeProcessApplicationWithContextOnSignalTask() {
    ...
    assertNotNull(invocationContext);
    assertNotNull(invocationContext.getExecution());
    assertEquals(execution.getId(), invocationContext.getExecution().getId());
  }
