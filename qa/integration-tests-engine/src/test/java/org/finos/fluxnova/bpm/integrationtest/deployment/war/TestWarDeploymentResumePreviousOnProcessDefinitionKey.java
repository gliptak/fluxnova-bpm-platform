...
public class TestWarDeploymentResumePreviousOnProcessDefinitionKey  extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive2() {
    return initWebArchiveDeployment("pa2.war", "org/finos/fluxnova/bpm/integrationtest/deployment/war/resumePreviousVersionsOnProcessDefinitionKey_processes.xml")
