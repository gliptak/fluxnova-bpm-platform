 ...
 */
public class XmlSerializableJsonDeserializer extends ValueDeserializer<XmlSerializable> {

  @Override
  public XmlSerializable deserialize(JsonParser p, DeserializationContext ctxt) throws JacksonException {
