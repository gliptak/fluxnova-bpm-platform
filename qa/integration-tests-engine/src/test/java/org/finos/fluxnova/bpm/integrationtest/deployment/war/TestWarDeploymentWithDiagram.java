...
public class TestWarDeploymentWithDiagram extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {    
    return initWebArchiveDeployment()
            ...
            .addAsResource("org/finos/fluxnova/bpm/integrationtest/testDeployProcessArchive.png")
            .addAsResource("org/finos/fluxnova/bpm/integrationtest/invoice-it.bpmn20.xml")
            .addAsResource("org/finos/fluxnova/bpm/integrationtest/invoice-it.jpg");
  }
  
  @Test
  public void testDeployProcessArchive() throws IOException {
    String expectedDiagramResource = "/org/finos/fluxnova/bpm/integrationtest/testDeployProcessArchive.png";
  ...
  public void testInvoiceProcess() throws IOException {
    String expectedDiagramResource = "/org/finos/fluxnova/bpm/integrationtest/invoice-it.jpg";
