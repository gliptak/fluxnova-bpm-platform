...
public class DelegatedVariableMappingTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeplyoment() {
    WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "mainDeployment.war")
        ...
        .addAsResource("org/finos/fluxnova/bpm/integrationtest/functional/delegation/DelegatedVariableMappingTest.testCallSubProcessWithDelegatedVariableMapping.bpmn20.xml")
        .addAsResource("org/finos/fluxnova/bpm/integrationtest/functional/delegation/DelegatedVariableMappingTest.testCallSubProcessWithDelegatedVariableMappingExpression.bpmn20.xml");
  ...
  public static WebArchive createSecondProcessArchiveDeployment() {
    WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "calledDeployment.war")
        ...
        .addClass(AbstractFoxPlatformIntegrationTest.class)
        .addClass(TestConstants.class)
        .addAsResource("org/finos/fluxnova/bpm/integrationtest/functional/delegation/simpleSubProcess.bpmn20.xml");
