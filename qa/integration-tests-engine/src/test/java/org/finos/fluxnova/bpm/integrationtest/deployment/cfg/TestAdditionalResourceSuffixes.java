...
public class TestAdditionalResourceSuffixes extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    ...
    WebArchive archive = ShrinkWrap.create(WebArchive.class, "test.war")
        ...
        .addAsResource("org/finos/fluxnova/bpm/integrationtest/deployment/cfg/processes-additional-resource-suffixes.xml", "META-INF/processes.xml")
        ...
        .addAsResource("org/finos/fluxnova/bpm/integrationtest/deployment/cfg/hello.groovy")
        .addAsResource("org/finos/fluxnova/bpm/integrationtest/deployment/cfg/hello.py");
