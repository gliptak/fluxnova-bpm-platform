 ...
 */
package org.finos.fluxnova.bpm.qa.performance.engine.bpmn;

import static org.finos.fluxnova.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE1;
import static org.finos.fluxnova.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE10;
import static org.finos.fluxnova.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE2;
import static org.finos.fluxnova.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE3;
import static org.finos.fluxnova.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE4;
import static org.finos.fluxnova.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE5;
import static org.finos.fluxnova.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE6;
import static org.finos.fluxnova.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE7;
import static org.finos.fluxnova.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE8;
import static org.finos.fluxnova.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE9;
...
public class VariablesPerformanceTest extends ProcessEnginePerformanceTestCase {
  ...
  @Deployment(resources =
    {"org/finos/fluxnova/bpm/qa/performance/engine/bpmn/StartEventPerformanceTest.noneStartEvent.bpmn"})
