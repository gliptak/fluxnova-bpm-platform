= flowave BPMN model API  ** Needs To Be Reviewed **

The flowave BPMN model API is a simple, lightweight Java library for parsing, creating and editing BPMN 2.0 XML files. It is licensed under the Apache 2.0 license.

[NOTE]
====
flowave BPMN model can be used standalone, independenly of Flowave Platform / process engine.
====
...
and can be executed by the Flowave Platform.
...
the tests in link:src/test/java/org/finos/flowave/bpm/model/bpmn/builder/ProcessBuilderTest.java[ProcessBuilderTest.java] or this   ** Needs To Be Reviewed **
...
link:src/test/java/org/finos/flowave/bpm/model/bpmn/CreateModelTest.java[CreateModelTest.java].
...
Java JRE 1.8+ is required. We test flowave BPMN model API on Oracle and IBM JVMs.

=== Does this API support all BPMN 2.0 Elements?

No, but support is already quite extensive. See
link:src/main/java/org/finos/flowave/bpm/model/bpmn/instance[org.finos.flowave.bpm.model.bpmn.instance]
