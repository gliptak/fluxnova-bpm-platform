...
public class ConditionalSequenceFlowTest {
  ...
  public void shouldHaveResource() {
    assertThat(conditionExpression1.getFluxnovaResource()).isNull();
    assertThat(conditionExpression2.getFluxnovaResource()).isNull();
    assertThat(conditionExpression3.getFluxnovaResource()).isEqualTo("test.groovy");
  }
