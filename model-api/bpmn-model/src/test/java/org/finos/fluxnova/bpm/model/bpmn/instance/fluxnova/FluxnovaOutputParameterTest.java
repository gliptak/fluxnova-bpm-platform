 ...
 */
public class FluxnovaOutputParameterTest extends BpmnModelElementInstanceTest {
  ...
  public void testOutputParameterScriptChildAssignment() {
    try {
      FluxnovaOutputParameter outputParamElement = modelInstance.newInstance(FluxnovaOutputParameter.class);
      outputParamElement.setFluxnovaName("aVariable");

      FluxnovaScript scriptElement = modelInstance.newInstance(FluxnovaScript.class);
      scriptElement.setFluxnovaScriptFormat("juel");
  ...
  public void testOutputParameterMapChildAssignment() {
    try {
      ...
      FluxnovaMap listElement = modelInstance.newInstance(FluxnovaMap.class);
