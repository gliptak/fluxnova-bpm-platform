 ...
 */
public class FluxnovaInputParameterTest extends BpmnModelElementInstanceTest {
  ...
  public void testIntputParameterScriptChildAssignment() {
    try {
      FluxnovaInputParameter inputParamElement = modelInstance.newInstance(FluxnovaInputParameter.class);
      inputParamElement.setFluxnovaName("aVariable");
