...
import org.finos.fluxnova.bpm.model.bpmn.instance.RootElement;
...
public class ProcessTest extends BpmnModelTest {
  ...
  public void shouldImportProcess() {
    ...
    org.finos.fluxnova.bpm.model.bpmn.instance.Process process = (Process) rootElements.iterator().next();
