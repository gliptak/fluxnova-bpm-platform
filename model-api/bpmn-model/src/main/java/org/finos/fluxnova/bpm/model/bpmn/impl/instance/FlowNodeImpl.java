...
import org.finos.fluxnova.bpm.model.xml.type.reference.ElementReferenceCollection;
import org.finos.fluxnova.bpm.model.xml.type.reference.Reference;
...
public abstract class FlowNodeImpl extends FlowElementImpl implements FlowNode {
  ...
  public boolean isFluxnovaAsyncBefore() {
    return camundaAsyncBefore.getValue(this);
  }

  public void setFluxnovaAsyncBefore(boolean isCamundaAsyncBefore) {
    camundaAsyncBefore.setValue(this, isCamundaAsyncBefore);
  }

  public boolean isFluxnovaAsyncAfter() {
    return camundaAsyncAfter.getValue(this);
  }

  public void setFluxnovaAsyncAfter(boolean isCamundaAsyncAfter) {
    camundaAsyncAfter.setValue(this, isCamundaAsyncAfter);
  }

  public boolean isFluxnovaExclusive() {
    return camundaExclusive.getValue(this);
  }

  public void setFluxnovaExclusive(boolean isCamundaExclusive) {
    camundaExclusive.setValue(this, isCamundaExclusive);
  }

  public String getFluxnovaJobPriority() {
    return camundaJobPriority.getValue(this);
  }

  public void setFluxnovaJobPriority(String jobPriority) {
