...
public abstract class AbstractFlowNodeBuilder<B extends AbstractFlowNodeBuilder<B, E>, E extends FlowNode> extends AbstractFlowElementBuilder<B, E> {
   ...
   */
  public B fluxnovaAsyncBefore(boolean asyncBefore) {
    element.setFluxnovaAsyncBefore(asyncBefore);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaAsyncAfter(boolean asyncAfter) {
    element.setFluxnovaAsyncAfter(asyncAfter);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaAsyncAfter() {
    element.setFluxnovaAsyncAfter(true);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B notFluxnovaExclusive() {
    element.setFluxnovaExclusive(false);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaExclusive(boolean exclusive) {
    element.setFluxnovaExclusive(exclusive);
    return myself;
  }

  public B fluxnovaJobPriority(String jobPriority) {
    element.setFluxnovaJobPriority(jobPriority);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaFailedJobRetryTimeCycle(String retryTimeCycle) {
    FluxnovaFailedJobRetryTimeCycle failedJobRetryTimeCycle = createInstance(FluxnovaFailedJobRetryTimeCycle.class);
  ...
  @SuppressWarnings("rawtypes")
  public B fluxnovaExecutionListenerClass(String eventName, Class listenerClass) {
    return fluxnovaExecutionListenerClass(eventName, listenerClass.getName());
  }

  public B fluxnovaExecutionListenerClass(String eventName, String fullQualifiedClassName) {
    FluxnovaExecutionListener executionListener = createInstance(FluxnovaExecutionListener.class);
  ...
  public B fluxnovaExecutionListenerExpression(String eventName, String expression) {
    FluxnovaExecutionListener executionListener = createInstance(FluxnovaExecutionListener.class);
    executionListener.setFluxnovaEvent(eventName);
  ...
  public B fluxnovaExecutionListenerDelegateExpression(String eventName, String delegateExpression) {
    FluxnovaExecutionListener executionListener = createInstance(FluxnovaExecutionListener.class);
    executionListener.setFluxnovaEvent(eventName);
