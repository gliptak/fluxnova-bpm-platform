 ...
 */
package org.finos.fluxnova.bpm.model.xml.validation;

import java.io.StringWriter;
import java.util.Formatter;

import org.finos.fluxnova.bpm.model.xml.instance.ModelElementInstance;
import org.finos.fluxnova.bpm.model.xml.testmodel.instance.FlyingAnimal;
...
public class TestResultFormatter implements ValidationResultFormatter {
  ...
  public void formatElement(StringWriter writer, ModelElementInstance element) {
    ...
    if (element instanceof FlyingAnimal animal) {
      formatter.format("%s\n", animal.getId());
    } else {
