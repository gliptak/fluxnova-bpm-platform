 ...
 */
package org.finos.fluxnova.bpm.model.xml.instance;
...
import org.finos.fluxnova.bpm.model.xml.testmodel.instance.Description;
...
public class DomTest extends TestModelTest {
  ...
  public DomTest() {
    super("parsed", parseModel(DomTest.class));
  }
