 ...
 */
package org.finos.fluxnova.bpm.model.xml.impl.instance;

import org.finos.fluxnova.bpm.model.xml.ModelException;
import org.finos.fluxnova.bpm.model.xml.impl.ModelInstanceImpl;
import org.finos.fluxnova.bpm.model.xml.impl.util.DomUtil;
import org.finos.fluxnova.bpm.model.xml.impl.util.XmlQName;
...
public class DomElementImpl implements DomElement {
  ...
  public DomElement getParentElement() {
    synchronized(document) {
      ...
      if (parentNode != null && parentNode instanceof Element element1) {
        return new DomElementImpl(element1);
      }
      else {
        return null;
      }
