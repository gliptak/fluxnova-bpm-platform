 ...
 */
package org.finos.fluxnova.bpm.run.test.config.cors;
...
@TestPropertySource(properties = {
    FluxnovaBpmRunCorsProperty.PREFIX + ".allowed-origins=http://other.origin:8081",
    FluxnovaBpmRunCorsProperty.PREFIX + ".allow-credentials=true"})
