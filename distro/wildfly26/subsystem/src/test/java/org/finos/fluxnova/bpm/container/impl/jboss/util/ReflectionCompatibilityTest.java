 ...
 */
package org.finos.fluxnova.bpm.container.impl.jboss.util;
...
public class ReflectionCompatibilityTest {
  ...
  public void reflectionAccessOnFieldValueTypesWorks() {
    ...
    StandardResourceDescriptionResolver testStandardResourceDescriptionResolver = new StandardResourceDescriptionResolver("fluxnova-bpm-platform",
            BpmPlatformExtension.class.getPackage().getName() + ".TestLocalDescriptions", BpmPlatformExtension.class.getClassLoader());
