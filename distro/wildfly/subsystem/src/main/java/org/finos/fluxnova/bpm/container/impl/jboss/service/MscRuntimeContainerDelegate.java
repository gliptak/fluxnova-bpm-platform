...
import org.finos.fluxnova.bpm.container.impl.jboss.util.BindingUtil;
import org.finos.fluxnova.bpm.container.impl.jboss.util.PlatformServiceReferenceFactory;
import org.finos.fluxnova.bpm.container.impl.jboss.util.ServiceTracker;
import org.finos.fluxnova.bpm.engine.ProcessEngine;
import org.finos.fluxnova.bpm.engine.ProcessEngineException;
import org.finos.fluxnova.bpm.engine.impl.util.ClassLoaderUtil;
...
public class MscRuntimeContainerDelegate implements Service<MscRuntimeContainerDelegate>, RuntimeContainerDelegate, ProcessEngineService, ProcessApplicationService {
  ...
  public void deployProcessApplication(AbstractProcessApplication processApplication) {
    if(processApplication instanceof JakartaServletProcessApplication application) {
      deployServletProcessApplication(application);
    }
  }
