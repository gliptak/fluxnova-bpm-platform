...
import org.finos.fluxnova.bpm.container.impl.jboss.extension.Element;
import org.finos.fluxnova.bpm.container.impl.jboss.extension.ModelConstants;
import org.finos.fluxnova.bpm.container.impl.jboss.extension.SubsystemAttributeDefinitons;
import org.finos.fluxnova.bpm.container.impl.jboss.service.MscManagedProcessEngineController;
...
import org.finos.fluxnova.bpm.container.impl.plugin.BpmPlatformPlugin;
...
public class JBossSubsystemXMLTest extends AbstractSubsystemTest {
  ...
  public static final ServiceName PROCESS_ENGINE_SERVICE_BINDING_SERVICE_NAME = ContextNames.GLOBAL_CONTEXT_SERVICE_NAME
    ...
    .append("ProcessEngineService!org.finos.fluxnova.bpm.ProcessEngineService");
  ...
  static {
    ...
    EXPRESSION_PROPERTIES.put("org.camunda.bpm.jboss.process-engine.test.configuration", "org.finos.fluxnova.bpm.container.impl.jboss.config.ManagedJtaProcessEngineConfiguration");
    EXPRESSION_PROPERTIES.put("org.camunda.bpm.jboss.process-engine.test.property.job-acquisition-name", "default");
    EXPRESSION_PROPERTIES.put("org.camunda.bpm.jboss.process-engine.test.plugin.ldap.class", "org.finos.fluxnova.bpm.identity.impl.ldap.plugin.LdapIdentityProviderPlugin");
  ...
  public void testInstallSubsystemWithEnginesPropertiesPlugins() throws Exception {
    ...
    assertEquals("org.finos.fluxnova.bpm.identity.impl.ldap.plugin.LdapIdentityProviderPlugin", processEnginePluginXml.getPluginClass());
