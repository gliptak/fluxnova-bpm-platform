...
public abstract class SoapHttpLogger extends BaseLogger {
  ...
  public static final SoapHttpConnectorLogger SOAP_HTTP_CONNECTOR_LOGGER = createLogger(SoapHttpConnectorLogger.class, PROJECT_CODE, "org.finos.fluxnova.bpm.connect.soap.httpclient.connector", "01");
