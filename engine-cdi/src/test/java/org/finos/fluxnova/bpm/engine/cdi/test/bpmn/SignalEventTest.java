 ...
 */
package org.finos.fluxnova.bpm.engine.cdi.test.bpmn;
...
public class SignalEventTest extends CdiProcessEngineTestCase {
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/cdi/test/bpmn/SignalEventTests.catchAlertSignalBoundaryWithReceiveTask.bpmn20.xml",
          "org/finos/fluxnova/bpm/engine/cdi/test/bpmn/SignalEventTests.throwAlertSignalWithDelegate.bpmn20.xml"})
