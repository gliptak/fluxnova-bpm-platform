...
public class ElContextDelegate extends ELContext {
  ...
  protected final org.finos.fluxnova.bpm.impl.juel.jakarta.el.ELContext delegateContext;

  protected final ELResolver elResolver;

  public ElContextDelegate(org.finos.fluxnova.bpm.impl.juel.jakarta.el.ELContext delegateContext, ELResolver elResolver) {
