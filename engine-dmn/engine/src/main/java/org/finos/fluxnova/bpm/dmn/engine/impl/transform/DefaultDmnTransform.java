 ...
 */
package org.finos.fluxnova.bpm.dmn.engine.impl.transform;
...
import org.finos.fluxnova.bpm.dmn.engine.impl.DmnDecisionRequirementsGraphImpl;
...
import org.finos.fluxnova.bpm.dmn.engine.impl.DmnLogger;
import org.finos.fluxnova.bpm.dmn.engine.impl.DmnVariableImpl;
import org.finos.fluxnova.bpm.dmn.engine.impl.spi.hitpolicy.DmnHitPolicyHandlerRegistry;
import org.finos.fluxnova.bpm.dmn.engine.impl.spi.transform.DmnElementTransformContext;
import org.finos.fluxnova.bpm.dmn.engine.impl.spi.transform.DmnElementTransformHandler;
import org.finos.fluxnova.bpm.dmn.engine.impl.spi.transform.DmnElementTransformHandlerRegistry;
import org.finos.fluxnova.bpm.dmn.engine.impl.spi.transform.DmnTransform;
import org.finos.fluxnova.bpm.dmn.engine.impl.spi.transform.DmnTransformListener;
import org.finos.fluxnova.bpm.dmn.engine.impl.spi.transform.DmnTransformer;
import org.finos.fluxnova.bpm.dmn.engine.impl.spi.type.DmnDataTypeTransformerRegistry;
...
import org.finos.fluxnova.bpm.model.dmn.instance.Expression;
import org.finos.fluxnova.bpm.model.dmn.instance.InformationRequirement;
...
import org.finos.fluxnova.bpm.model.dmn.instance.LiteralExpression;
import org.finos.fluxnova.bpm.model.dmn.instance.Output;
import org.finos.fluxnova.bpm.model.dmn.instance.OutputEntry;
import org.finos.fluxnova.bpm.model.dmn.instance.Rule;
import org.finos.fluxnova.bpm.model.dmn.instance.Variable;
...
public class DefaultDmnTransform implements DmnTransform, DmnElementTransformContext {
  ...
  protected DmnDecisionImpl transformDecision(Decision decision) {
    ...
    if (expression instanceof DecisionTable table) {
      DmnDecisionTableImpl dmnDecisionTable = transformDecisionTable(table);
