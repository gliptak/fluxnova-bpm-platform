 ...
 */
package org.finos.fluxnova.bpm.dmn.engine.transform;
...
import org.finos.fluxnova.bpm.dmn.engine.impl.DmnDecisionImpl;
import org.finos.fluxnova.bpm.dmn.engine.impl.DmnDecisionLiteralExpressionImpl;
import org.finos.fluxnova.bpm.dmn.engine.impl.DmnDecisionTableImpl;
import org.finos.fluxnova.bpm.dmn.engine.impl.DmnDecisionTableInputImpl;
import org.finos.fluxnova.bpm.dmn.engine.impl.DmnDecisionTableOutputImpl;
import org.finos.fluxnova.bpm.dmn.engine.impl.DmnDecisionTableRuleImpl;
import org.finos.fluxnova.bpm.dmn.engine.impl.DmnExpressionImpl;
import org.finos.fluxnova.bpm.dmn.engine.impl.DmnVariableImpl;
import org.finos.fluxnova.bpm.dmn.engine.impl.hitpolicy.FirstHitPolicyHandler;
import org.finos.fluxnova.bpm.dmn.engine.impl.hitpolicy.UniqueHitPolicyHandler;
import org.finos.fluxnova.bpm.dmn.engine.impl.transform.DmnTransformException;
import org.finos.fluxnova.bpm.dmn.engine.impl.type.DefaultTypeDefinition;
...
public class DmnTransformTest extends DmnEngineTest {
  ...
  public static final String TRANSFORM_DMN = "org/finos/fluxnova/bpm/dmn/engine/transform/DmnTransformTest.dmn";

  public static final String DECISION_WITH_LITERAL_EXPRESSION_DMN = "org/finos/fluxnova/bpm/dmn/engine/transform/DecisionWithLiteralExpression.dmn";

  public static final String REQUIRED_DECISIONS_DMN = "org/finos/fluxnova/bpm/dmn/engine/api/RequiredDecision.dmn";
  public static final String MULTIPLE_REQUIRED_DECISIONS_DMN = "org/finos/fluxnova/bpm/dmn/engine/api/MultipleRequiredDecisions.dmn";
  public static final String MULTI_LEVEL_MULTIPLE_REQUIRED_DECISIONS_DMN = "org/finos/fluxnova/bpm/dmn/engine/api/MultilevelMultipleRequiredDecisions.dmn";
  public static final String LOOP_REQUIRED_DECISIONS_DMN = "org/finos/fluxnova/bpm/dmn/engine/api/LoopInRequiredDecision.dmn";
  public static final String LOOP_REQUIRED_DECISIONS_DIFFERENT_ORDER_DMN = "org/finos/fluxnova/bpm/dmn/engine/api/LoopInRequiredDecision2.dmn";
  public static final String SELF_REQUIRED_DECISIONS_DMN = "org/finos/fluxnova/bpm/dmn/engine/api/SelfRequiredDecision.dmn";
