...
import org.finos.fluxnova.bpm.engine.impl.cmmn.listener.DelegateExpressionCaseExecutionListener;
...
public class DelegateExpressionExecutionListenerSpec extends AbstractExecutionListenerSpec {
  ...
  protected void configureCaseExecutionListener(CmmnModelInstance modelInstance, FluxnovaCaseExecutionListener listener) {
    listener.setFluxnovaDelegateExpression(DELEGATE_EXPRESSION);
  }
