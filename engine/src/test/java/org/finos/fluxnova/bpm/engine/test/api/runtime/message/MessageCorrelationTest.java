 ...
 */
package org.finos.fluxnova.bpm.engine.test.api.runtime.message;
...
public class MessageCorrelationTest {
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/runtime/message/MessageCorrelationTest.testCatchingMessageEventCorrelation.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/runtime/message/MessageCorrelationTest.testMessageStartEventCorrelation.bpmn20.xml")
  @Test
  ...
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/api/runtime/message/MessageCorrelationTest.testMultipleMessageStartEventsCorrelation.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/api/runtime/message/MessageCorrelationTest.testMatchingStartEventAndExecution.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/runtime/message/MessageCorrelationTest.testCatchingMessageEventCorrelation.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/runtime/message/MessageCorrelationTest.testCorrelateAllWithoutMessage.bpmn20.xml"})
  @Test
    ...
    BpmnModelInstance model = Bpmn.createExecutableProcess("Process_1")
        .startEvent()
          .intermediateCatchEvent("message_1")
            .message("1")
            .fluxnovaOutputParameter(outputVarName, "${testLocalVar}")
          .userTask("UserTask_1")
        .endEvent()
        .done();
  ...
  "org/finos/fluxnova/bpm/engine/test/api/runtime/message/MessageCorrelationTest.sendMessageProcess.bpmn20.xml" })
  @Test
  ...
  public void testCorrelationWithModifiedVariablesInResult() {
    ...
    BpmnModelInstance model = Bpmn.createExecutableProcess("Process_1")
        ...
        .message("1")
        .serviceTask()
        .fluxnovaClass(ChangeVariableDelegate.class.getName())
        .userTask("UserTask_1")
        .endEvent()
        .done();
