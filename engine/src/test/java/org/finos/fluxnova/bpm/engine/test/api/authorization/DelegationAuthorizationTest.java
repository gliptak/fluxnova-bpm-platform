...
import static org.finos.fluxnova.bpm.engine.authorization.Permissions.CREATE_INSTANCE;
...
import org.finos.fluxnova.bpm.engine.test.api.authorization.service.ExecuteCommandDelegate;
import org.finos.fluxnova.bpm.engine.test.api.authorization.service.ExecuteCommandListener;
import org.finos.fluxnova.bpm.engine.test.api.authorization.service.ExecuteCommandTaskListener;
import org.finos.fluxnova.bpm.engine.test.api.authorization.service.ExecuteQueryDelegate;
import org.finos.fluxnova.bpm.engine.test.api.authorization.service.ExecuteQueryListener;
import org.finos.fluxnova.bpm.engine.test.api.authorization.service.ExecuteQueryTaskListener;
import org.finos.fluxnova.bpm.engine.test.api.authorization.service.MyDelegationService;
import org.finos.fluxnova.bpm.engine.test.api.authorization.service.MyFormFieldValidator;
...
public class DelegationAuthorizationTest extends AuthorizationTest {
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/authorization/DelegationAuthorizationTest.testCustomStartFormHandlerExecutesQuery.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/authorization/DelegationAuthorizationTest.testCustomTaskFormHandlerExecutesQuery.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/authorization/DelegationAuthorizationTest.testJavaDelegateExecutesQueryAfterUserCompletesTask.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/authorization/DelegationAuthorizationTest.testJavaDelegateExecutesCommandAfterUserCompletesTask.bpmn20.xml"})
  @Test
