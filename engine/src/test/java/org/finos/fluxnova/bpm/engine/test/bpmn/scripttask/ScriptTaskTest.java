...
public class ScriptTaskTest extends AbstractScriptTaskTest {
  ...
  public void testJavascriptVariableSerialization() {
    ...
    deployProcess(JAVASCRIPT, "execution.setVariable('myVar', new org.finos.fluxnova.bpm.engine.test.bpmn.scripttask.MySerializable('test'));");
  ...
  public void testRubyVariableSerialization() {
    ...
    deployProcess(RUBY, "$execution.setVariable('myVar', org.finos.fluxnova.bpm.engine.test.bpmn.scripttask.MySerializable.new('test'));");
  ...
  public void testGroovyVariableSerialization() {
    ...
    deployProcess(GROOVY, "execution.setVariable('myVar', new org.finos.fluxnova.bpm.engine.test.bpmn.scripttask.MySerializable('test'));");
  ...
  @org.finos.fluxnova.bpm.engine.test.Deployment
  @Test
  ...
  public void shouldLoadExternalScriptJavascript() {
    try {
      ...
      deployProcess(JAVASCRIPT,
          ...
          "load(\"" + getNormalizedResourcePath("/org/finos/fluxnova/bpm/engine/test/bpmn/scripttask/sum.js") + "\");"
          // THEN
