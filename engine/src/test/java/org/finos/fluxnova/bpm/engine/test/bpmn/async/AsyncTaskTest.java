...
public class AsyncTaskTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/bpmn/async/AsyncTaskTest.testAsyncServiceWrappedInParallelMultiInstance.bpmn20.xml")
  @Test
  ...
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/bpmn/async/AsyncTaskTest.testAsyncCallActivity.bpmn20.xml",
          "org/finos/fluxnova/bpm/engine/test/bpmn/async/AsyncTaskTest.testAsyncServiceNoListeners.bpmn20.xml"})
  @Test
  ...
  public void testDeployAndRemoveAsyncActivity() {
    ...
    try {
      ...
      org.finos.fluxnova.bpm.engine.repository.Deployment deployment1 = repositoryService
          .createDeployment()
          .addClasspathResource("org/finos/fluxnova/bpm/engine/test/bpmn/async/AsyncTaskTest.testDeployAndRemoveAsyncActivity.v1.bpmn20.xml")
          .deploy();
      ...
      org.finos.fluxnova.bpm.engine.repository.Deployment deployment2 = repositoryService
          .createDeployment()
          .addClasspathResource("org/finos/fluxnova/bpm/engine/test/bpmn/async/AsyncTaskTest.testDeployAndRemoveAsyncActivity.v2.bpmn20.xml")
          .deploy();
  ...
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/bpmn/async/processWithGatewayAndTwoEndEvents.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/bpmn/async/processGatewayAndTwoEndEventsPlusTimer.bpmn20.xml"})
  @Test
