...
import org.finos.fluxnova.bpm.engine.impl.cmmn.behavior.HumanTaskActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.cmmn.handler.CasePlanModelHandler;
import org.finos.fluxnova.bpm.engine.impl.cmmn.handler.HumanTaskItemHandler;
...
import org.finos.fluxnova.bpm.model.cmmn.instance.CaseRole;
...
public class HumanTaskPlanItemHandlerTest extends CmmnElementHandlerTest {
  ...
  public void testTaskDefinitionDueDateExpression() {
    ...
    humanTask.setFluxnovaDueDate(aDueDate);
  ...
  public void testTaskDefinitionFollowUpDateExpression() {
    ...
    humanTask.setFluxnovaFollowUpDate(aFollowUpDate);
  ...
  public void testTaskDefinitionPriorityExpression() {
    ...
    humanTask.setFluxnovaPriority(aPriority);
  ...
  public void testTaskDefinitionCandidateUsers() {
    ...
    humanTask.setFluxnovaCandidateUsers(aCandidateUsers);
  ...
  public void testTaskDefinitionCandidateGroups() {
    ...
    humanTask.setFluxnovaCandidateGroups(aCandidateGroups);
  ...
  public void testTaskDefinitionFormKey() {
    ...
    humanTask.setFluxnovaFormKey(aFormKey);
  ...
  public void testCreateTaskListenerByClass() {
    ...
    FluxnovaTaskListener taskListener = createElement(extensionElements, null, FluxnovaTaskListener.class);
  ...
  public void testCreateTaskListenerByDelegateExpression() {
    ...
    String event = TaskListener.EVENTNAME_CREATE;
    taskListener.setFluxnovaEvent(event);
    taskListener.setFluxnovaDelegateExpression(delegateExpression);
  ...
  public void testCreateTaskListenerByExpression() {
    ...
    String event = TaskListener.EVENTNAME_CREATE;
    taskListener.setFluxnovaEvent(event);
    taskListener.setFluxnovaExpression(expression);
