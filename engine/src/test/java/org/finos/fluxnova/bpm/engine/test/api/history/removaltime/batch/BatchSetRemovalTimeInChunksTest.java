...
import org.finos.fluxnova.bpm.engine.test.api.history.removaltime.batch.helper.BatchSetRemovalTimeRule.TestProcessBuilder;
...
public class BatchSetRemovalTimeInChunksTest {
  ...
  @Test
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/api/history/testDmnWithPojo.dmn11.xml"
  })
