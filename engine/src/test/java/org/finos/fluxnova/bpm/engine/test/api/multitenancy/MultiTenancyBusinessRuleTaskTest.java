...
public class MultiTenancyBusinessRuleTaskTest extends PluggableProcessEngineTest {
  ...
  public static final String DMN_FILE_VERSION_TAG = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testDecisionVersionTagOkay.dmn11.xml";
  public static final String DMN_FILE_VERSION_TAG_TWO = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testDecisionVersionTagOkay_v2.dmn11.xml";
  ...
  public void testEvaluateDecisionWithDeploymentBinding() {
    ...
    BpmnModelInstance process = Bpmn.createExecutableProcess("process")
        ...
        .businessRuleTask()
          ...
          .fluxnovaDecisionRefBinding("deployment")
          .fluxnovaMapDecisionResult("singleEntry")
          .fluxnovaResultVariable("decisionVar")
        .fluxnovaAsyncAfter()
        .endEvent()
        .done();
  ...
  public void testEvaluateDecisionWithVersionBinding() {
    ...
    BpmnModelInstance process = Bpmn.createExecutableProcess("process")
        ...
        .businessRuleTask()
          .fluxnovaDecisionRef("decision")
          .fluxnovaDecisionRefBinding("version")
          .fluxnovaDecisionRefVersion("1")
          .fluxnovaMapDecisionResult("singleEntry")
          .fluxnovaResultVariable("decisionVar")
        .fluxnovaAsyncAfter()
        .endEvent()
  ...
  public void testEvaluateDecisionWithVersionTagBinding() {
    ...
    testRule.deploy(Bpmn.createExecutableProcess("process")
        ...
        .businessRuleTask()
          .fluxnovaDecisionRef("decision")
          .fluxnovaDecisionRefTenantId(TENANT_ONE)
  ...
  public void testEvaluateDecisionWithoutTenantIdConstant() {
    ...
    BpmnModelInstance process = Bpmn.createExecutableProcess("process")
        ...
        .businessRuleTask()
          .fluxnovaDecisionRef("decision")
          .fluxnovaDecisionRefBinding("latest")
          .fluxnovaDecisionRefTenantId("${null}")
          .fluxnovaMapDecisionResult("singleEntry")
          .fluxnovaResultVariable("decisionVar")
        .fluxnovaAsyncAfter()
        .endEvent()
  ...
  public void testEvaluateDecisionTenantIdCompositeExpression() {
    ...
    BpmnModelInstance process = Bpmn.createExecutableProcess("process")
      ...
      .fluxnovaDecisionRef("decision")
      .fluxnovaDecisionRefBinding("latest")
      .fluxnovaDecisionRefTenantId("tenant${'1'}")
      .fluxnovaMapDecisionResult("singleEntry")
      .fluxnovaResultVariable("decisionVar")
      .fluxnovaAsyncAfter()
      .endEvent()
