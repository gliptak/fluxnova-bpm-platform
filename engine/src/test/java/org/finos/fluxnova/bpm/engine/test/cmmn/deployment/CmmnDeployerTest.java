...
public class CmmnDeployerTest extends PluggableProcessEngineTest {
  ...
  public void testCmmnDeployment() {
    String deploymentId = processEngine
        ...
        .createDeployment()
        .addClasspathResource("org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testSimpleDeployment.cmmn")
        .deploy()
        .getId();
  ...
  public void testDeployTwoCasesWithDuplicateIdAtTheSameTime() {
    try {
      String cmmnResourceName1 = "org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testSimpleDeployment.cmmn";
      String cmmnResourceName2 = "org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testSimpleDeployment2.cmmn";
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testCaseDiagramResource.cmmn",
      "org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testCaseDiagramResource.png" })
  @Test
  public void testCaseDiagramResource() {
    ...
    assertEquals("org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testCaseDiagramResource.cmmn", caseDefinition.getResourceName());
    assertEquals("Case_1", caseDefinition.getKey());

    final String diagramResourceName = caseDefinition.getDiagramResourceName();
    assertEquals("org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testCaseDiagramResource.png", diagramResourceName);
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testMultipleDiagramResourcesProvided.cmmn",
      "org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testMultipleDiagramResourcesProvided.a.png",
      "org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testMultipleDiagramResourcesProvided.b.png",
      "org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testMultipleDiagramResourcesProvided.c.png" })
  @Test
  public void testMultipleDiagramResourcesProvided() {
    ...
    assertEquals("org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testMultipleDiagramResourcesProvided.a.png", caseA.getDiagramResourceName());
    assertEquals("org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testMultipleDiagramResourcesProvided.b.png", caseB.getDiagramResourceName());
    assertEquals("org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testMultipleDiagramResourcesProvided.c.png", caseC.getDiagramResourceName());
  }

  @Test
  public void testDeployCmmn10XmlFile() {
    verifyCmmnResourceDeployed("org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testDeployCmmn10XmlFile.cmmn10.xml");

  }

  @Test
  public void testDeployCmmn11XmlFile() {
    verifyCmmnResourceDeployed("org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testDeployCmmn11XmlFile.cmmn11.xml");
  }
  ...
  protected static CmmnModelInstance createCmmnModelInstance() {
    ...
    org.finos.fluxnova.bpm.model.cmmn.instance.Definitions definitions = modelInstance.newInstance(org.finos.fluxnova.bpm.model.cmmn.instance.Definitions.class);
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testDeployCaseDefinitionWithIntegerHistoryTimeToLive.cmmn")
  @Test
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testDeployCaseDefinitionWithStringHistoryTimeToLive.cmmn")
  @Test
  ...
  public void testDeployCaseDefinitionWithMalformedHistoryTimeToLive() {
    try {
     testRule.deploy("org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testDeployCaseDefinitionWithMalformedHistoryTimeToLive.cmmn");
