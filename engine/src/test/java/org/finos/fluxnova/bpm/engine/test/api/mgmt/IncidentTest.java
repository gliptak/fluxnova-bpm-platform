...
public class IncidentTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/mgmt/IncidentTest.testShouldCreateOneIncidentForNestedExecution.bpmn"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/mgmt/IncidentTest.testShouldCreateRecursiveIncidents.bpmn",
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/mgmt/IncidentTest.testShouldCreateRecursiveIncidentsForNestedCallActivity.bpmn",
  		"org/finos/fluxnova/bpm/engine/test/api/mgmt/IncidentTest.testShouldCreateRecursiveIncidents.bpmn",
  "org/finos/fluxnova/bpm/engine/test/api/mgmt/IncidentTest.testShouldCreateOneIncident.bpmn"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/mgmt/IncidentTest.testShouldDeleteIncidentAfterJobWasSuccessfully.bpmn"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/mgmt/IncidentTest.testShouldCreateIncidentOnFailedStartTimerEvent.bpmn"})
  @Test
