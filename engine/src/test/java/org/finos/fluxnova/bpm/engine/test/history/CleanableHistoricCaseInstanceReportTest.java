...
public class CleanableHistoricCaseInstanceReportTest {
  ...
  public void testReportComplex() {
    // given
    testRule.deploy("org/finos/fluxnova/bpm/engine/test/api/cmmn/oneCaseTaskCase.cmmn", "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn",
        "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCaseWithHistoryTimeToLive.cmmn");
