...
public class DeploymentAuthorizationTest extends AuthorizationTest {
  ...
  protected static final String FIRST_RESOURCE = "org/finos/fluxnova/bpm/engine/test/api/oneTaskProcess.bpmn20.xml";
  protected static final String SECOND_RESOURCE = "org/finos/fluxnova/bpm/engine/test/api/authorization/messageBoundaryEventProcess.bpmn20.xml";
  ...
  @Test
  public void shouldRegisterProcessApplicationAsFluxnovaAdmin() {
    // given
  ...
  @Test
  public void shouldUnregisterProcessApplicationAsFluxnovaAdmin() {
    // given
    identityService.setAuthentication(userId, Collections.singletonList(Groups.CAMUNDA_ADMIN));
  ...
  @Test
  public void shouldGetProcessApplicationForDeploymentAsFluxnovaAdmin() {
    // given
    identityService.setAuthentication(userId, Collections.singletonList(Groups.CAMUNDA_ADMIN));
  ...
  @Test
  public void shouldGetRegisteredDeploymentsAsFluxnovaAdmin() {
    // given
    identityService.setAuthentication(userId, Collections.singletonList(Groups.CAMUNDA_ADMIN));
  ...
  @Test
  public void shouldRegisterDeploymentAsFluxnovaAdmin() {
    // given
    identityService.setAuthentication(userId, Collections.singletonList(Groups.CAMUNDA_ADMIN));
  ...
  @Test
  public void shouldUnregisterDeploymentAsFluxnovaAdmin() {
    // given
    identityService.setAuthentication(userId, Collections.singletonList(Groups.CAMUNDA_ADMIN));
