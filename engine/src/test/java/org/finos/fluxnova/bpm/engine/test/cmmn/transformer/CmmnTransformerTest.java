 ...
 */
package org.finos.fluxnova.bpm.engine.test.cmmn.transformer;
...
import org.finos.fluxnova.bpm.engine.impl.cmmn.transformer.CmmnTransform;
...
public class CmmnTransformerTest {
  ...
  protected List<CaseDefinitionEntity> transform() {
    ...
    byte[] model = org.finos.fluxnova.bpm.engine.impl.util.IoUtil.readInputStream(inputStream, "model");
