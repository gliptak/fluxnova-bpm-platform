...
public class MultiTenancyProcessDefinitionCmdsTenantCheckTest {
  ...
  protected static final String BPMN_PROCESS_MODEL = "org/finos/fluxnova/bpm/engine/test/api/multitenancy/testProcess.bpmn";
  protected static final String BPMN_PROCESS_DIAGRAM = "org/finos/fluxnova/bpm/engine/test/api/multitenancy/testProcess.png";
  ...
  public void testDeleteProcessDefinitionWithAuthenticatedTenant() {
    ...
    Deployment deployment = testRule.deployForTenant(TENANT_ONE, "org/finos/fluxnova/bpm/engine/test/repository/twoProcesses.bpmn20.xml");
