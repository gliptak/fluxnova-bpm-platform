...
import org.finos.fluxnova.bpm.engine.test.bpmn.event.error.ThrowBpmnErrorDelegate;
  ...
  public void testTransitionIdRequired() {
    ...
    try {
      repositoryService.createDeployment()
        .addClasspathResource("org/finos/fluxnova/bpm/engine/test/bpmn/async/AsyncAfterTest.testTransitionIdRequired.bpmn20.xml")
        .deploy();
  ...
  public void testAsyncAfterErrorEvent() {
    ...
    BpmnModelInstance instance = Bpmn.createExecutableProcess("process")
      ...
      .serviceTask("servTask")
        .fluxnovaClass(ThrowBpmnErrorDelegate.class)
      .boundaryEvent()
        .fluxnovaAsyncAfter(true)
        .fluxnovaFailedJobRetryTimeCycle("R10/PT10S")
