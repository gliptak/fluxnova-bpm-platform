...
import org.finos.fluxnova.bpm.engine.impl.cmmn.listener.ScriptCaseExecutionListener;
...
public class ScriptExecutionListenerSpec extends AbstractExecutionListenerSpec {
  ...
  protected void configureCaseExecutionListener(CmmnModelInstance modelInstance, FluxnovaCaseExecutionListener listener) {
    FluxnovaScript script = SpecUtil.createElement(modelInstance, listener, null, FluxnovaScript.class);
    String scriptValue = "${myScript}";
    script.setFluxnovaScriptFormat(SCRIPT_FORMAT);
