...
public class CaseInstanceQueryTest extends PluggableProcessEngineTest {
  ...
  public void setUp() throws Exception {
    ...
    repositoryService.createDeployment()
      .addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn")
  ...
  public void testQueryByCompleted() {
    ...
    repositoryService.createDeployment()
        .addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCaseWithManualActivation.cmmn")
        .deploy();
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/runtime/CaseInstanceQueryTest.testQueryByTerminated.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/runtime/superProcessWithCaseCallActivityInsideSubProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/cmmn/oneCaseTaskCase.cmmn"})
  @Test
