...
public class InputOutputTest extends PluggableProcessEngineTest {
  ...
  public void testInputExternalScriptValueAsVariable() {
    Map<String, Object> variables = new HashMap<String, Object>();
    variables.put("scriptPath", "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/oneplusone.groovy");
    runtimeService.startProcessInstanceByKey("testProcess", variables);
    Execution execution = runtimeService.createExecutionQuery().activityId("wait").singleResult();
  ...
  public void testInputExternalClasspathScriptValueAsVariable() {
    Map<String, Object> variables = new HashMap<String, Object>();
    variables.put("scriptPath", "classpath://org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/oneplusone.groovy");
    runtimeService.startProcessInstanceByKey("testProcess", variables);
    Execution execution = runtimeService.createExecutionQuery().activityId("wait").singleResult();
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/InputOutputTest.testInputExternalDeploymentScriptValue.bpmn",
    "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/oneplusone.groovy"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/InputOutputTest.testInputExternalDeploymentScriptValueAsVariable.bpmn",
    "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/oneplusone.groovy"
  })
  @Test
  public void testInputExternalDeploymentScriptValueAsVariable() {
    Map<String, Object> variables = new HashMap<String, Object>();
    variables.put("scriptPath", "deployment://org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/oneplusone.groovy");
    runtimeService.startProcessInstanceByKey("testProcess", variables);
    Execution execution = runtimeService.createExecutionQuery().activityId("wait").singleResult();
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/InputOutputTest.testInputExternalDeploymentScriptValueAsBean.bpmn",
    "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/oneplusone.groovy"
  })
  @Test
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/InputOutputTest.testInputMapElKey.bpmn")
  @Test
  ...
  public void testOutputParameterAvailableAfterParallelGateway() {
    ...
    BpmnModelInstance processDefinition = Bpmn.createExecutableProcess("process")
      .startEvent()
      .serviceTask()
        .fluxnovaOutputParameter("variable", "A")
        .fluxnovaExpression("${'this value does not matter'}")
      .parallelGateway("fork")
      .endEvent()
      .moveToNode("fork")
        .serviceTask().fluxnovaExpression("${variable}")
        .receiveTask()
      .endEvent()
    .done();
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/InputOutputTest.testOutputExternalDeploymentScriptValue.bpmn",
    "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/oneplusone.groovy"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/InputOutputTest.testOutputExternalDeploymentScriptValueAsVariable.bpmn",
    "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/oneplusone.groovy"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/InputOutputTest.testOutputExternalDeploymentScriptValueAsBean.bpmn",
    "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/oneplusone.groovy"
  })
  @Test
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/InputOutputTest.testOutputMapElKey.bpmn")
  @Test
  ...
  public void testInterruptingEventSubprocessIoSupport() {
    try {
      repositoryService
        .createDeployment()
        .addClasspathResource("org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/InputOutputTest.testInterruptingEventSubprocessIoSupport.bpmn")
        .deploy();
      fail("exception expected");
  ...
  public void testMIOutputMappingDisallowed() {
    try {
      ...
      .addClasspathResource("org/finos/fluxnova/bpm/engine/test/bpmn/iomapping/InputOutputTest.testMIOutputMappingDisallowed.bpmn20.xml")
      .deploy();
      fail("Exception expected");
    } catch (ParseException e) {
  ...
  public void testCompositeExpressionForInputValue() {
    ...
    BpmnModelInstance instance = Bpmn.createExecutableProcess("Process")
      .startEvent()
      .receiveTask()
        .fluxnovaInputParameter("var", "Hello World${'!'}")
      .endEvent("end")
      .done();
  ...
  public void testCompositeExpressionForOutputValue() {
    ...
    BpmnModelInstance instance = Bpmn.createExecutableProcess("Process")
      ...
      .serviceTask()
        ...
        .fluxnovaInputParameter("var1", "World!")
        .fluxnovaOutputParameter("var2", "Hello ${var1}")
      .userTask()
      .endEvent("end")
      .done();
