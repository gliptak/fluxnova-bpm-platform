 ...
 */
package org.finos.fluxnova.bpm.engine.test.bpmn.tasklistener.builtin;
...
public class BuiltinTaskListenerTest {
  ...
  public static ProcessEngineBootstrapRule bootstrapRule = new ProcessEngineBootstrapRule(
      "org/finos/fluxnova/bpm/engine/test/bpmn/tasklistener/builtin/task.listener.camunda.cfg.xml");
  ...
  @Test
  @Deployment
  @WatchLogger(loggerNames = {"org.finos.fluxnova.bpm.engine.test"}, level = "INFO")
