...
import org.finos.fluxnova.bpm.engine.test.bpmn.event.conditional.SetVariableDelegate;
import org.finos.fluxnova.bpm.engine.test.bpmn.executionlistener.CurrentActivityExecutionListener.CurrentActivity;
...
public class ExecutionListenerTest {
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/bpmn/executionlistener/ExecutionListenersProcess.bpmn20.xml"})
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/bpmn/executionlistener/ExecutionListenersStartEndEvent.bpmn20.xml"})
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/bpmn/executionlistener/ExecutionListenersFieldInjectionProcess.bpmn20.xml"})
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/bpmn/executionlistener/ExecutionListenersCurrentActivity.bpmn20.xml"})
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/bpmn/executionlistener/ExecutionListenerTest.testOnBoundaryEvents.bpmn20.xml"})
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/executionlistener/ExecutionListenerTest.testScriptResourceListener.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/executionlistener/executionListener.groovy"
  })
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/bpmn/executionlistener/ExecutionListenerTest.testOnCancellingBoundaryEvent.bpmn"})
  ...
  public static final BpmnModelInstance PROCESS_SERVICE_TASK_WITH_EXECUTION_START_LISTENER = Bpmn.createExecutableProcess(PROCESS_KEY)
          ...
          .serviceTask("sendTask")
            .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_START, SendMessageDelegate.class.getName())
  ...
  public void testEndExecutionListenerIsCalledOnlyOnce() {
    ...
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess("conditionalProcessKey")
      .startEvent()
      .userTask()
      .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_END, SetVariableDelegate.class.getName())
      .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_END, RecorderExecutionListener.class.getName())
      .endEvent()
      .done();
  ...
  @Test
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/bpmn/executionlistener/ExecutionListenerTest.testMultiInstanceCancelation.bpmn20.xml")
  ...
  public void testThrowBpmnErrorInTakeListenerAndEventSubprocessWithCatch() {
    ...
    FluxnovaExecutionListener listener = model.newInstance(FluxnovaExecutionListener.class);
    listener.setFluxnovaEvent(ExecutionListener.EVENTNAME_TAKE);
    listener.setFluxnovaClass(ThrowBPMNErrorDelegate.class.getName());
  ...
  public void testThrowBpmnErrorInStartListenerOfStartEventAndEventSubprocessWithCatch() {
    ...
    BpmnModelInstance model = processBuilder
        .startEvent()
        .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_START, ThrowBPMNErrorDelegate.class.getName())
        .userTask("afterListener")
        .endEvent()
        .done();
  ...
  public void testThrowBpmnErrorInEndListenerOfLastEventAndEventProcessWithCatch() {
    ...
    BpmnModelInstance model = processBuilder
        ...
        .serviceTask("throw")
          .fluxnovaExpression("${true}")
          .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_END, ThrowBPMNErrorDelegate.class.getName())
        .done();
  ...
  public void testThrowBpmnErrorInStartListenerServiceTaskAndEndListener() {
    ...
    BpmnModelInstance model = Bpmn.createExecutableProcess(PROCESS_KEY)
        ...
        .serviceTask("throw")
          .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_START, ThrowBPMNErrorDelegate.class.getName())
          .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_END, SetsVariableDelegate.class.getName())
          .fluxnovaExpression("${true}")
        .boundaryEvent("errorEvent")
        .error(ERROR_CODE)
        .userTask("afterCatch")
  ...
  public void testThrowBpmnErrorInStartExpressionListenerAndEventSubprocessWithCatch() {
    ...
    BpmnModelInstance model = processBuilder
        ...
        .userTask("userTask1")
        .serviceTask("throw")
          .fluxnovaExecutionListenerExpression(ExecutionListener.EVENTNAME_START, "${myListener.notify(execution)}")
          .fluxnovaExpression("${true}")
        .userTask("afterService")
        .endEvent()
        .done();
  ...
  public void testThrowBpmnErrorInProcessStartListenerShouldNotTriggerPropagation() {
    ...
    FluxnovaExecutionListener listener = model.newInstance(FluxnovaExecutionListener.class);
    listener.setFluxnovaEvent(ExecutionListener.EVENTNAME_START);
    listener.setFluxnovaClass(ThrowBPMNErrorDelegate.class.getName());
    model.<org.finos.fluxnova.bpm.model.bpmn.instance.Process>getModelElementById(PROCESS_KEY).builder().addExtensionElement(listener);
  ...
  public void testThrowBpmnErrorInProcessEndListenerShouldNotTriggerPropagation() {
    ...
    FluxnovaExecutionListener listener = model.newInstance(FluxnovaExecutionListener.class);
    listener.setFluxnovaEvent(ExecutionListener.EVENTNAME_END);
    listener.setFluxnovaClass(ThrowBPMNErrorDelegate.class.getName());
    model.<org.finos.fluxnova.bpm.model.bpmn.instance.Process>getModelElementById(PROCESS_KEY).builder().addExtensionElement(listener);
  ...
  protected BpmnModelInstance createModelWithCatchInServiceTaskAndListener(String eventName, boolean throwException, boolean catchException) {
    return Bpmn.createExecutableProcess(PROCESS_KEY)
          ...
          .userTask("userTask1")
          .serviceTask("throw")
            .fluxnovaExecutionListenerClass(eventName, throwException ? ThrowRuntimeExceptionDelegate.class : ThrowBPMNErrorDelegate.class)
            .fluxnovaExpression("${true}")
          .boundaryEvent("errorEvent")
