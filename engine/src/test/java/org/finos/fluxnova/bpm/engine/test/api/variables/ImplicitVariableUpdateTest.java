...
import org.finos.fluxnova.bpm.engine.test.history.RemoveAndUpdateValueDelegate;
import org.finos.fluxnova.bpm.engine.test.history.ReplaceAndUpdateValueDelegate;
import org.finos.fluxnova.bpm.engine.test.history.UpdateValueDelegate;
...
public class ImplicitVariableUpdateTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/variables/ImplicitVariableUpdateTest.sequence.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/variables/ImplicitVariableUpdateTest.parallel.bpmn20.xml")
  @Test
