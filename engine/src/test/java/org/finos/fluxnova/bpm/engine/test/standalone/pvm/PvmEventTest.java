...
import org.finos.fluxnova.bpm.engine.test.standalone.pvm.activities.EmbeddedSubProcess;
...
public class PvmEventTest {
  ...
  public void testStartEndEvents() {
    ...
    PvmProcessDefinition processDefinition = new ProcessDefinitionBuilder("events")
      .executionListener(org.finos.fluxnova.bpm.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
      .executionListener(org.finos.fluxnova.bpm.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
