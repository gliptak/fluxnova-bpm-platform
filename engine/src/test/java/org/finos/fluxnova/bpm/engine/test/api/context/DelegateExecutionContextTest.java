 ...
 */
package org.finos.fluxnova.bpm.engine.test.api.context;

import static org.assertj.core.api.Assertions.assertThat;

import org.finos.fluxnova.bpm.engine.RuntimeService;
import org.finos.fluxnova.bpm.engine.TaskService;
import org.finos.fluxnova.bpm.engine.context.DelegateExecutionContext;
...
public class DelegateExecutionContextTest {
  ...
  protected static final BpmnModelInstance SERVICE_TASK_DELEGATE_PROCESS = Bpmn.createExecutableProcess()
      ...
      .serviceTask("serviceTask1")
        .fluxnovaClass(DelegateClass.class.getName())
      .endEvent()
      .done();
  ...
  protected static final BpmnModelInstance EXEUCTION_LISTENER_PROCESS = Bpmn.createExecutableProcess()
      .fluxnovaHistoryTimeToLive(180)
      .startEvent()
        .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_START, ExecutionListenerImpl.class.getName())
      .endEvent()
      .done();
