...
public class FoxJobRetryCmdTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.testFailedUserTask.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.testFailedBusinessRuleTask.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.testFailedCallActivity.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.testFailedScriptTask.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.testFailedSendTask.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.testFailedSubProcess.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.testFailedTransaction.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.testFailedReceiveTask.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.testFailedBoundaryTimerEvent.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.testFailedIntermediateCatchingTimerEvent.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.testBrokenFoxJobRetryValue.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.testFailedStartTimerEvent.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.testFailedIntermediateThrowingSignalEvent.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/bpmn/async/FoxJobRetryCmdTest.failingSignalStart.bpmn20.xml" })
  ...
  public void testRetryOnServiceTaskLikeMessageThrowEvent() {
    ...
    BpmnModelInstance bpmnModelInstance = Bpmn.createExecutableProcess("process")
        ...
        .intermediateThrowEvent()
          .fluxnovaAsyncBefore()
          .fluxnovaFailedJobRetryTimeCycle("R10/PT5S")
    ...
    messageDefinition.setFluxnovaClass(FailingDelegate.class.getName());
  ...
  public void testRetryOnAsyncStartEvent() throws Exception {
    BpmnModelInstance bpmnModelInstance = Bpmn.createExecutableProcess("process")
        .startEvent()
          .fluxnovaAsyncBefore()
          .fluxnovaFailedJobRetryTimeCycle("R5/PT5M")
        .serviceTask()
          .fluxnovaClass("bar")
        .endEvent()
        .done();
  ...
  public void testIntermediateCatchEvent() throws Exception {
    BpmnModelInstance bpmnModelInstance = Bpmn.createExecutableProcess("process")
        ...
        .intermediateCatchEvent()
          ...
          .fluxnovaAsyncBefore()
          .fluxnovaFailedJobRetryTimeCycle("R5/PT5M")
          .fluxnovaExecutionListenerClass("start", "foo")
        .endEvent()
        .done();
    ...
    try {
      ...
      BpmnModelInstance bpmnModelInstance = Bpmn.createExecutableProcess("process")
        ...
        .userTask("wait")
          ...
          .fluxnovaFailedJobRetryTimeCycle("R2/PT10M")
        .serviceTask("failing")
          .fluxnovaClass("foo")
        .endEvent()
        .done();
    ...
    BpmnModelInstance bpmnModelInstance = Bpmn.createExecutableProcess("process")
      ...
      .parallelGateway("gwt")
        .serviceTask("failing")
          .fluxnovaClass("foo")
          .fluxnovaAsyncBefore()
          .fluxnovaFailedJobRetryTimeCycle("R2/PT5M")
      .moveToNode("gwt")
