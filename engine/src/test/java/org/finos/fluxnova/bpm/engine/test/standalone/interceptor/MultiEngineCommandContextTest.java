 ...
 */
package org.finos.fluxnova.bpm.engine.test.standalone.interceptor;
...
public class MultiEngineCommandContextTest {
  ...
  public void shouldOpenNewCommandContextWhenInteractingAccrossEngines() {
    ...
    BpmnModelInstance process1 = Bpmn.createExecutableProcess("process1")
        .startEvent()
        .serviceTask()
          .fluxnovaInputParameter("engineName", "engine2")
          .fluxnovaInputParameter("processKey", "process2")
          .fluxnovaClass(StartProcessInstanceOnEngineDelegate.class.getName())
        .endEvent()
        .done();
  ...
  public void shouldOpenNewCommandContextWhenInteractingWithOtherEngineAndBack() {
    ...
    BpmnModelInstance process2 = Bpmn.createExecutableProcess("process2")
        .startEvent()
        .serviceTask()
          .fluxnovaInputParameter("engineName", "engine1")
          .fluxnovaInputParameter("processKey", "process3")
          .fluxnovaClass(StartProcessInstanceOnEngineDelegate.class.getName())
        .done();
