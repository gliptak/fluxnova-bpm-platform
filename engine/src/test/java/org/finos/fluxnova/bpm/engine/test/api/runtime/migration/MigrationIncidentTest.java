...
public class MigrationIncidentTest {
  ...
  public static final BpmnModelInstance NEW_CALLED_PROC = Bpmn.createExecutableProcess(NEW_CALLED_PROC_KEY)
    ...
    .serviceTask("taskV2")
      .fluxnovaAsyncBefore()
      .fluxnovaClass(NewDelegate.class.getName())
    .endEvent("end")
    .done();
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/runtime/migration/calledProcess.bpmn",
                           "org/finos/fluxnova/bpm/engine/test/api/runtime/migration/callingProcess.bpmn",
                           "org/finos/fluxnova/bpm/engine/test/api/runtime/migration/callingProcess_v2.bpmn"})
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/runtime/migration/calledProcess.bpmn",
                           "org/finos/fluxnova/bpm/engine/test/api/runtime/migration/calledProcess_v2.bpmn"})
