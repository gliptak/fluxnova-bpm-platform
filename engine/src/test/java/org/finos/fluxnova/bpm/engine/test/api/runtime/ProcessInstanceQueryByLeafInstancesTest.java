...
public class ProcessInstanceQueryByLeafInstancesTest {
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/api/runtime/superProcessWithNestedSubProcess.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/runtime/nestedSubProcess.bpmn20.xml", "org/finos/fluxnova/bpm/engine/test/api/runtime/subProcess.bpmn20.xml" })
  ...
  @Test
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/api/runtime/nestedSubProcess.bpmn20.xml",
  ...
  @Test
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/api/runtime/subProcess.bpmn20.xml" })
