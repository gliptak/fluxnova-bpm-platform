...
public class HistoricProcessInstanceStateTest {
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/history/HistoricProcessInstanceStateTest.testWithCallActivity.bpmn"})
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/history/CAM-9934.bpmn"})
