...
import static org.finos.fluxnova.bpm.engine.variable.Variables.booleanValue;
...
public class FormServiceTest {
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/api/form/util/VacationRequest_deprecated_forms.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/form/util/approve.html",
      "org/finos/fluxnova/bpm/engine/test/api/form/util/request.html",
      "org/finos/fluxnova/bpm/engine/test/api/form/util/adjustRequest.html" })
  @Test
  ...
  public void testTaskFormPropertyDefaultsAndFormRendering() {
    ...
    final String deploymentId = testRule.deploy("org/finos/fluxnova/bpm/engine/test/api/form/FormsProcess.bpmn20.xml",
    ...
    assertEquals("org/finos/fluxnova/bpm/engine/test/api/form/start.html", startForm.getFormKey());
    ...
    assertEquals("org/finos/fluxnova/bpm/engine/test/api/form/task.html", taskForm.getFormKey());
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/form/FormsProcess.bpmn20.xml"})
  @Test
  ...
  public void testSubmitStartFormWithExecutionListenerOnStartEvent() {
    ...
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess()
        ...
        .startEvent()
        .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_START, VariablesRecordingListener.class)
        .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_END, VariablesRecordingListener.class)
        .endEvent()
        .done();
  ...
  public void testSubmitStartFormWithAsyncStartEvent() {
    ...
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess()
        .fluxnovaHistoryTimeToLive(180)
        .startEvent().fluxnovaAsyncBefore()
        .endEvent()
        .done();
  ...
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/api/form/FormServiceTest.startFormFields.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/api/form/FormServiceTest.startFormFieldsUnknownType.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/api/form/FormServiceTest.taskFormFields.bpmn20.xml"})
  @Test
  ...
  public void testDeployTaskFormWithoutFieldTypes() {
    try {
      repositoryService
        .createDeployment()
        .addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/form/FormServiceTest.testDeployTaskFormWithoutFieldTypes.bpmn20.xml")
        .deploy();
    } catch (ProcessEngineException e) {
  ...
  public void testDeployStartFormWithoutFieldTypes() {
    try {
      repositoryService
        .createDeployment()
        .addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/form/FormServiceTest.testDeployStartFormWithoutFieldTypes.bpmn20.xml")
        .deploy();
    } catch (ProcessEngineException e) {
      testRule.assertTextPresent("form field must have a 'type' attribute", e.getMessage());
    }
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/api/form/util/VacationRequest_deprecated_forms.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/api/form/util/approve.html",
    "org/finos/fluxnova/bpm/engine/test/api/form/util/request.html",
    "org/finos/fluxnova/bpm/engine/test/api/form/util/adjustRequest.html" })
  @Test
  public void testTaskFormsWithVacationRequestProcess() {
    ...
    assertEquals("org/finos/fluxnova/bpm/engine/test/api/form/util/request.html", formService.getStartFormData(processDefinitionId).getFormKey());
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/api/form/DeployedFormsProcess.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/form/start.html",
      "org/finos/fluxnova/bpm/engine/test/api/form/task.html" })
  @Test
  public void testGetDeployedStartForm() {
    ...
    String fileAsString = IoUtil.fileAsString("org/finos/fluxnova/bpm/engine/test/api/form/start.html");
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/api/form/EmbeddedDeployedFormsProcess.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/form/start.html",
      "org/finos/fluxnova/bpm/engine/test/api/form/task.html" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/api/form/DeployedCamundaFormsProcess.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/form/start.html",
      "org/finos/fluxnova/bpm/engine/test/api/form/task.html" })
  @Test
  public void testGetDeployedFluxnovaStartForm() {
    // given
    String procDefId = repositoryService.createProcessDefinitionQuery().singleResult().getId();
  ...
  public void testGetDeployedTaskForm() {
    ...
    String fileAsString = IoUtil.fileAsString("org/finos/fluxnova/bpm/engine/test/api/form/task.html");
    String deployedStartFormAsString = IoUtil.inputStreamAsString(deployedTaskForm);
    assertEquals(deployedStartFormAsString, fileAsString);
  }

  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/api/form/DeployedFormsCase.cmmn11.xml",
    "org/finos/fluxnova/bpm/engine/test/api/form/task.html" })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/api/form/DeployedCamundaFormsProcess.bpmn20.xml",
      ...
      "org/finos/fluxnova/bpm/engine/test/api/form/task.html" })
  @Test
  public void testGetDeployedFluxnovaTaskForm() {
    // given
    runtimeService.startProcessInstanceByKey("FormsProcess");
    String taskId = taskService.createTaskQuery().singleResult().getId();
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/form/FormServiceTest.testGetDeployedStartFormWithWrongKeyFormat.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/form/FormServiceTest.testGetDeployedTaskFormWithWrongKeyFormat.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/form/FormServiceTest.shouldSubmitStartFormUsingFormKeyAndCamundaFormDefinition.bpmn",
      "org/finos/fluxnova/bpm/engine/test/api/form/start.form" })
  @Test
  public void shouldSubmitStartFormUsingFormKeyAndFluxnovaFormDefinition() {
    // given
    ...
    assertThat(findAllFluxnovaFormDefinitionEntities(processEngineConfiguration)).hasSize(1);
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/form/FormServiceTest.shouldSubmitTaskFormUsingFormKeyAndCamundaFormDefinition.bpmn",
  "org/finos/fluxnova/bpm/engine/test/api/form/task.form" })
  @Test
  public void shouldSubmitTaskFormUsingFormKeyAndFluxnovaFormDefinition() {
    // given
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/form/FormServiceTest.shouldSubmitStartFormUsingFormRefAndCamundaFormDefinition.bpmn",
  "org/finos/fluxnova/bpm/engine/test/api/form/start.form" })
  @Test
  public void shouldSubmitStartFormUsingFormRefAndFluxnovaFormDefinition() {
    // given
    ProcessDefinition processDefinition = repositoryService.createProcessDefinitionQuery()
        .processDefinitionKey("CamundaStartFormProcess").singleResult();
    ...
    assertThat(engineRule.getProcessEngineConfiguration().getCommandExecutorTxRequired()
        .execute(new FindFluxnovaFormDefinitionsCmd())).hasSize(1);
    assertThat(runtimeService.createProcessInstanceQuery().processInstanceId(processInstance.getId()).list()).hasSize(0);
    assertThat(historyService.createHistoricProcessInstanceQuery().processInstanceId(processInstance.getId()).list()).hasSize(1);
  }

  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/form/FormServiceTest.shouldSubmitTaskFormUsingFormRefAndCamundaFormDefinition.bpmn",
  "org/finos/fluxnova/bpm/engine/test/api/form/task.form" })
  @Test
  public void shouldSubmitTaskFormUsingFormRefAndFluxnovaFormDefinition() {
    // given
    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("CamundaTaskFormProcess");
