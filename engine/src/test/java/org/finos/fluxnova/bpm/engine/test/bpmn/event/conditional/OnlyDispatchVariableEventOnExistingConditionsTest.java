...
import static org.finos.fluxnova.bpm.engine.test.bpmn.event.conditional.AbstractConditionalEventTestCase.CONDITIONAL_EVENT_PROCESS_KEY;
import static org.finos.fluxnova.bpm.engine.test.bpmn.event.conditional.AbstractConditionalEventTestCase.CONDITIONAL_MODEL;
import static org.finos.fluxnova.bpm.engine.test.bpmn.event.conditional.AbstractConditionalEventTestCase.TASK_WITH_CONDITION_ID;
...
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.DelayedVariableEvent;
...
public class OnlyDispatchVariableEventOnExistingConditionsTest {
  ...
  public void testProcessWithIntermediateConditionalEvent() {
    ...
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess(CONDITIONAL_EVENT_PROCESS_KEY)
      .startEvent()
      .serviceTask()
      .fluxnovaClass(CheckDelayedVariablesDelegate.class.getName())
  ...
  public void testProcessWithoutConditionalEvent() {
    ...
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess(CONDITIONAL_EVENT_PROCESS_KEY)
      .startEvent()
      .serviceTask()
      .fluxnovaClass(CheckNoDelayedVariablesDelegate.class.getName())
      .userTask()
      .endEvent()
      .done();
