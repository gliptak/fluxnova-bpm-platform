...
import org.finos.fluxnova.bpm.engine.impl.cmmn.cmd.DisableCaseExecutionCmd;
...
public class CompetingParentCompletionTest {
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/concurrency/CompetingParentCompletionTest.testComplete.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/concurrency/CompetingParentCompletionTest.testDisable.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/concurrency/CompetingParentCompletionTest.testTerminate.cmmn"})
  @Test
