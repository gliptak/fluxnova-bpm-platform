 ...
 * 'src/test/resources/org/finos/fluxnova/bpm/engine/test/api/repository/diagram'.
 * 
...
public class ProcessDiagramRetrievalTest {
   ...
   * src/test/resources/org/finos/fluxnova/bpm/engine/test/api/repository/diagram, which
...
//              new File("src/test/resources/org/finos/fluxnova/bpm/engine/test/api/repository/diagram/" + imageFileName + ".actual.png"));
      assertTrue(isEqual(expectedStream, actualStream));
    } else {
      // some test diagrams do not contain executable processes
      // and are therefore ignored by the engine
  ...
  public void testGetProcessDiagramLayout(String modelName, String xmlFileExtension, String imageFileExtension, String highlightedActivityId) throws Exception {
    ...
    if (1 == processDefinitionQuery.count()) {
      ...
      // some test diagrams do not contain executable processes
      // and are therefore ignored by the engine
      final InputStream bpmnXmlStream = new FileInputStream("src/test/resources/org/finos/fluxnova/bpm/engine/test/api/repository/diagram/" + xmlFileName);
      final InputStream imageStream = new FileInputStream("src/test/resources/org/finos/fluxnova/bpm/engine/test/api/repository/diagram/" + imageFileName);
  ...
  private void assertLayoutCorrect(DiagramLayout processDiagramLayout) throws IOException {
    ...
    File htmlFile = new File("src/test/resources/org/finos/fluxnova/bpm/engine/test/api/repository/diagram/" + imageFileName + ".html");
