 ...
 */
package org.finos.fluxnova.bpm.engine.test.dmn.businessruletask;
...
public class DmnBusinessRuleTaskTest {
  ...
  public static final String DECISION_PROCESS = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testDecisionRef.bpmn20.xml";
  public static final String DECISION_PROCESS_EXPRESSION = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testDecisionRefExpression.bpmn20.xml";
  public static final String DECISION_PROCESS_COMPOSITEEXPRESSION = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testDecisionRefCompositeExpression.bpmn20.xml";
  public static final String DECISION_PROCESS_LATEST = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testDecisionRefLatestBinding.bpmn20.xml";
  public static final String DECISION_PROCESS_DEPLOYMENT = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testDecisionRefDeploymentBinding.bpmn20.xml";
  public static final String DECISION_PROCESS_VERSION = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testDecisionRefVersionBinding.bpmn20.xml";
  public static final String DECISION_OKAY_DMN = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testDecisionOkay.dmn11.xml";
  public static final String DECISION_NOT_OKAY_DMN = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testDecisionNotOkay.dmn11.xml";
  public static final String DECISION_VERSION_TAG_OKAY_DMN = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testDecisionVersionTagOkay.dmn11.xml";
  public static final String DECISION_POJO_DMN = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testPojo.dmn11.xml";

  public static final String DECISION_LITERAL_EXPRESSION_DMN = "org/finos/fluxnova/bpm/engine/test/dmn/deployment/DecisionWithLiteralExpression.dmn";
  public static final String DRD_DISH_RESOURCE = "org/finos/fluxnova/bpm/engine/test/dmn/deployment/drdDish.dmn11.xml";

  public static final String DECISION_OKAY_DMN12 = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/dmn12/DmnBusinessRuleTaskTest.testDecisionOkay.dmn";

  public static final String DECISION_OKAY_DMN13 = "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/dmn13/DmnBusinessRuleTaskTest.testDecisionOkay.dmn";

  public static final BpmnModelInstance BPMN_VERSION_TAG_BINDING = Bpmn.createExecutableProcess("process")
              .startEvent()
              .businessRuleTask()
                    .fluxnovaDecisionRef("decision")
                    .fluxnovaDecisionRefBinding("versionTag")
                    .fluxnovaDecisionRefVersionTag("0.0.2")
                    .fluxnovaMapDecisionResult("singleEntry")
                    .fluxnovaResultVariable("result")
              .endEvent()
                    .fluxnovaAsyncBefore()
              .done();
  ...
  public void decisionRefVersionTagBindingExpression() {
    ...
    testRule.deploy(Bpmn.createExecutableProcess("process")
        ...
        .businessRuleTask()
          .fluxnovaDecisionRef("decision")
          .fluxnovaDecisionRefBinding("versionTag")
          .fluxnovaDecisionRefVersionTag("${versionTagExpr}")
          .fluxnovaMapDecisionResult("singleEntry")
          .fluxnovaResultVariable("result")
        .endEvent()
          .fluxnovaAsyncBefore()
  ...
  public void decisionRefVersionTagBindingWithoutVersionTag() {
    ...
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess("process")
        .startEvent()
        .businessRuleTask()
        .fluxnovaDecisionRef("testDecision")
        .fluxnovaDecisionRefBinding("versionTag")
        .fluxnovaMapDecisionResult("singleEntry")
        .fluxnovaResultVariable("result")
        .endEvent()
  ...
  public void evaluateDecisionWithLiteralExpression() {
    testRule.deploy(Bpmn.createExecutableProcess("process")
        .startEvent()
        .businessRuleTask()
          .fluxnovaDecisionRef("decisionLiteralExpression")
          .fluxnovaResultVariable("result")
          .fluxnovaMapDecisionResult("singleEntry")
        .endEvent()
          .fluxnovaAsyncBefore()
  ...
  public void evaluateDecisionWithRequiredDecisions() {
    testRule.deploy(Bpmn.createExecutableProcess("process")
        .startEvent()
        .businessRuleTask()
          .fluxnovaDecisionRef("dish-decision")
          .fluxnovaResultVariable("result")
          .fluxnovaMapDecisionResult("singleEntry")
        .endEvent()
          .fluxnovaAsyncBefore()
