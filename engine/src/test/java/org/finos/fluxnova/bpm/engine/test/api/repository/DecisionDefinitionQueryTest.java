...
import static org.finos.fluxnova.bpm.engine.test.api.runtime.TestOrderingUtil.decisionDefinitionByDeployTime;
...
public class DecisionDefinitionQueryTest {
  ...
  protected static final String DMN_ONE_RESOURCE = "org/finos/fluxnova/bpm/engine/test/repository/one.dmn";
  protected static final String DMN_TWO_RESOURCE = "org/finos/fluxnova/bpm/engine/test/repository/two.dmn";
  protected static final String DMN_THREE_RESOURCE = "org/finos/fluxnova/bpm/engine/test/api/repository/three_.dmn";
  ...
  public void decisionDefinitionProperties() {
    ...
    assertThat(decisionDefinition.getResourceName()).isEqualTo("org/finos/fluxnova/bpm/engine/test/repository/one.dmn");
    ...
    assertThat(decisionDefinition.getVersion()).isEqualTo(1);
    assertThat(decisionDefinition.getResourceName()).isEqualTo("org/finos/fluxnova/bpm/engine/test/repository/two.dmn");
    assertThat(decisionDefinition.getDeploymentId()).isEqualTo(firstDeploymentId);
  }
  ...
  @org.finos.fluxnova.bpm.engine.test.Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/api/repository/versionTag.dmn",
    "org/finos/fluxnova/bpm/engine/test/api/repository/versionTagHigher.dmn" })
  @Test
