...
public class CaseServiceStageTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/api/cmmn/oneStageCase.cmmn"})
  @Test
  ...
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/api/cmmn/oneStageCaseWithManualActivation.cmmn"})
  @Test
  ...
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskAndOneStageCase.cmmn"})
  @Test
