...
import org.finos.fluxnova.bpm.engine.test.concurrency.ConcurrencyTestHelper;
...
public class SignalEventConcurrencyTest extends ConcurrencyTestHelper {
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/event/signal/SignalEventConcurrencyTest.testSignalWithCompletedExecution.bpmn20.xml" })
