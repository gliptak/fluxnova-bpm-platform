...
import static org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.ConditionalModels.PROC_DEF_KEY;
import static org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.ConditionalModels.SUB_PROCESS_ID;
...
public class MigrationWithoutTriggerConditionTest {
  ...
  public void testIntermediateConditionalEventWithSetVariableOnStartListener() {
    ...
    ProcessDefinition targetProcessDefinition = testHelper.deployAndGetDefinition(Bpmn.createExecutableProcess()
      .startEvent()
      .subProcess()
      .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_START, SetVariableDelegate.class.getName())
      .embeddedSubProcess()
        .startEvent()
        .intermediateCatchEvent(CONDITION_ID)
        .conditionalEventDefinition()
