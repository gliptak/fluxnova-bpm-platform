...
import static org.finos.fluxnova.bpm.engine.test.api.runtime.TestOrderingUtil.processInstanceByBusinessKey;
import static org.finos.fluxnova.bpm.engine.test.api.runtime.TestOrderingUtil.processInstanceByProcessDefinitionId;
import static org.finos.fluxnova.bpm.engine.test.api.runtime.TestOrderingUtil.processInstanceByProcessInstanceId;
...
public class ProcessInstanceQueryTest {
  ...
  public void deployTestProcesses() throws Exception {
    org.finos.fluxnova.bpm.engine.repository.Deployment deployment = engineRule.getRepositoryService().createDeployment()
      .addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/runtime/oneTaskProcess.bpmn20.xml")
      .addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/runtime/otherOneTaskProcess.bpmn20.xml")
      .deploy();
  ...
  public void testQueryNoSpecificsDeploymentIdMappingsInDifferentDeployments() {
    ...
    org.finos.fluxnova.bpm.engine.repository.Deployment deploymentTwo = repositoryService.createDeployment()
        .addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/runtime/oneTaskProcess.bpmn20.xml")
        .deploy();
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/runtime/superProcessWithNestedSubProcess.bpmn20.xml",
                           "org/finos/fluxnova/bpm/engine/test/api/runtime/nestedSubProcess.bpmn20.xml",
                           "org/finos/fluxnova/bpm/engine/test/api/runtime/subProcess.bpmn20.xml"})
  ...
  @Test
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/runtime/superCase.cmmn",
      "org/finos/fluxnova/bpm/engine/test/api/runtime/superProcessWithCallActivityInsideSubProcess.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/runtime/subProcess.bpmn20.xml"
    })
  ...
  @Test
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/runtime/superProcessWithCaseCallActivity.bpmn20.xml",
  ...
  @Test
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/runtime/superProcessWithCaseCallActivityInsideSubProcess.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn" })
  ...
  public void testQueryByDeploymentId() {
    ...
    org.finos.fluxnova.bpm.engine.repository.Deployment secondDeployment = repositoryService.createDeployment()
      .addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/runtime/oneTaskProcess.bpmn20.xml")
      .deploy();
  ...
  public void testQueryByAsyncBeforeActivityId() {
    ...
    ProcessDefinition testProcess = testHelper.deployAndGetDefinition(ProcessModels.newModel()
      .startEvent("start").fluxnovaAsyncBefore()
      .subProcess("subProcess").fluxnovaAsyncBefore()
      .embeddedSubProcess()
        .startEvent()
        .serviceTask("task").fluxnovaAsyncBefore().fluxnovaExpression("${true}")
        .endEvent()
      .subProcessDone()
      .endEvent("end").fluxnovaAsyncBefore()
      .done()
    );
  ...
  public void testQueryByAsyncAfterActivityId() {
    // given
    ProcessDefinition testProcess = testHelper.deployAndGetDefinition(ProcessModels.newModel()
      .startEvent("start").fluxnovaAsyncAfter()
      .subProcess("subProcess").fluxnovaAsyncAfter()
      .embeddedSubProcess()
        .startEvent()
        .serviceTask("task").fluxnovaAsyncAfter().fluxnovaExpression("${true}")
        .endEvent()
      .subProcessDone()
      .endEvent("end").fluxnovaAsyncAfter()
      .done()
    );
