...
import org.finos.fluxnova.bpm.engine.impl.bpmn.helper.CmmnProperties;
...
import org.finos.fluxnova.bpm.engine.impl.cmmn.behavior.ProcessTaskActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.cmmn.handler.CasePlanModelHandler;
import org.finos.fluxnova.bpm.engine.impl.cmmn.handler.ProcessTaskItemHandler;
import org.finos.fluxnova.bpm.engine.impl.cmmn.handler.SentryHandler;
...
import org.finos.fluxnova.bpm.model.cmmn.instance.Body;
import org.finos.fluxnova.bpm.model.cmmn.instance.ConditionExpression;
import org.finos.fluxnova.bpm.model.cmmn.instance.DefaultControl;
import org.finos.fluxnova.bpm.model.cmmn.instance.EntryCriterion;
...
import org.finos.fluxnova.bpm.model.cmmn.instance.ItemControl;
import org.finos.fluxnova.bpm.model.cmmn.instance.ManualActivationRule;
...
import org.finos.fluxnova.bpm.model.cmmn.instance.ProcessTask;
...
public class ProcessTaskPlanItemHandlerTest extends CmmnElementHandlerTest {
  ...
  public void testBinding() {
    ...
    processTask.setFluxnovaProcessBinding(processBinding.getValue());
  ...
  public void testVersionConstant() {
    ...
    processTask.setFluxnovaProcessVersion(processVersion);
  ...
  public void testBusinessKeyConstant() {
    ...
    FluxnovaIn businessKeyElement = createElement(extensionElements, null, FluxnovaIn.class);
    businessKeyElement.setFluxnovaBusinessKey(businessKey);
  ...
  public void testInputs() {
    // given:
    ExtensionElements extensionElements = addExtensionElements(processTask);
    FluxnovaIn variablesElement = createElement(extensionElements, null, FluxnovaIn.class);
    variablesElement.setFluxnovaVariables("all");
    FluxnovaIn sourceElement = createElement(extensionElements, null, FluxnovaIn.class);
    sourceElement.setFluxnovaSource("a");
    FluxnovaIn sourceExpressionElement = createElement(extensionElements, null, FluxnovaIn.class);
    sourceExpressionElement.setFluxnovaSourceExpression("${b}");
  ...
  public void testInputSource() {
    ...
    ExtensionElements extensionElements = addExtensionElements(processTask);
    FluxnovaIn sourceElement = createElement(extensionElements, null, FluxnovaIn.class);
    sourceElement.setFluxnovaSource(source);
  ...
  public void testInputSourceExpression() {
    ...
    ExtensionElements extensionElements = addExtensionElements(processTask);
    FluxnovaIn sourceElement = createElement(extensionElements, null, FluxnovaIn.class);
    sourceElement.setFluxnovaSourceExpression(source);
  ...
  public void testInputTarget() {
    ...
    ExtensionElements extensionElements = addExtensionElements(processTask);
    FluxnovaIn sourceElement = createElement(extensionElements, null, FluxnovaIn.class);
    sourceElement.setFluxnovaTarget(target);
  ...
  public void testOutputs() {
    // given:
    ExtensionElements extensionElements = addExtensionElements(processTask);
    FluxnovaOut variablesElement = createElement(extensionElements, null, FluxnovaOut.class);
    variablesElement.setFluxnovaVariables("all");
    FluxnovaOut sourceElement = createElement(extensionElements, null, FluxnovaOut.class);
    sourceElement.setFluxnovaSource("a");
    FluxnovaOut sourceExpressionElement = createElement(extensionElements, null, FluxnovaOut.class);
    sourceExpressionElement.setFluxnovaSourceExpression("${b}");
  ...
  public void testRepetitionRuleCustomStandardEvents() {
    ...
    repetitionRule.setFluxnovaRepeatOnStandardEvent(CaseExecutionListener.DISABLE);
