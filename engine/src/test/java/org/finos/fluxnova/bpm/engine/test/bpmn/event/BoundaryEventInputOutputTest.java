 ...
 */
package org.finos.fluxnova.bpm.engine.test.bpmn.event;
...
import org.finos.fluxnova.bpm.engine.test.bpmn.iomapping.VariableLogDelegate;
  ...
  protected static final BpmnModelInstance EVENT_GATEWAY_PROCESS =
    Bpmn.createExecutableProcess("process")
      ...
      .serviceTask("inputParameterTask")
        .fluxnovaInputParameter("variable1", "testValue")
        .fluxnovaClass(VariableLogDelegate.class)
      .endEvent()
