...
public class CallActivityTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcess.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcess.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcessParentVariableAccess.bpmn20.xml"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcess.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/concurrentSubProcessParentVariableAccess.bpmn20.xml"
  })
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcessWithExpressions.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
   ...
   */
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessEndsSuperProcess.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testCallParallelSubProcess.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleParallelSubProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testCallSequentialSubProcess.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcessWithExpressions.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess2.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testTimerOnCallActivity.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
   ...
   */
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessDataInputOutput.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
   ...
   */
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessLimitedDataInputOutputTypedApi.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
   ...
   */
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessAllDataInputOutputTypedApi.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
  ...
  public void testSubProcessWithDataInputOutputWithoutTarget() {
    ...
    FluxnovaIn camundaIn = modelInstance.newInstance(FluxnovaIn.class);
    camundaIn.setFluxnovaSource("superVariable");
    callActivityBuilder.addExtensionElement(camundaIn);

    deployAndExpectException(modelInstance);
    // set target
    camundaIn.setFluxnovaTarget("subVariable");

    // create camunda:in with sourceExpression but without target
    camundaIn = modelInstance.newInstance(FluxnovaIn.class);
    camundaIn.setFluxnovaSourceExpression("${x+5}");
    callActivityBuilder.addExtensionElement(camundaIn);

    deployAndExpectException(modelInstance);
    // set target
    camundaIn.setFluxnovaTarget("subVariable2");

    // create camunda:out with source but without target
    FluxnovaOut camundaOut = modelInstance.newInstance(FluxnovaOut.class);
    camundaOut.setFluxnovaSource("subVariable");
    callActivityBuilder.addExtensionElement(camundaOut);

    deployAndExpectException(modelInstance);
    // set target
    camundaOut.setFluxnovaTarget("superVariable");

    // create camunda:out with sourceExpression but without target
    camundaOut = modelInstance.newInstance(FluxnovaOut.class);
    camundaOut.setFluxnovaSourceExpression("${y+1}");
    callActivityBuilder.addExtensionElement(camundaOut);

    deployAndExpectException(modelInstance);
    // set target
    camundaOut.setFluxnovaTarget("superVariable2");
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessDataInputOutput.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/dataSubProcess.bpmn20.xml"})
  @Test
   ...
   */
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessDataInputOutputAsExpression.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/dataSubProcess.bpmn20.xml"})
  @Test
   ...
   */
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testTwoSubProcesses.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
   ...
   */
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessAllDataInputOutputWithAdditionalInputMapping.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessLocalInputAllVariables.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessLocalInputSingleVariable.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessLocalInputSingleVariableExpression.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessLocalOutputAllVariables.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessLocalOutputSingleVariable.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
   ...
   */
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessBusinessKeyInput.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcessWithHashExpressions.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testInterruptingEventSubProcessEventSubscriptions.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/interruptingEventSubProcessEventSubscriptions.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testLiteralSourceExpression.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessDataOutputOnError.bpmn",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/subProcessWithError.bpmn"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessDataOutputOnThrownError.bpmn",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/subProcessWithThrownError.bpmn"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testTwoSubProcessesDataOutputOnError.bpmn",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/subProcessCallErrorSubProcess.bpmn",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/subProcessWithError.bpmn"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testTwoSubProcessesLimitedDataOutputOnError.bpmn",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/subProcessCallErrorSubProcessWithLimitedOutMapping.bpmn",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/subProcessWithError.bpmn"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivityAdvancedTest.testCallProcessByVersionAsExpression.bpmn20.xml",
  ...
  public void testCallCaseByVersionAsExpression() {
    ...
    String bpmnResourceName = "org/finos/fluxnova/bpm/engine/test/api/oneTaskProcess.bpmn20.xml";
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivityAdvancedTest.testCallProcessByVersionAsDelegateExpression.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
  })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/subProcessWithVersionTag.bpmn20.xml" })
  @Test
  ...
  public void testCallProcessWithoutVersionTag() {
    ...
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess("process")
        ...
        .fluxnovaCalledElementBinding("versionTag")
        .endEvent()
        .done();
  ...
  public void testCallProcessByVersionTagTwoSubprocesses() {
   ...
   testRule.deploy(modelInstance);
   testRule.deploy("org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/subProcessWithVersionTag.bpmn20.xml");
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/orderProcess.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/checkCreditProcess.bpmn20.xml"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcess.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testNestedCallActivity.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcess.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testNestedCallActivity.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testDoubleNestedCallActivity.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
  })
  @Test
  ...
  public void testTransientVariableInputMapping() {
    ...
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess("simpleSubProcess")
      .startEvent()
      .serviceTask()
      .fluxnovaClass(AssertTransientVariableDelegate.class)
      .userTask()
      .endEvent()
      .done();

   testRule.deploy("org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CallActivity.testSubProcessAllDataInputOutputTypedApi.bpmn20.xml");
   testRule.deploy(modelInstance);
  ...
  protected BpmnModelInstance getModelWithCallActivityVersionTagBinding(String versionTag) {
    return Bpmn.createExecutableProcess("process")
        ...
        .calledElement("subProcess")
        .fluxnovaCalledElementBinding("versionTag")
        .fluxnovaCalledElementVersionTag(versionTag)
        .endEvent()
        .done();
  }
  ...
  protected void cleanupDeployments() {
    ...
    for (org.finos.fluxnova.bpm.engine.repository.Deployment currentDeployment : deployments) {
