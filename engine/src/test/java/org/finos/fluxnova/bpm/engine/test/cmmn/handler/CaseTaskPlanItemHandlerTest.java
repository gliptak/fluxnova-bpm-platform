...
import org.finos.fluxnova.bpm.engine.impl.cmmn.behavior.CaseTaskActivityBehavior;
...
public class CaseTaskPlanItemHandlerTest extends CmmnElementHandlerTest {
  ...
  public void testBinding() {
    ...
    caseTask.setFluxnovaCaseBinding(caseBinding.getValue());
  ...
  public void testVersionConstant() {
    ...
    caseTask.setFluxnovaCaseVersion(caseVersion);
