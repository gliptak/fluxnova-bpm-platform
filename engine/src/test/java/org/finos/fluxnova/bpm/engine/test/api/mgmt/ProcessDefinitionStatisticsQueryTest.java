...
public class ProcessDefinitionStatisticsQueryTest extends PluggableProcessEngineTest {
  ...
  public void testProcessDefinitionStatisticsQueryForMultipleVersions() {
    org.finos.fluxnova.bpm.engine.repository.Deployment deployment =
        repositoryService.createDeployment()
          .addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/mgmt/StatisticsTest.testStatisticsQueryWithFailedJobs.bpmn20.xml")
          .deploy();
  ...
  public void testProcessDefinitionStatisticsQueryPagination() {
    org.finos.fluxnova.bpm.engine.repository.Deployment deployment =
        repositoryService.createDeployment()
          .addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/mgmt/StatisticsTest.testStatisticsQuery.bpmn20.xml")
          .deploy();
  ...
  public void testProcessDefinitionStatisticsProperties() {
    String resourceName = "org/finos/fluxnova/bpm/engine/test/api/mgmt/ProcessDefinitionStatisticsQueryTest.testProcessDefinitionStatisticsProperties.bpmn20.xml";
