 ...
 */
package org.finos.fluxnova.bpm.engine.test.cmmn;
...
public class CmmnDisabledTest {
  ...
  public static ProcessEngineBootstrapRule bootstrapRule = new ProcessEngineBootstrapRule(
      "org/finos/fluxnova/bpm/application/impl/deployment/cmmn.disabled.camunda.cfg.xml");
  ...
  public void testTaskQueryAuthorization() {
    // given
    engineTestRule.deploy("org/finos/fluxnova/bpm/engine/test/api/oneTaskProcess.bpmn20.xml");
    engineTestRule.deploy("org/finos/fluxnova/bpm/engine/test/api/twoTasksProcess.bpmn20.xml");
