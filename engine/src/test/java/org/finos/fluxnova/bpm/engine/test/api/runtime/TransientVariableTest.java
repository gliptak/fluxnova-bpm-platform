...
import static org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.ConditionalModels.USER_TASK_ID;
import static org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.ConditionalModels.VARIABLE_NAME;
...
public class TransientVariableTest {
  ...
  public void createTransientTypedVariablesUsingVariableMap() throws URISyntaxException {
    ...
    BpmnModelInstance instance = Bpmn.createExecutableProcess("Process")
      .startEvent()
      .serviceTask()
        .fluxnovaClass(ReadTransientVariablesOfAllTypesDelegate.class.getName())
      .userTask("user")
      .endEvent()
      .done();
    ...
    runtimeService.startProcessInstanceByKey("Process",
        Variables.createVariables()
            ...
            .putValueTyped("l", Variables.fileValue(new File(this.getClass().getClassLoader()
                .getResource("org/finos/fluxnova/bpm/engine/test/standalone/variables/simpleFile.txt").toURI()), true)));
  ...
  public void createTransientVariablesUsingFluentBuilder() {
    ...
    BpmnModelInstance simpleInstanceWithListener = Bpmn.createExecutableProcess("Process")
        .startEvent()
          .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_END, ReadTransientVariableExecutionListener.class)
        .userTask()
        .endEvent()
        .done();
  ...
  public void triggerConditionalEventWithTransientVariable() {
    ...
    BpmnModelInstance instance = Bpmn.createExecutableProcess(CONDITIONAL_PROCESS_KEY)
        .startEvent()
        .serviceTask()
        .fluxnovaClass(SetVariableTransientDelegate.class.getName())
  ...
  public void testParallelProcessWithSetVariableTransientAfterReachingEventBasedGW() {
    BpmnModelInstance modelInstance =
        Bpmn.createExecutableProcess(CONDITIONAL_PROCESS_KEY)
          ...
          .conditionalEventDefinition()
          .condition(VAR_CONDITION)
          .fluxnovaVariableEvents(Arrays.asList("create", "update"))
          .conditionalEventDefinitionDone()
          .userTask()
          .name("taskAfter")
          .endEvent()
  ...
  public void setVariableTransientForCase() {
    // given
    testRule.deploy("org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn");
  ...
  public void testFormFieldsWithCustomTransientFlags() {
    // given
    testRule.deploy("org/finos/fluxnova/bpm/engine/test/api/form/TransientVariableTest.taskFormFieldsWithTransientFlags.bpmn20.xml");
  ...
  public void testStartProcessInstanceWithFormsUsingTransientVariables() {
    // given
    testRule.deploy("org/finos/fluxnova/bpm/engine/test/api/form/TransientVariableTest.startFormFieldsWithTransientFlags.bpmn20.xml");
  ...
  public void testExclusiveGateway() {
    // given
    testRule.deploy("org/finos/fluxnova/bpm/engine/test/bpmn/gateway/ExclusiveGatewayTest.testDivergingExclusiveGateway.bpmn20.xml");
  ...
  public void testChangeTransientVariable() throws URISyntaxException {
    ...
    BpmnModelInstance instance = Bpmn.createExecutableProcess("Process")
      .startEvent()
      .serviceTask()
        .fluxnovaClass(ChangeVariableTransientDelegate.class.getName())
      .userTask("user")
      .endEvent()
      .done();
  ...
  public void testSwitchTransientToNonVariable() throws URISyntaxException {
    ...
    BpmnModelInstance instance = Bpmn.createExecutableProcess("Process")
      .startEvent()
      .serviceTask()
        .fluxnovaClass(SwitchTransientVariableDelegate.class.getName())
      .userTask("user")
      .endEvent()
      .done();
  ...
  public void testSwitchNonToTransientLocalVariable() throws URISyntaxException {
    ...
    BpmnModelInstance instance = Bpmn.createExecutableProcess("Process")
      .startEvent()
      .serviceTask()
        .fluxnovaClass(SetTransientLocalVariableDelegate.class)
      .endEvent()
      .done();
  ...
  public void testKeepTransientIfUntypedValueIsAccessed() {
    ...
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess("aProcess")
      .startEvent()
      .serviceTask()
        .fluxnovaClass(ReadTypedTransientVariableDelegate.class)
      .userTask()
      .endEvent()
      .done();
    testRule.deploy(modelInstance);
  ...
  public void testTransientLocalVariable() {
    ...
    BpmnModelInstance model = Bpmn.createExecutableProcess("process")
        .startEvent()
        .serviceTask().fluxnovaClass(SetTransientLocalVariableDelegate.class)
        .userTask()
        .endEvent()
        .done();
  ...
  public void shouldRemoveNonTransientAndSetNonTransient() {
    ...
    BpmnModelInstance model = Bpmn.createExecutableProcess("process")
        .startEvent()
        .serviceTask().fluxnovaClass(RemoveAndSetVariableDelegate.class)
        .userTask()
        .endEvent()
        .done();
