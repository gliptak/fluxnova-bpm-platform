...
import org.finos.fluxnova.bpm.engine.exception.cmmn.CaseDefinitionNotFoundException;
...
public class CaseCallActivityTest extends CmmnTest {
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testCallCaseAsConstant.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testCallCaseAsExpressionStartsWithDollar.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testCallCaseAsExpressionStartsWithHash.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testCallCaseWithCompositeExpression.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
  })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testCallLatestCase.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  public void testCallLatestCase() {
    // given
    String cmmnResourceName = "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn";
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testCallCaseByDeployment.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testCallCaseByVersion.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testCallCaseByVersionAsExpression.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testCallCaseAsConstant.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testInputBusinessKey.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testInputDifferentBusinessKey.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testInputSource.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testInputSourceDifferentTarget.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testInputSourceExpression.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testInputSourceAsCompositeExpression.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
  })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testInputAll.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testCompleteCase.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testOutputSource.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testOutputSourceDifferentTarget.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testOutputSourceExpression.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testOutputSourceAsCompositeExpression.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
  })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testOutputAll.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testVariablesRoundtrip.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testOutputAll.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCaseWithManualActivation.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivityTest.testCompletionOfCaseWithTwoTasks.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/twoTaskCase.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivity.testSubProcessLocalInputAllVariables.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn" })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivity.testSubProcessLocalInputSingleVariable.bpmn20.xml",
  "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn" })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivity.testSubProcessLocalInputSingleVariableExpression.bpmn20.xml",
  "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn" })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivity.testSubProcessLocalOutputAllVariables.bpmn20.xml",
  "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCaseWithManualActivation.cmmn" })
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/CaseCallActivity.testSubProcessLocalOutputSingleVariable.bpmn20.xml",
  "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn" })
  @Test
