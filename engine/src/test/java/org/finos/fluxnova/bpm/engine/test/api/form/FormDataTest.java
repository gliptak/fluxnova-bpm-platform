...
import org.finos.fluxnova.bpm.engine.impl.form.validator.FormFieldValidatorException;
...
public class FormDataTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/form/FormDataTest.testDoubleQuotesAreEscapedInGeneratedTaskForms.bpmn20.xml")
  @Test
