...
public class MultiTenancyCallActivityTest extends PluggableProcessEngineTest {
  ...
  protected static final String CMMN = "org/finos/fluxnova/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testSimpleDeployment.cmmn";
  ...
  public void testStartProcessInstanceWithDeploymentBinding() {
    ...
    BpmnModelInstance callingProcess = Bpmn.createExecutableProcess("callingProcess")
      ...
      .callActivity()
        ...
        .fluxnovaCalledElementBinding("deployment")
      .endEvent()
      .done();
  ...
  public void testStartProcessInstanceWithLatestBindingSameVersion() {
    ...
    BpmnModelInstance callingProcess = Bpmn.createExecutableProcess("callingProcess")
      ...
      .callActivity()
        .calledElement("subProcess")
        .fluxnovaCalledElementBinding("latest")
      .endEvent()
      .done();
  ...
  public void testStartProcessInstanceWithVersionBinding() {
    ...
    BpmnModelInstance callingProcess = Bpmn.createExecutableProcess("callingProcess")
      ...
      .callActivity()
        ...
        .fluxnovaCalledElementVersion("1")
      .endEvent()
      .done();
  ...
  public void testStartProcessInstanceWithVersionTagBinding() {
    ...
    testRule.deployForTenant(TENANT_ONE, "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/subProcessWithVersionTag.bpmn20.xml");
    testRule.deployForTenant(TENANT_TWO, callingProcess);
    testRule.deployForTenant(TENANT_TWO, "org/finos/fluxnova/bpm/engine/test/bpmn/callactivity/subProcessWithVersionTag2.bpmn20.xml");
  ...
  public void testFailStartProcessInstanceFromOtherTenantWithVersionBinding() {
    ...
    BpmnModelInstance callingProcess = Bpmn.createExecutableProcess("callingProcess")
      ...
      .callActivity()
        .calledElement("subProcess")
        .fluxnovaCalledElementBinding("version")
        .fluxnovaCalledElementVersion("2")
      .endEvent()
      .done();
  ...
  public void testStartCaseInstanceWithVersionBinding() {
    ...
    BpmnModelInstance callingProcess = Bpmn.createExecutableProcess("callingProcess")
      ...
      .callActivity()
        .fluxnovaCaseRef("Case_1")
        .fluxnovaCaseBinding("version")
        .fluxnovaCaseVersion("1")
      .endEvent()
      .done();
  ...
  public void testCalledElementTenantIdConstant() {
    ...
    BpmnModelInstance callingProcess = Bpmn.createExecutableProcess("callingProcess")
        ...
        .callActivity()
          .calledElement("subProcess")
          .fluxnovaCalledElementTenantId(TENANT_ONE)
        .endEvent()
        .done();
  ...
  public void testCaseRefTenantIdConstant() {
    ...
    BpmnModelInstance callingProcess = Bpmn.createExecutableProcess("callingProcess")
      ...
      .callActivity()
        .fluxnovaCaseRef("Case_1")
        .fluxnovaCaseTenantId(TENANT_ONE)
      .endEvent()
      .done();
  ...
  protected BpmnModelInstance createCallingProcess(String processId, String versionTagValue) {
    return Bpmn.createExecutableProcess(processId)
        ...
        .callActivity()
          ...
          .fluxnovaCalledElementVersionTag(versionTagValue)
        .endEvent()
        .done();
  }
