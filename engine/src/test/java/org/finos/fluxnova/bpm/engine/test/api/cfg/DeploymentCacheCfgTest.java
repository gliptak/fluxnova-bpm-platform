...
public class DeploymentCacheCfgTest {
  ...
  protected BpmnModelInstance createModel(String suffix) {
    BpmnModelInstance bpmnModel = Bpmn.createExecutableProcess("Process" + suffix)
        ...
        .endEvent("endEvent")
        .done();
    org.finos.fluxnova.bpm.model.bpmn.instance.Process model = bpmnModel.getModelElementById("Process" + suffix);
    model.setFluxnovaCandidateStarterUsers("demo" + suffix);
    return bpmnModel;
  }
