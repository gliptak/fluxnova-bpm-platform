...
import org.finos.fluxnova.bpm.container.impl.metadata.BpmPlatformXmlParser;
...
public class BpmPlatformXmlParserTest {
  ...
  public void testParseBpmPlatformXmlNoEngine() {
    ...
    assertEquals("org.finos.fluxnova.bpm.engine.impl.jobexecutor.DefaultJobExecutor", jobAcquisitionXml.getJobExecutorClassName());
