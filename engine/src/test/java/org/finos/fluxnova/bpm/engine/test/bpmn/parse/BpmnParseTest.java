...
import org.finos.fluxnova.bpm.engine.test.util.SystemPropertiesRule;
...
public class BpmnParseTest {
  ...
  public void testParseWithBpmnNamespacePrefix() {
    repositoryService.createDeployment()
        .addClasspathResource("org/finos/fluxnova/bpm/engine/test/bpmn/parse/BpmnParseTest.testParseWithBpmnNamespacePrefix.bpmn20.xml").deploy();
  ...
  public void testParseWithMultipleDocumentation() {
    repositoryService.createDeployment()
        .addClasspathResource("org/finos/fluxnova/bpm/engine/test/bpmn/parse/BpmnParseTest.testParseWithMultipleDocumentation.bpmn20.xml").deploy();
    assertEquals(1, repositoryService.createProcessDefinitionQuery().count());
  }

  @Test
  public void testParseCollaborationPlane() {
    repositoryService.createDeployment().addClasspathResource("org/finos/fluxnova/bpm/engine/test/bpmn/parse/BpmnParseTest.testParseCollaborationPlane.bpmn").deploy();
    assertEquals(1, repositoryService.createProcessDefinitionQuery().count());
  }
  ...
  @Test
  @Deployment
  public void testParseDefinitionWithFluxnovaNamespace(){
  ...
  public void testParseSwitchedSourceAndTargetRefsForAssociations() {
    repositoryService.createDeployment()
        .addClasspathResource("org/finos/fluxnova/bpm/engine/test/bpmn/parse/BpmnParseTest.testParseSwitchedSourceAndTargetRefsForAssociations.bpmn20.xml").deploy();

    assertEquals(1, repositoryService.createProcessDefinitionQuery().count());
  }

  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/bpmn/event/compensate/CompensateEventTest.compensationMiActivity.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/bpmn/event/compensate/CompensateEventTest.compensationMiSubprocess.bpmn20.xml")
  @Test
  ...
  @Test
  public void testNoFluxnovaInSourceThrowsError() {
    try {
      String resource = TestHelper.getBpmnProcessDefinitionResource(getClass(), "testNoFluxnovaInSourceThrowsError");
      repositoryService.createDeployment().name(resource).addClasspathResource(resource).deploy();
  ...
  @Test
  public void testNoFluxnovaInSourceShouldWithoutValidation() {
    try {
  ...
  @Test
  public void testEmptyFluxnovaInSourceThrowsError() {
    try {
  ...
  @Test
  public void testEmptyFluxnovaInSourceWithoutValidation() {
    try {
      processEngineConfiguration.setDisableStrictCallActivityValidation(true);
  ...
  @Test
  public void testNoFluxnovaInTargetThrowsError() {
    try {
      String resource = TestHelper.getBpmnProcessDefinitionResource(getClass(), "testNoFluxnovaInTargetThrowsError");
      repositoryService.createDeployment().name(resource).addClasspathResource(resource).deploy();
  ...
  @Test
  public void testNoFluxnovaInTargetWithoutValidation() {
    try {
      processEngineConfiguration.setDisableStrictCallActivityValidation(true);
  ...
  @Test
  public void testEmptyFluxnovaInTargetThrowsError() {
    try {
  ...
  @Test
  public void testEmptyFluxnovaInTargetWithoutValidation() {
    try {
      processEngineConfiguration.setDisableStrictCallActivityValidation(true);
  ...
  @Test
  public void testNoFluxnovaOutSourceThrowsError() {
    try {
      String resource = TestHelper.getBpmnProcessDefinitionResource(getClass(), "testNoFluxnovaOutSourceThrowsError");
      repositoryService.createDeployment().name(resource).addClasspathResource(resource).deploy();
  ...
  @Test
  public void testNoFluxnovaOutSourceWithoutValidation() {
    try {
      processEngineConfiguration.setDisableStrictCallActivityValidation(true);
  ...
  @Test
  public void testEmptyFluxnovaOutSourceThrowsError() {
    try {
  ...
  @Test
  public void testEmptyFluxnovaOutSourceWithoutValidation() {
    try {
      processEngineConfiguration.setDisableStrictCallActivityValidation(true);
  ...
  @Test
  public void testNoFluxnovaOutTargetThrowsError() {
    try {
      String resource = TestHelper.getBpmnProcessDefinitionResource(getClass(), "testNoFluxnovaOutTargetThrowsError");
      repositoryService.createDeployment().name(resource).addClasspathResource(resource).deploy();
  ...
  @Test
  public void testNoFluxnovaOutTargetWithoutValidation() {
    try {
      processEngineConfiguration.setDisableStrictCallActivityValidation(true);
  ...
  @Test
  public void testEmptyFluxnovaOutTargetThrowsError() {
    try {
  ...
  @Test
  public void testEmptyFluxnovaOutTargetWithoutValidation() {
    try {
      processEngineConfiguration.setDisableStrictCallActivityValidation(true);
  ...
  public void testFeatureSecureProcessingRejectsDefinitionDueToAttributeLimit() {
    ...
    MatcherAssume.assumeThat(System.getProperty("java.vm.vendor"), not(containsString("IBM")));
    try {
  ...
  @Test
  @WatchLogger(loggerNames = {"org.finos.fluxnova.bpm.engine.bpmn.parser"}, level = "INFO")
  ...
  public void testParseEmptyExtensionProperty() {
    ...
    // when
    repositoryService.createDeployment()
    .addClasspathResource("org/finos/fluxnova/bpm/engine/test/bpmn/parse/BpmnParseTest.testParseEmptyExtensionProperty.bpmn").deploy();
