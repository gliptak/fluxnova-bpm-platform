 ...
 */
package org.finos.fluxnova.bpm.engine.test.api.history.removaltime.batch;
...
import static org.finos.fluxnova.bpm.engine.ProcessEngineConfiguration.HISTORY_REMOVAL_TIME_STRATEGY_NONE;
import static org.finos.fluxnova.bpm.engine.ProcessEngineConfiguration.HISTORY_REMOVAL_TIME_STRATEGY_START;
import static org.finos.fluxnova.bpm.engine.test.api.history.removaltime.batch.helper.BatchSetRemovalTimeRule.addDays;
...
import org.finos.fluxnova.bpm.engine.history.CleanableHistoricDecisionInstanceReportResult;
import org.finos.fluxnova.bpm.engine.history.CleanableHistoricProcessInstanceReportResult;
...
import org.finos.fluxnova.bpm.engine.history.SetRemovalTimeSelectModeForHistoricBatchesBuilder;
import org.finos.fluxnova.bpm.engine.history.SetRemovalTimeSelectModeForHistoricDecisionInstancesBuilder;
import org.finos.fluxnova.bpm.engine.history.SetRemovalTimeSelectModeForHistoricProcessInstancesBuilder;
import org.finos.fluxnova.bpm.engine.history.SetRemovalTimeToHistoricBatchesBuilder;
import org.finos.fluxnova.bpm.engine.history.SetRemovalTimeToHistoricDecisionInstancesBuilder;
import org.finos.fluxnova.bpm.engine.history.SetRemovalTimeToHistoricProcessInstancesBuilder;
...
import org.finos.fluxnova.bpm.engine.test.api.history.removaltime.batch.helper.BatchSetRemovalTimeRule;
...
public class BatchSetRemovalTimeTest {
  ...
  public void shouldCreateDeploymentAwareBatchJobs_ProcessInstances() {
    ...
    List<String> deploymentIds = engineRule.getRepositoryService().createDeploymentQuery()
        .list().stream()
        .map(org.finos.fluxnova.bpm.engine.repository.Deployment::getId)
  ...
  public void shouldCreateDeploymentAwareBatchJobs_StandaloneDecision() {
    ...
    engineTestRule.deploy("org/finos/fluxnova/bpm/engine/test/dmn/deployment/drdDish.dmn11.xml");
    decisionService.evaluateDecisionByKey("dish-decision")
    .variables(
      Variables.createVariables()
        .putValue("temperature", 32)
  ...
  @Test
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/dmn/deployment/drdDish.dmn11.xml")
