...
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.HistoricProcessInstanceEntity;
...
import org.finos.fluxnova.bpm.engine.test.api.runtime.RestartProcessInstanceSyncTest.SetVariableExecutionListenerImpl;
import org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.ProcessModels;
import org.finos.fluxnova.bpm.engine.test.api.runtime.util.IncrementCounterListener;
...
public class RestartProcessInstanceAsyncTest {
  ...
  public void shouldRestartProcessInstance() {
    ...
    org.junit.jupiter.api.Assertions.assertEquals(task1.getTaskDefinitionKey(), restartedTask.getTaskDefinitionKey());
    ...
    org.junit.jupiter.api.Assertions.assertEquals(task2.getTaskDefinitionKey(), restartedTask.getTaskDefinitionKey());
  }
  ...
  public void shouldRestartProcessInstanceWithInitialVariables() {
    ...
    BpmnModelInstance instance = Bpmn.createExecutableProcess("Process")
        .startEvent()
        .userTask("userTask1")
        .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_END, SetVariableExecutionListenerImpl.class.getName())
        .userTask("userTask2")
        .endEvent()
        .done();
  ...
  public void shouldSkipCustomListeners() {
    ...
    ProcessDefinition processDefinition = testRule.deployAndGetDefinition(modify(ProcessModels.TWO_TASKS_PROCESS).activityBuilder("userTask1")
        .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_START, IncrementCounterListener.class.getName()).done());
    ProcessInstance processInstance1 = runtimeService.startProcessInstanceByKey("Process");
    ProcessInstance processInstance2 = runtimeService.startProcessInstanceByKey("Process");
  ...
  public void shouldSkipIoMappings() {
    ...
    ProcessDefinition processDefinition = testRule.deployAndGetDefinition(
        modify(ProcessModels.TWO_TASKS_PROCESS).activityBuilder("userTask1").fluxnovaInputParameter("foo", "bar").done());
    ProcessInstance processInstance1 = runtimeService.startProcessInstanceByKey("Process");
    ProcessInstance processInstance2 = runtimeService.startProcessInstanceByKey("Process");
