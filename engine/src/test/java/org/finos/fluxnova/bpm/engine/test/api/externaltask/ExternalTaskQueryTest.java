...
import static org.finos.fluxnova.bpm.engine.test.api.runtime.TestOrderingUtil.*;
...
public class ExternalTaskQueryTest extends PluggableProcessEngineTest {
  ...
  public void testQueryByProcessDefinitionId() {
    ...
    org.finos.fluxnova.bpm.engine.repository.Deployment secondDeployment = repositoryService
      .createDeployment()
      .addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/externaltask/oneExternalTaskProcess.bpmn20.xml")
      .deploy();
  ...
  public void shouldCheckPresenceOfVersionTag() {
    BpmnModelInstance process = Bpmn.createExecutableProcess("process")
        .fluxnovaVersionTag("1.2.3.4")
        .startEvent()
        .serviceTask()
          .fluxnovaExternalTask("my-topic")
        .endEvent()
        .done();
