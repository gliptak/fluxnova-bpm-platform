...
public class DecisionMetricsTest extends AbstractMetricsTest {
  ...
  public static final String DRD_DISH_DECISION_TABLE = "org/finos/fluxnova/bpm/engine/test/dmn/deployment/drdDish.dmn11.xml";
  public static final String DMN_DECISION_LITERAL_EXPRESSION = "org/finos/fluxnova/bpm/engine/test/api/dmn/DecisionWithLiteralExpression.dmn";
  public static final String DMN_FILE = "org/finos/fluxnova/bpm/engine/test/api/mgmt/metrics/ExecutedDecisionElementsTest.dmn11.xml";
  ...
  public void testBusinessRuleTask() {
    ...
    task.setFluxnovaDecisionRef("decision");
