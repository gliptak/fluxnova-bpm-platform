...
import org.finos.fluxnova.bpm.engine.test.errorcode.FailingJavaDelegateWithCustomException;
import org.finos.fluxnova.bpm.engine.test.errorcode.FailingJavaDelegateWithErrorCode;
import org.finos.fluxnova.bpm.engine.test.errorcode.FailingJavaDelegateWithOleAndErrorCode;
...
public class CustomErrorCodeProviderTest {
  ...
  public void shouldOverrideCodeFromDelegationCodeWithBuiltinCode() {
    ...
    BpmnModelInstance myProcess = Bpmn.createExecutableProcess("foo")
        .startEvent()
        .serviceTask()
          .fluxnovaClass(FailingJavaDelegateWithOleAndErrorCode.class)
        .endEvent()
        .done();
  ...
  public void shouldProvideCustomCodeFromDelegationCodeWithCustomException() {
    ...
    BpmnModelInstance myProcess = Bpmn.createExecutableProcess("foo")
        .startEvent()
        .serviceTask()
          .fluxnovaClass(FailingJavaDelegateWithCustomException.class)
        .endEvent()
        .done();
