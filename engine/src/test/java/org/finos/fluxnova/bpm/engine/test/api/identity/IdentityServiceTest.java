...
import org.finos.fluxnova.bpm.engine.impl.identity.Account;
...
public class IdentityServiceTest {
  ...
  public void testSaveUserWithGenericResourceId() {
    processEngine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/finos/fluxnova/bpm/engine/test/api/identity/generic.resource.id.whitelist.camunda.cfg.xml")
      .buildProcessEngine();
  ...
  @Test
  public void testFluxnovaAdminId() {
    String camundaAdminID = "fluxnova-admin";
    try {
  ...
  public void testCustomResourceWhitelist() {
    processEngine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/finos/fluxnova/bpm/engine/test/api/identity/custom.whitelist.camunda.cfg.xml")
      .buildProcessEngine();
  ...
  public void testSeparateResourceWhitelistPatterns() {
    processEngine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/finos/fluxnova/bpm/engine/test/api/identity/custom.resource.whitelist.camunda.cfg.xml")
      .buildProcessEngine();
