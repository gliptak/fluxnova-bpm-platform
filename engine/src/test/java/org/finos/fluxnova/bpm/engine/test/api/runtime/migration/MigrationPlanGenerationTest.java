...
import static org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.ConditionalModels.BOUNDARY_ID;
import static org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.ConditionalModels.CONDITIONAL_PROCESS_KEY;
import static org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.ConditionalModels.CONDITION_ID;
import static org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels.EVENT_SUB_PROCESS_ID;
...
import static org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels.EVENT_SUB_PROCESS_TASK_ID;
import static org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels.USER_TASK_ID;
...
import org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.EventBasedGatewayModels;
import org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels;
import org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.ExternalTaskModels;
import org.finos.fluxnova.bpm.engine.test.api.runtime.migration.models.GatewayModels;
...
import org.finos.fluxnova.bpm.engine.test.util.MigrationPlanAssert;
...
public class MigrationPlanGenerationTest {
  ...
  public void testMapEqualUnsupportedAsyncBeforeActivities() {
    BpmnModelInstance testModel = modify(ProcessModels.UNSUPPORTED_ACTIVITIES)
      .flowNodeBuilder("startEvent").fluxnovaAsyncBefore()
      .moveToNode("decisionTask").fluxnovaAsyncBefore()
      .moveToNode("throwEvent").fluxnovaAsyncAfter()
      .moveToNode("serviceTask").fluxnovaAsyncBefore()
      .moveToNode("sendTask").fluxnovaAsyncBefore()
      .moveToNode("scriptTask").fluxnovaAsyncBefore()
      .moveToNode("endEvent").fluxnovaAsyncBefore()
      .done();
  ...
  public void testMapEqualUnsupportedAsyncAfterActivities() {
    BpmnModelInstance testModel = modify(ProcessModels.UNSUPPORTED_ACTIVITIES)
      .flowNodeBuilder("startEvent").fluxnovaAsyncAfter()
      .moveToNode("decisionTask").fluxnovaAsyncAfter()
      .moveToNode("throwEvent").fluxnovaAsyncAfter()
      .moveToNode("serviceTask").fluxnovaAsyncAfter()
      .moveToNode("sendTask").fluxnovaAsyncAfter()
      .moveToNode("scriptTask").fluxnovaAsyncAfter()
      .moveToNode("endEvent").fluxnovaAsyncAfter()
      .done();
