...
import static org.finos.fluxnova.bpm.engine.impl.util.StringUtil.hasText;
...
public class HistoryEventDataTest {
    ...
    @Test
    @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/threeTasksProcess.bpmn20.xml")
    public void verify() {
