...
public class IntermediateConditionalEventTest extends AbstractConditionalEventTestCase {
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/bpmn/event/conditional/IntermediateConditionalEventTest.testParallelVariableValue.bpmn20.xml"})
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/bpmn/event/conditional/IntermediateConditionalEventTest.testSubProcessVariableValue.bpmn20.xml"})
    ...
    final BpmnModelInstance modelInstance = Bpmn.createExecutableProcess(CONDITIONAL_EVENT_PROCESS_KEY)
          ...
          .intermediateCatchEvent(CONDITIONAL_EVENT)
            .conditionalEventDefinition()
              ...
              .fluxnovaVariableName(VARIABLE_NAME)
  ...
  public void testVariableConditionWithVariableEvent() {
    ...
    final BpmnModelInstance modelInstance = Bpmn.createExecutableProcess(CONDITIONAL_EVENT_PROCESS_KEY)
          ...
          .intermediateCatchEvent(CONDITIONAL_EVENT)
            .conditionalEventDefinition()
              .condition(CONDITION_EXPR)
              .fluxnovaVariableEvents(CONDITIONAL_VAR_EVENT_UPDATE)
            .conditionalEventDefinitionDone()
          .userTask()
            .name(TASK_AFTER_CONDITION)
          .endEvent()
