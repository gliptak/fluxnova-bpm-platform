...
import org.finos.fluxnova.bpm.engine.impl.cfg.multitenancy.TenantIdProviderCaseInstanceContext;
import org.finos.fluxnova.bpm.engine.impl.cfg.multitenancy.TenantIdProviderHistoricDecisionInstanceContext;
import org.finos.fluxnova.bpm.engine.impl.cfg.multitenancy.TenantIdProviderProcessInstanceContext;
...
public class TenantIdProviderTest {
  ...
  protected static final String CONFIGURATION_RESOURCE = "org/finos/fluxnova/bpm/engine/test/api/multitenancy/TenantIdProviderTest.camunda.cfg.xml";
  ...
  protected static final BpmnModelInstance FAILING_PROCESS = Bpmn.createExecutableProcess(PROCESS_DEFINITION_KEY).startEvent()
      .serviceTask()
        .fluxnovaClass("org.finos.fluxnova.bpm.engine.test.api.multitenancy.FailingDelegate")
        .fluxnovaAsyncBefore()
      .done();

  protected static final String DMN_FILE = "org/finos/fluxnova/bpm/engine/test/api/multitenancy/simpleDecisionTable.dmn";

  protected static final String CMMN_FILE = "org/finos/fluxnova/bpm/engine/test/api/multitenancy/CaseWithCaseTask.cmmn";
  protected static final String CMMN_FILE_WITH_MANUAL_ACTIVATION = "org/finos/fluxnova/bpm/engine/test/api/multitenancy/CaseWithCaseTaskWithManualActivation.cmmn";
  protected static final String CMMN_VARIABLE_FILE = "org/finos/fluxnova/bpm/engine/test/api/multitenancy/CaseWithCaseTaskVariables.cmmn";
  protected static final String CMMN_SUBPROCESS_FILE = "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn";
  ...
  public void providerCalledWithVariables_SubProcessInstance() {
    ...
    testRule.deploy(Bpmn.createExecutableProcess(PROCESS_DEFINITION_KEY).startEvent().done(),
        Bpmn.createExecutableProcess("superProcess").startEvent().callActivity().calledElement(PROCESS_DEFINITION_KEY).fluxnovaIn("varName", "varName").done());
  ...
  public void providerCalledForProcessDefinitionWithoutTenantId_ProcessTask() {
    ...
    testRule.deploy(
        ...
        "org/finos/fluxnova/bpm/engine/test/api/multitenancy/CaseWithProcessTask.cmmn");
  ...
  public void providerCalledForHistoricDecisionDefinitionWithoutTenantId_BusinessRuleTask() {
    ...
    BpmnModelInstance process = Bpmn.createExecutableProcess(PROCESS_DEFINITION_KEY)
      .startEvent()
      .businessRuleTask()
        .fluxnovaDecisionRef(DECISION_DEFINITION_KEY)
      .endEvent()
      .done();
  ...
  public void shouldHaveAccessToFormPropertiesFromTenantIdProvider() {
    ...
    BpmnModelInstance process = Bpmn.createExecutableProcess(PROCESS_DEFINITION_KEY)
        .startEvent().fluxnovaFormKey("embedded:app:forms/FORM_NAME.htmls")
        .userTask("UserTask")
        .endEvent()
        .done();
