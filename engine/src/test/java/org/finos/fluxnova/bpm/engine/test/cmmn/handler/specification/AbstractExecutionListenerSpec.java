...
import org.finos.fluxnova.bpm.model.cmmn.instance.CmmnModelElementInstance;
...
public abstract class AbstractExecutionListenerSpec {
  ...
  public void addListenerToElement(CmmnModelInstance modelInstance, CmmnModelElementInstance modelElement) {
    ...
    FluxnovaCaseExecutionListener caseExecutionListener = SpecUtil.createElement(modelInstance, extensionElements, null, FluxnovaCaseExecutionListener.class);

    if (!ANY_EVENT.equals(eventNameToRegisterOn)) {
      caseExecutionListener.setFluxnovaEvent(eventNameToRegisterOn);
    }
  ...
  protected abstract void configureCaseExecutionListener(CmmnModelInstance modelInstance, FluxnovaCaseExecutionListener listener);
