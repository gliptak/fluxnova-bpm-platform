...
import org.finos.fluxnova.bpm.engine.test.bpmn.tasklistener.util.CompletingTaskListener;
import org.finos.fluxnova.bpm.engine.test.bpmn.tasklistener.util.RecorderTaskListener;
import org.finos.fluxnova.bpm.engine.test.bpmn.tasklistener.util.RecorderTaskListener.RecordedTaskEvent;
import org.finos.fluxnova.bpm.engine.test.bpmn.tasklistener.util.TaskDeleteListener;
...
public class TaskListenerTest extends AbstractTaskListenerTest {
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/bpmn/tasklistener/TaskListenerTest.bpmn20.xml"})
  ...
  public void testCompleteTaskInCreateEventTaskListener() {
    ...
    BpmnModelInstance modelInstance =
        Bpmn.createExecutableProcess("startToEnd")
            .startEvent()
            .userTask()
            .fluxnovaTaskListenerClass(TaskListener.EVENTNAME_CREATE, CompletingTaskListener.class.getName())
            .name("userTask")
            .endEvent().done();
  ...
  public void testCompleteTaskInCreateEventTaskListenerWithIdentityLinks() {
    ...
    BpmnModelInstance modelInstance =
        Bpmn.createExecutableProcess("startToEnd")
            ...
            .fluxnovaTaskListenerClass(TaskListener.EVENTNAME_CREATE, CompletingTaskListener.class.getName())
            .name("userTask")
            .fluxnovaCandidateUsers(Arrays.asList(new String[]{"users1", "user2"}))
            .fluxnovaCandidateGroups(Arrays.asList(new String[]{"group1", "group2"}))
            .endEvent().done();
  ...
  public void testActivityInstanceIdOnDeleteInCalledProcess() {
    ...
    BpmnModelInstance calledProcess = Bpmn.createExecutableProcess("called")
                                          .startEvent()
                                          .userTask()
                                          .fluxnovaTaskListenerClass(TaskListener.EVENTNAME_CREATE, RecorderTaskListener.class.getName())
                                          .fluxnovaTaskListenerClass(TaskListener.EVENTNAME_DELETE, RecorderTaskListener.class.getName())
                                          .endEvent()
                                          .done();
  ...
  public void testVariableAccessOnDeleteInCalledProcess() {
    ...
    BpmnModelInstance calledProcess = Bpmn.createExecutableProcess("called")
                                          .startEvent()
                                          .userTask()
                                          .fluxnovaTaskListenerClass(TaskListener.EVENTNAME_DELETE, VariablesCollectingListener.class.getName())
                                          .endEvent()
                                          .done();
  ...
  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/test/bpmn/tasklistener/TaskListenerTest.testScriptResourceListener.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/test/bpmn/tasklistener/taskListener.groovy"
  })
  ...
  public void testUpdateTaskListenerInvokedBeforeConditionalEventsOnSetVariable() {
    ...
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess("process")
      .startEvent()
      .userTask("task")
        .fluxnovaTaskListenerClass(TaskListener.EVENTNAME_UPDATE, RecorderTaskListener.class)
      .boundaryEvent()
        .condition("${triggerBoundaryEvent}")
      .userTask("afterBoundaryEvent")
        .fluxnovaTaskListenerClass(TaskListener.EVENTNAME_CREATE, RecorderTaskListener.class)
      .endEvent()
      .moveToActivity("task")
      .endEvent()
      .done();
  ...
  @Test
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/bpmn/tasklistener/TaskListenerTest.testTimeoutTaskListenerDuration.bpmn20.xml")
  ...
  @Test
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/bpmn/tasklistener/TaskListenerTest.testRecalculateTimeoutTaskListenerDuedateCreationDateBased.bpmn20.xml")
