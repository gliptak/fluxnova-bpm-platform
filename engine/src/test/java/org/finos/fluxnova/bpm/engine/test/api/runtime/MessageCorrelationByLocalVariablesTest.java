        ...
        .startEvent()
          ...
          .startEvent()
            .receiveTask("MessageReceiver_1").message(TEST_MESSAGE_NAME)
              .fluxnovaInputParameter("localVar", "${loopVar}")
              .fluxnovaInputParameter("constVar", "someValue")   //to test array of parameters
            .userTask("UserTask_1")
          .endEvent()
          .subProcessDone()
          .multiInstance().fluxnovaCollection("${vars}").fluxnovaElementVariable("loopVar").multiInstanceDone()
        .endEvent().done();
