...
public class TaskListenerErrorThrowTest extends AbstractTaskListenerTest {
  ...
  public void testThrowErrorOnAssignmentExpressionListenerAndCatchOnUserTask() {
    ...
    BpmnModelInstance model = Bpmn.createExecutableProcess("process")
                                  .startEvent()
                                    .userTask("mainTask")
                                      .fluxnovaTaskListenerExpression(TaskListener.EVENTNAME_ASSIGNMENT, "${myListener.notify(task)}")
  ...
  public void testThrowUncaughtErrorOnCompleteAndCatchOnUserTask() {
    ...
    BpmnModelInstance model = Bpmn.createExecutableProcess("process")
                                  .startEvent()
                                    .userTask("mainTask")
                                      .fluxnovaTaskListenerClass(TaskListener.EVENTNAME_COMPLETE, ThrowBPMNErrorListener.class.getName())
                                      .fluxnovaTaskListenerClass(TaskListener.EVENTNAME_DELETE, RecorderTaskListener.class.getName())
                                    .userTask("afterThrow")
                                  .endEvent()
                                  .done();
  ...
  protected BpmnModelInstance createModelThrowErrorInListenerAndCatchOnUserTask(String eventName) {
    return Bpmn.createExecutableProcess("process")
               .startEvent()
                 .userTask("mainTask")
                   .fluxnovaTaskListenerClass(eventName, ThrowBPMNErrorListener.class.getName())
                   .fluxnovaTaskListenerClass(TaskListener.EVENTNAME_DELETE, RecorderTaskListener.class.getName())
                   .boundaryEvent("throw")
                     .error(ERROR_CODE)
                 .userTask("afterCatch")
