...
import static org.finos.fluxnova.bpm.engine.test.util.ExecutableProcessUtil.USER_TASK_PROCESS;
...
import org.finos.fluxnova.bpm.engine.test.api.runtime.util.SimpleSerializableBean;
import org.finos.fluxnova.bpm.engine.test.bpmn.executionlistener.RecorderExecutionListener;
import org.finos.fluxnova.bpm.engine.test.bpmn.executionlistener.RecorderExecutionListener.RecordedEvent;
import org.finos.fluxnova.bpm.engine.test.bpmn.tasklistener.util.RecorderTaskListener;
import org.finos.fluxnova.bpm.engine.test.history.SerializableVariable;
...
import org.finos.fluxnova.bpm.model.bpmn.builder.SubProcessBuilder;
...
public class RuntimeServiceTest {
  ...
  @Deployment(resources={
      "org/finos/fluxnova/bpm/engine/test/api/oneTaskProcessWithIoMappings.bpmn20.xml" })
  ...
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.testCascadingDeleteSubprocessInstanceSkipIoMappings.Calling.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.testCascadingDeleteSubprocessInstanceSkipIoMappings.Called.bpmn20.xml" })
  @RequiredHistoryLevel(ProcessEngineConfiguration.HISTORY_FULL)
  @Test
  ...
  @Deployment(resources={
    "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.testSignalWithProcessVariables.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={
          "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.catchAlertSignal.bpmn20.xml",
          "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.catchPanicSignal.bpmn20.xml"
  })
  @Test
  ...
  @Deployment(resources={
          "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.catchAlertMessage.bpmn20.xml",
          "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.catchPanicMessage.bpmn20.xml"
  })
  @Test
 ...
 @Test
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.testGetActivityInstancesForActivity.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.testGetTransitionInstancesForActivity.bpmn20.xml")
  @Test
  ...
  @Test
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.testActivityInstanceTreeForConcurrentAsyncAfterTask.bpmn20.xml"})
  ...
  @Test
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.testActivityInstanceForConcurrentSubprocess.bpmn20.xml"})
  ...
  @Test
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/oneAsyncTask.bpmn")
  ...
  public void testActivityInstanceIncidentOnNonLeafWithScopeActivity() {
    ...
    BpmnModelInstance process = ProcessModels.newModel("process")
      .startEvent()
      .subProcess("subProcess")
      .fluxnovaExecutionListenerClass(ExecutionListener.EVENTNAME_START, CreateIncidentDelegate.class)
      .embeddedSubProcess()
      .startEvent()
      .userTask("task")
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/runtime/messageStartEvent.bpmn20.xml")
  @Test
  public void testStartProcessInstanceByMessageWithEarlierVersionOfProcessDefinition() {
	  String deploymentId = repositoryService.createDeployment().addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/runtime/messageStartEvent_version2.bpmn20.xml").deploy().getId();
  ...
  public void testStartProcessInstanceByMessageWithNonExistingMessageStartEvent() {
	  ...
	  try {
		 deploymentId = repositoryService.createDeployment().addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/runtime/messageStartEvent_version2.bpmn20.xml").deploy().getId();
		 ProcessDefinition processDefinition = repositoryService.createProcessDefinitionQuery().processDefinitionVersion(1).singleResult();
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.testTransitionInstanceActivityNamePropertyBeforeTask.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.testTransitionInstanceActivityNamePropertyAfterTask.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.testTransitionInstanceActivityNamePropertyBeforeStartEvent.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.testTransitionInstanceActivityNamePropertyAfterStartEvent.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.testBasicVariableOperations.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/runtime/RuntimeServiceTest.testSetVariableInScope.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = {
      "org/finos/fluxnova/bpm/engine/test/api/runtime/trivial.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/runtime/rollbackAfterSubProcess.bpmn20.xml"})
  @Test
  ...
  public void testGetActivityInstanceForCompletedInstanceInDelegate() {
    ...
    BpmnModelInstance deletingProcess = Bpmn.createExecutableProcess("process1")
        ...
        .userTask()
        .serviceTask()
        .fluxnovaClass(DeleteInstanceDelegate.class.getName())
        .userTask()
        .endEvent()
        .done();
