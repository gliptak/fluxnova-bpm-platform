...
import org.finos.fluxnova.bpm.engine.test.bpmn.tasklistener.util.GetIdentityLinksTaskListener;
...
public class TaskIdentityLinksTest extends PluggableProcessEngineTest {
  ...
  public void testAssigneeGetIdentityLinksInCompleteListener() {
    ...
    BpmnModelInstance model = Bpmn.createExecutableProcess("process")
        ...
        .startEvent()
        .userTask("task1")
        .fluxnovaTaskListenerClass(TaskListener.EVENTNAME_COMPLETE, GetIdentityLinksTaskListener.class.getName())
        .userTask("task2")
        .endEvent()
        .done();
