...
import static org.finos.fluxnova.bpm.engine.test.api.runtime.util.SetBusinessKeyListener.BUSINESS_KEY_VARIABLE;
...
import org.finos.fluxnova.bpm.engine.test.api.runtime.util.SetBusinessKeyListener;
...
public class SetBusinessKeyTest {
  ...
  protected static final BpmnModelInstance SYNC_SERVICE_TASK_PROCESS =
      ...
      .serviceTask()
        .fluxnovaClass(SetBusinessKeyDelegate.class)
      .userTask("userTask2")
      .endEvent("endEvent")
      .done();
  ...
  protected BpmnModelInstance createModelExecutionListener(String listener) {
    ...
    .userTask("userTask1").name("User task")
      .fluxnovaExecutionListenerExpression(listener,
  ...
  protected BpmnModelInstance createModelTaskListener(String listener) {
    ...
    .startEvent("startEvent")
    .userTask("userTask1").name("User task")
      .fluxnovaTaskListenerClass(listener, SetBusinessKeyListener.class)
    .userTask("userTask2")
    .endEvent("endEvent")
    .done();
  }
