...
import org.finos.fluxnova.bpm.engine.impl.cmmn.behavior.DecisionTaskActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.cmmn.behavior.DmnDecisionTaskActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.cmmn.handler.CasePlanModelHandler;
import org.finos.fluxnova.bpm.engine.impl.cmmn.handler.DecisionTaskItemHandler;
...
import org.finos.fluxnova.bpm.engine.impl.dmn.result.ResultListDecisionTableResultMapper;
import org.finos.fluxnova.bpm.engine.impl.dmn.result.SingleResultDecisionResultMapper;
...
import org.finos.fluxnova.bpm.model.cmmn.instance.DecisionRefExpression;
...
import org.finos.fluxnova.bpm.model.cmmn.instance.Documentation;
...
public class DecisionTaskPlanItemHandlerTest extends CmmnElementHandlerTest {
  ...
  public void testBinding() {
    ...
    decisionTask.setFluxnovaDecisionBinding(caseBinding.getValue());
  ...
  public void testVersionConstant() {
    ...
    decisionTask.setFluxnovaDecisionVersion(caseVersion);
  ...
  public void testResultVariable() {
    // given:
    decisionTask.setFluxnovaResultVariable("aResultVariable");
  ...
  public void testMapDecisionResult() {
    // given:
    decisionTask.setFluxnovaMapDecisionResult("singleResult");
