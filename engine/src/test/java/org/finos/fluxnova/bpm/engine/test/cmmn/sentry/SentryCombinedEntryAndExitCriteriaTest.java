...
public class SentryCombinedEntryAndExitCriteriaTest extends CmmnTest {
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentSuspendInsideStage.cmmn"})
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentResumeInsideStageDifferentPlanItemOrder.cmmn"})
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentSuspendInsideStageDifferentPlanItemOrder.cmmn"})
