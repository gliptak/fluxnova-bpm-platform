...
import static org.finos.fluxnova.bpm.engine.impl.migration.validation.instruction.ConditionalEventUpdateEventTriggerValidator.MIGRATION_CONDITIONAL_VALIDATION_ERROR_MSG;
...
public class IncidentQueryTest {
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/runtime/IncidentQueryTest.testQueryByCauseIncidentId.bpmn"})
  ...
  @Test
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/api/runtime/IncidentQueryTest.testQueryByRootCauseIncidentId.bpmn",
      "org/finos/fluxnova/bpm/engine/test/api/runtime/IncidentQueryTest.testQueryByCauseIncidentId.bpmn"})
