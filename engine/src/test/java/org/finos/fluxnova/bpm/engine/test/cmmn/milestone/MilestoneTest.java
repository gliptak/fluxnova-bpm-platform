 ...
 */
package org.finos.fluxnova.bpm.engine.test.cmmn.milestone;
...
public class MilestoneTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/cmmn/milestone/MilestoneTest.testWithoutEntryCriterias.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/cmmn/milestone/MilestoneTest.testWithEntryCriteria.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/finos/fluxnova/bpm/engine/test/cmmn/milestone/MilestoneTest.testWithMultipleEntryCriterias.cmmn"})
  @Test
