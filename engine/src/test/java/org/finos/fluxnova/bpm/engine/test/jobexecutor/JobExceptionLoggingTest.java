...
public class JobExceptionLoggingTest {
  ...
  private static final String JOBEXECUTOR_LOGGER = "org.finos.fluxnova.bpm.engine.jobexecutor";
  ...
  @Test
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/jobexecutor/delegateThrowsException.bpmn20.xml")
  ...
  public void shouldNotLogExceptionWhenApiCallReducedLogging() {
    ...
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess("failingDelegate")
        .startEvent()
        .serviceTask()
          .fluxnovaClass("org.finos.fluxnova.bpm.engine.test.jobexecutor.FailingDelegate")
          .fluxnovaAsyncBefore()
        .done();
