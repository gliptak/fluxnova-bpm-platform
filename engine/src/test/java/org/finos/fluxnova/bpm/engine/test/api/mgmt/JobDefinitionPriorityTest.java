...
public class JobDefinitionPriorityTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/mgmt/asyncTaskProcess.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/finos/fluxnova/bpm/engine/test/api/mgmt/jobPrioProcess.bpmn20.xml")
  @Test
  ...
  public void testRedeployOverridesSetJobDefinitionPriority() {
    ...
    String secondDeploymentId = repositoryService.createDeployment().addClasspathResource("org/finos/fluxnova/bpm/engine/test/api/mgmt/jobPrioProcess.bpmn20.xml").deploy().getId();
