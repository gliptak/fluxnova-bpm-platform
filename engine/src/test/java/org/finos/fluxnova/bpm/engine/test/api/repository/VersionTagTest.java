...
public class VersionTagTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/api/repository/versionTag.dmn"})
  @Test
  ...
  @Deployment(resources={"org/finos/fluxnova/bpm/engine/test/api/repository/noVersionTag.dmn"})
  @Test
