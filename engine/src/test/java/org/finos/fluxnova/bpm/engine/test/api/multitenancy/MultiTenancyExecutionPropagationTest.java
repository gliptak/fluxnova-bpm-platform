...
public class MultiTenancyExecutionPropagationTest extends PluggableProcessEngineTest {
  ...
  protected static final String CMMN_FILE = "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCase.cmmn";
  protected static final String SET_VARIABLE_CMMN_FILE = "org/finos/fluxnova/bpm/engine/test/api/multitenancy/HumanTaskSetVariableExecutionListener.cmmn";
  ...
  public void testPropagateTenantIdToVariableInstanceFromExecution() {
    ...
    testRule.deployForTenant(TENANT_ID, Bpmn.createExecutableProcess(PROCESS_DEFINITION_KEY)
        .startEvent()
        .serviceTask()
          .fluxnovaClass(SetVariableTask.class.getName())
          .fluxnovaAsyncAfter()
        .endEvent()
      .done());
  ...
  public void testPropagateTenantIdToCompensationEventSubscription() {
    ...
    testRule.deployForTenant(TENANT_ID, "org/finos/fluxnova/bpm/engine/test/api/multitenancy/compensationBoundaryEvent.bpmn");
