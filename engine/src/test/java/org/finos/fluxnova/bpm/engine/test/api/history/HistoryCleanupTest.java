...
public class HistoryCleanupTest {
  ...
  public void init() {
    ...
    testRule.deploy("org/finos/fluxnova/bpm/engine/test/api/oneTaskProcess.bpmn20.xml", "org/finos/fluxnova/bpm/engine/test/api/dmn/Example.dmn", "org/finos/fluxnova/bpm/engine/test/api/cmmn/oneTaskCaseWithHistoryTimeToLive.cmmn");
  ...
  @Test
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testDecisionRef.bpmn20.xml",
      "org/finos/fluxnova/bpm/engine/test/api/history/testDmnWithPojo.dmn11.xml", "org/finos/fluxnova/bpm/engine/test/api/authorization/oneTaskCase.cmmn" })
  ...
  @Test
  @Deployment(resources = { "org/finos/fluxnova/bpm/engine/test/dmn/businessruletask/DmnBusinessRuleTaskTest.testDecisionRef.bpmn20.xml", "org/finos/fluxnova/bpm/engine/test/api/history/testDmnWithPojo.dmn11.xml", "org/finos/fluxnova/bpm/engine/test/api/authorization/oneTaskCase.cmmn"})
