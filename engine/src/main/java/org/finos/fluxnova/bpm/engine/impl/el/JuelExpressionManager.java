 ...
 */
package org.finos.fluxnova.bpm.engine.impl.el;
...
import org.finos.fluxnova.bpm.impl.juel.ExpressionFactoryImpl;
import org.finos.fluxnova.bpm.engine.impl.util.EnsureUtil;
import org.finos.fluxnova.bpm.engine.test.mock.MockElResolver;
...
public class JuelExpressionManager implements ExpressionManager, ElProviderCompatible {
  ...
  public ELContext getElContext(VariableScope variableScope) {
    ...
    if (elContext == null) {
      ...
      if (variableScope instanceof AbstractVariableScope scope) {
        scope.setCachedElContext(elContext);
      }
    }
