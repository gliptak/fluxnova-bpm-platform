...
import org.finos.fluxnova.bpm.engine.impl.core.delegate.CoreActivityBehavior;
...
import org.finos.fluxnova.bpm.engine.impl.pvm.delegate.MigrationObserverBehavior;
...
public class ActivityInstanceHandler implements MigratingInstanceParseHandler<ActivityInstance> {
  ...
  public void handle(MigratingInstanceParseContext parseContext, ActivityInstance element) {
    ...
    if (sourceActivityBehavior instanceof MigrationObserverBehavior behavior) {
      behavior.onParseMigratingInstance(parseContext, migratingInstance);
    }
