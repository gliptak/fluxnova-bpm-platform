...
import org.finos.fluxnova.bpm.engine.impl.bpmn.parser.ConditionalEventDefinition;
...
public class EventBasedGatewayActivityBehavior extends FlowNodeActivityBehavior {
  ...
  public void execute(ActivityExecution execution) throws Exception {
    ...
    for (ActivityImpl act : eventBasedGateway.getEventActivities()) {
      ...
      if (activityBehavior instanceof ConditionalEventBehavior conditionalEventBehavior) {
