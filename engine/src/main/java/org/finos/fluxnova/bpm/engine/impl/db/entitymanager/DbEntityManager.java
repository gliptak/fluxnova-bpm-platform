 ...
 */
package org.finos.fluxnova.bpm.engine.impl.db.entitymanager;

import static org.finos.fluxnova.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_MERGED;
import static org.finos.fluxnova.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_PERSISTENT;
import static org.finos.fluxnova.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_TRANSIENT;
import static org.finos.fluxnova.bpm.engine.impl.db.entitymanager.cache.DbEntityState.MERGED;
import static org.finos.fluxnova.bpm.engine.impl.db.entitymanager.cache.DbEntityState.PERSISTENT;
import static org.finos.fluxnova.bpm.engine.impl.db.entitymanager.cache.DbEntityState.TRANSIENT;
import static org.finos.fluxnova.bpm.engine.impl.db.entitymanager.operation.DbOperationType.DELETE;
import static org.finos.fluxnova.bpm.engine.impl.db.entitymanager.operation.DbOperationType.DELETE_BULK;
import static org.finos.fluxnova.bpm.engine.impl.db.entitymanager.operation.DbOperationType.INSERT;
import static org.finos.fluxnova.bpm.engine.impl.db.entitymanager.operation.DbOperationType.UPDATE;
import static org.finos.fluxnova.bpm.engine.impl.db.entitymanager.operation.DbOperationType.UPDATE_BULK;
...
import org.finos.fluxnova.bpm.engine.impl.DeploymentQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.ExecutionQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.GroupQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.HistoricActivityInstanceQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.HistoricDetailQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.HistoricJobLogQueryImpl;
...
import org.finos.fluxnova.bpm.engine.impl.JobQueryImpl;
...
import org.finos.fluxnova.bpm.engine.impl.UserQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.cfg.IdGenerator;
import org.finos.fluxnova.bpm.engine.impl.cfg.ProcessEngineConfigurationImpl;
import org.finos.fluxnova.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionQueryImpl;
...
import org.finos.fluxnova.bpm.engine.impl.db.EntityLoadListener;
import org.finos.fluxnova.bpm.engine.impl.db.FlushResult;
...
import org.finos.fluxnova.bpm.engine.impl.db.PersistenceSession;
import org.finos.fluxnova.bpm.engine.impl.db.entitymanager.cache.CachedDbEntity;
import org.finos.fluxnova.bpm.engine.impl.db.entitymanager.cache.DbEntityCache;
import org.finos.fluxnova.bpm.engine.impl.db.entitymanager.cache.DbEntityState;
import org.finos.fluxnova.bpm.engine.impl.db.entitymanager.operation.DbBulkOperation;
...
import org.finos.fluxnova.bpm.engine.impl.db.entitymanager.operation.DbOperation.State;
import org.finos.fluxnova.bpm.engine.impl.db.entitymanager.operation.DbOperationManager;
import org.finos.fluxnova.bpm.engine.impl.db.entitymanager.operation.DbOperationType;
...
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.JobExecutorContext;
