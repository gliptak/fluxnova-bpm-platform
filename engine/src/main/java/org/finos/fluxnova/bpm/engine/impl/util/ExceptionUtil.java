...
import static org.finos.fluxnova.bpm.engine.impl.util.ExceptionUtil.DEADLOCK_CODES.DB2;
import static org.finos.fluxnova.bpm.engine.impl.util.ExceptionUtil.DEADLOCK_CODES.H2;
import static org.finos.fluxnova.bpm.engine.impl.util.ExceptionUtil.DEADLOCK_CODES.MSSQL;
import static org.finos.fluxnova.bpm.engine.impl.util.ExceptionUtil.DEADLOCK_CODES.MYSQL;
import static org.finos.fluxnova.bpm.engine.impl.util.ExceptionUtil.DEADLOCK_CODES.ORACLE;
import static org.finos.fluxnova.bpm.engine.impl.util.ExceptionUtil.DEADLOCK_CODES.POSTGRES;
...
import org.finos.fluxnova.bpm.engine.repository.ResourceType;
...
public class ExceptionUtil {
  ...
  public static SQLException unwrapException(ProcessEngineException genericPersistenceException) {
    ...
    if (cause instanceof ProcessEngineException processEngineException) {
      ...
      if (processEngineExceptionCause instanceof PersistenceException exception) {
    ...
    } else if (cause instanceof PersistenceException exception) {
      return unwrapException(exception);
  ...
  public static BatchExecutorException findBatchExecutorException(PersistenceException exception) {
    ...
    do {
      if (cause instanceof BatchExecutorException executorException) {
