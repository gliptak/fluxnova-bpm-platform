 ...
 */
package org.finos.fluxnova.bpm.engine.impl.cmmn.transformer;
...
import org.finos.fluxnova.bpm.engine.impl.cmmn.handler.CmmnElementHandler;
import org.finos.fluxnova.bpm.engine.impl.cmmn.handler.CmmnHandlerContext;
...
import org.finos.fluxnova.bpm.engine.impl.core.transformer.Transform;
...
import org.finos.fluxnova.bpm.model.cmmn.CmmnModelException;
...
import org.finos.fluxnova.bpm.model.cmmn.instance.PlanFragment;
...
public class CmmnTransform implements Transform<CaseDefinitionEntity> {
  ...
  protected void transformCasePlanModel(CasePlanModel casePlanModel) {
    ...
    for (CmmnTransformListener transformListener : transformListeners) {
      transformListener.transformCasePlanModel((org.finos.fluxnova.bpm.model.cmmn.impl.instance.CasePlanModel) casePlanModel, newActivity);
    }
  }
