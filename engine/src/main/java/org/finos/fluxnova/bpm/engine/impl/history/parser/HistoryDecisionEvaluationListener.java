 ...
 */
package org.finos.fluxnova.bpm.engine.impl.history.parser;
...
import org.finos.fluxnova.bpm.engine.impl.context.CoreExecutionContext;
...
public class HistoryDecisionEvaluationListener implements DmnDecisionEvaluationListener {
  ...
  protected boolean isDeployedDecisionTable(DmnDecision decision) {
    if(decision instanceof DecisionDefinition definition) {
