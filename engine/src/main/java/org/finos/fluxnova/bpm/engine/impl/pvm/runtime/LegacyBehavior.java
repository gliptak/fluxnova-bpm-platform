 ...
 */
package org.finos.fluxnova.bpm.engine.impl.pvm.runtime;

import static org.finos.fluxnova.bpm.engine.impl.bpmn.helper.CompensationUtil.SIGNAL_COMPENSATION_DONE;
...
import org.finos.fluxnova.bpm.engine.impl.cmd.GetActivityInstanceCmd;
...
import org.finos.fluxnova.bpm.engine.impl.tree.ExecutionWalker;
import org.finos.fluxnova.bpm.engine.impl.tree.ReferenceWalker;
      ...
      if (flowScope != null) {
        ...
        if (flowScope != null) {
          if (flowScope == endedExecution.getActivity().getProcessDefinition()) {
            ...
            if (activityBehavior instanceof CompositeActivityBehavior behavior) {
              behavior.concurrentChildExecutionEnded(scopeExecution, endedExecution);
            }
          }
        }
      }
