...
import org.finos.fluxnova.bpm.engine.impl.cmmn.transformer.CmmnTransformerLogger;
...
import org.finos.fluxnova.bpm.model.cmmn.Query;
import org.finos.fluxnova.bpm.model.cmmn.VariableTransition;
import org.finos.fluxnova.bpm.model.cmmn.instance.CaseFileItemOnPart;
...
import org.finos.fluxnova.bpm.model.cmmn.instance.OnPart;
...
public class SentryHandler extends CmmnElementHandler<Sentry, CmmnSentryDeclaration> {
  ...
  public CmmnSentryDeclaration handleElement(Sentry element, CmmnHandlerContext context) {
    ...
    List<FluxnovaVariableOnPart> variableOnParts = queryExtensionElementsByClass(element, FluxnovaVariableOnPart.class);
  ...
  protected void initializeVariableOnParts(CmmnElement element, CmmnSentryDeclaration sentryDeclaration, 
    CmmnHandlerContext context, List<FluxnovaVariableOnPart> variableOnParts) {
    for(FluxnovaVariableOnPart variableOnPart: variableOnParts) {
      initializeVariableOnPart(variableOnPart, sentryDeclaration, context);
    }
  }

  protected void initializeVariableOnPart(FluxnovaVariableOnPart variableOnPart, CmmnSentryDeclaration sentryDeclaration, CmmnHandlerContext context) {
