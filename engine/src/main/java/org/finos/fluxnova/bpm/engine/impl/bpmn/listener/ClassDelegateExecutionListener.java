...
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.ServiceTaskJavaDelegateActivityBehavior;
...
import org.finos.fluxnova.bpm.engine.impl.delegate.ClassDelegate;
...
public class ClassDelegateExecutionListener extends ClassDelegate implements ExecutionListener {
  ...
  protected ExecutionListener getExecutionListenerInstance() {
    ...
    if (delegateInstance instanceof ExecutionListener listener) {
      return listener;
