...
import org.finos.fluxnova.bpm.engine.impl.BootstrapEngineCommand;
import org.finos.fluxnova.bpm.engine.impl.HistoryLevelSetupCommand;
import org.finos.fluxnova.bpm.engine.impl.SchemaOperationsProcessEngineBuild;
import org.finos.fluxnova.bpm.engine.impl.cfg.BeansConfigurationHelper;
...
public abstract class ProcessEngineConfiguration {
   ...
   *
   * <p>By default only alphanumeric values (or 'fluxnova-admin') will be accepted.</p>
   */
  protected String generalResourceWhitelistPattern =  "[a-zA-Z0-9]+|fluxnova-admin";
   ...
   * values (or 'fluxnova-admin') will be accepted.</p>
   */
