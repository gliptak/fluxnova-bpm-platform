 ...
 */
package org.finos.fluxnova.bpm.engine.impl.context;

import org.finos.fluxnova.bpm.application.ProcessApplicationReference;
import org.finos.fluxnova.bpm.application.impl.ProcessApplicationLogger;
...
import org.finos.fluxnova.bpm.engine.impl.repository.ResourceDefinitionEntity;
...
public class ProcessApplicationContextUtil {
  ...
  public static ProcessApplicationReference getTargetProcessApplication(CoreExecution execution) {
    if (execution instanceof ExecutionEntity entity) {
      return getTargetProcessApplication(entity);
    } else {
