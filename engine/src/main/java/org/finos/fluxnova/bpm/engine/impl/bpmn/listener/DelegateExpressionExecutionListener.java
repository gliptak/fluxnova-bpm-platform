 ...
 */
package org.finos.fluxnova.bpm.engine.impl.bpmn.listener;

import static org.finos.fluxnova.bpm.engine.impl.util.ClassDelegateUtil.applyFieldDeclaration;
...
import org.finos.fluxnova.bpm.engine.impl.bpmn.delegate.ExecutionListenerInvocation;
import org.finos.fluxnova.bpm.engine.impl.bpmn.delegate.JavaDelegateInvocation;
...
public class DelegateExpressionExecutionListener implements ExecutionListener {
  ...
  public void notify(DelegateExecution execution) throws Exception {
    ...
    if (delegate instanceof ExecutionListener listener) {
