 ...
 */
package org.finos.fluxnova.bpm.engine.impl.migration.instance;

import java.util.Collection;
import java.util.LinkedList;

import org.finos.fluxnova.bpm.engine.impl.migration.instance.MigratingProcessElementInstanceTopDownWalker.MigrationContext;
...
public class MigratingProcessElementInstanceTopDownWalker extends ReferenceWalker<MigrationContext> {
  ...
  protected Collection<MigrationContext> nextElements() {
    ...
    if (currentElement.processElementInstance instanceof MigratingScopeInstance scopeInstance) {
