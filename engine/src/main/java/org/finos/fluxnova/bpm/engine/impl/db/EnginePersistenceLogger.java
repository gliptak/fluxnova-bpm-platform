 ...
 */
package org.finos.fluxnova.bpm.engine.impl.db;
...
import org.finos.fluxnova.bpm.engine.WrongDbException;
import org.finos.fluxnova.bpm.engine.authorization.MissingAuthorization;
...
public class EnginePersistenceLogger extends ProcessEngineLogger {
  ...
  public AuthorizationException requiredFluxnovaAdmin() {
    return requiredFluxnovaAdminOrPermissionException(null);
  }

  public AuthorizationException requiredFluxnovaAdminOrPermissionException(List<MissingAuthorization> missingAuthorizations) {
  ...
  public ProcessEngineException multipleTenantsForFluxnovaFormDefinitionKeyException(String camundaFormDefinitionKey) {
    return new ProcessEngineException(exceptionMessage(
        "109",
