 ...
 */
package org.finos.fluxnova.bpm.engine.impl.migration.instance.parser;
...
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.TimerEventJobHandler.TimerJobConfiguration;
...
import org.finos.fluxnova.bpm.engine.impl.migration.instance.EmergingJobInstance;
import org.finos.fluxnova.bpm.engine.impl.migration.instance.MigratingActivityInstance;
import org.finos.fluxnova.bpm.engine.impl.migration.instance.MigratingJobInstance;
import org.finos.fluxnova.bpm.engine.impl.migration.instance.MigratingTimerJobInstance;
...
public class ActivityInstanceJobHandler implements MigratingDependentInstanceParseHandler<MigratingActivityInstance, List<JobEntity>> {
  ...
  protected static boolean isTimeoutListenerJobInTargetScope(JobHandlerConfiguration jobHandlerConfiguration,
      String targetActivity, Map<String, Map<String, TimerDeclarationImpl>> targetTimeoutListenerDeclarationsInEventScope) {
    return jobHandlerConfiguration instanceof TimerJobConfiguration tjc &&
        ...
        targetTimeoutListenerDeclarationsInEventScope.get(targetActivity).containsKey(
            tjc.getTimerElementSecondaryKey());
  }
