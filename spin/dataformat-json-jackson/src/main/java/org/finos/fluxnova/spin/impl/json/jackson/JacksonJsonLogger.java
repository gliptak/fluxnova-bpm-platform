...
import org.finos.fluxnova.spin.impl.logging.SpinLogger;
...
public class JacksonJsonLogger extends SpinLogger {
  ...
  public static final JacksonJsonLogger JSON_TREE_LOGGER = BaseLogger.createLogger(JacksonJsonLogger.class, PROJECT_CODE, "org.finos.fluxnova.spin.json", "01");
