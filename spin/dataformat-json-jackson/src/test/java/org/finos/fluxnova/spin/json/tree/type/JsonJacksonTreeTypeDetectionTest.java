 ...
 */
package org.finos.fluxnova.spin.json.tree.type;
...
import org.finos.fluxnova.spin.impl.json.jackson.format.MapJacksonJsonTypeDetector;
import org.finos.fluxnova.spin.impl.json.jackson.format.SetJacksonJsonTypeDetector;
import org.finos.fluxnova.spin.json.mapping.Customer;
...
public class JsonJacksonTreeTypeDetectionTest {
  ...
  public void shouldDetectTypeFromObject() {
    ...
    assertThat(canonicalTypeString).isEqualTo("org.finos.fluxnova.spin.json.mapping.RegularCustomer");
  }
  ...
  public void shouldDetectListType() {
    ...
    assertThat(canonicalTypeString).isEqualTo("java.util.ArrayList<org.finos.fluxnova.spin.json.mapping.RegularCustomer>");
  }
  ...
  public void shouldDetectSetType() {
    ...
    assertThat(canonicalTypeString).isEqualTo("java.util.HashSet<org.finos.fluxnova.spin.json.mapping.RegularCustomer>");
  }
  ...
  public void shouldDetectMapType() {
    ...
    assertThat(canonicalTypeString).isEqualTo("java.util.Map<java.lang.String,org.finos.fluxnova.spin.json.mapping.RegularCustomer>");
  }
  ...
  public void shouldHandleListOfLists() {
    ...
    assertThat(canonicalTypeString).isEqualTo("java.util.ArrayList<java.util.ArrayList<org.finos.fluxnova.spin.json.mapping.RegularCustomer>>");
  }
  ...
  public void shouldHandleSetOfSets() {
    ...
    assertThat(canonicalTypeString).isEqualTo("java.util.HashSet<java.util.HashSet<org.finos.fluxnova.spin.json.mapping.RegularCustomer>>");
  }
  ...
  public void shouldHandleSetOfLists() {
    ...
    String canonicalTypeString =
        dataFormatWithSetTypeDetector.getCanonicalTypeName(nestedCustomers);
    assertThat(canonicalTypeString).isEqualTo("java.util.HashSet<java.util.ArrayList<org.finos.fluxnova.spin.json.mapping.RegularCustomer>>");
  }
  ...
  public void shouldHandleMapOfMaps() {
    ...
    assertThat(canonicalTypeString).isEqualTo("java.util.Map<java.lang.String,java.util.Map<java.lang.Integer,org.finos.fluxnova.spin.json.mapping.RegularCustomer>>");
  }
