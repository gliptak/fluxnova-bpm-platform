 ...
 */
package org.finos.fluxnova.bpm.engine.spring.test.expression.callactivity;
 ...
 */
@ContextConfiguration("classpath:org/finos/fluxnova/bpm/engine/spring/test/expression/callactivity/testCallActivityByExpression-context.xml")
public class CallActivityBasedOnSpringBeansExpressionTest extends SpringProcessEngineTestCase {

  @Deployment(resources = {
    "org/finos/fluxnova/bpm/engine/spring/test/expression/callactivity/CallActivityBasedOnSpringBeansExpressionTest.testCallActivityByExpression.bpmn20.xml",
    "org/finos/fluxnova/bpm/engine/spring/test/expression/callactivity/simpleSubProcess.bpmn20.xml"})
  @Test
