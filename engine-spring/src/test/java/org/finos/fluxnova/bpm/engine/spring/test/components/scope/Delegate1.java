...
public class Delegate1 implements JavaDelegate,InitializingBean {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		Assertions.assertNotNull(statefulObject, "the 'scopedCustomer' reference can't be null");
	...
	public void afterPropertiesSet() throws Exception {
	 Assertions.assertNotNull(this.processInstance, "the processInstance must not be null") ;
