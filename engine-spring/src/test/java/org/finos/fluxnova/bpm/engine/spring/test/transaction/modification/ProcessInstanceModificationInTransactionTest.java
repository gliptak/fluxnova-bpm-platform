 ...
 */
package org.finos.fluxnova.bpm.engine.spring.test.transaction.modification;
...
@SpringJUnitConfig(locations = {"classpath:org/finos/fluxnova/bpm/engine/spring/test/transaction/ProcessInstanceModificationInTransactionTest-applicationContext.xml"})
  ...
  public void shouldBeAbleToPerformModification() {
    ...
    BpmnModelInstance modelInstance = Bpmn.createExecutableProcess("TestProcess")
      ...
      .intermediateCatchEvent("TimerEvent")
        ...
        .fluxnovaExecutionListenerDelegateExpression("end", "${deleteVariableListener}")
      .endEvent()
      .done();
