 ...
 */
package org.finos.fluxnova.bpm.engine.spring.application;

import java.util.logging.Level;
import java.util.logging.Logger;
import jakarta.servlet.ServletContext;
import org.finos.fluxnova.bpm.application.AbstractProcessApplication;
import org.finos.fluxnova.bpm.application.ProcessApplicationElResolver;
import org.finos.fluxnova.bpm.application.impl.EjbProcessApplication;
import org.finos.fluxnova.bpm.engine.spring.ApplicationContextElResolver;
 ...
 *    <li>Bootstrapping through {@link org.finos.fluxnova.bpm.application.impl.ServletProcessApplication}. In this case we have access to the {@link ServletContext}
...
public class SpringProcessApplicationElResolver implements ProcessApplicationElResolver {
  ...
  public ELResolver getElResolver(AbstractProcessApplication processApplication) {
    ...
    } else if (processApplication instanceof org.finos.fluxnova.bpm.application.impl.ServletProcessApplication) {
      // Using fully-qualified class name instead of import statement to allow for automatic transformation
      org.finos.fluxnova.bpm.application.impl.ServletProcessApplication servletProcessApplication = (org.finos.fluxnova.bpm.application.impl.ServletProcessApplication) processApplication;
