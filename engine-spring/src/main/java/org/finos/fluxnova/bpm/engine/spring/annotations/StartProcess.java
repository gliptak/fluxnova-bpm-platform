 ...
 */
package org.finos.fluxnova.bpm.engine.spring.annotations;
...
public @interface StartProcess {
	...
	/**
	 * returns the ID of the {@link org.finos.fluxnova.bpm.engine.runtime.ProcessInstance}. If specified, it'll only work if
	 * the return type of the invocation is compatabile with a {@link org.finos.fluxnova.bpm.engine.runtime.ProcessInstance}'s ID
