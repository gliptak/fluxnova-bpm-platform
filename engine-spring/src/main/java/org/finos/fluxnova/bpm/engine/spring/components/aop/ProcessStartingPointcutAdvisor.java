...
import org.finos.fluxnova.bpm.engine.spring.components.aop.util.MetaAnnotationMatchingPointcut;
 ...
 * type of {@link org.finos.fluxnova.bpm.engine.runtime.ProcessInstance} and then subsequently
...
public class ProcessStartingPointcutAdvisor implements PointcutAdvisor, Serializable {
	...
	/**
	 * the injected reference to the {@link org.finos.fluxnova.bpm.engine.ProcessEngine}
	 */
