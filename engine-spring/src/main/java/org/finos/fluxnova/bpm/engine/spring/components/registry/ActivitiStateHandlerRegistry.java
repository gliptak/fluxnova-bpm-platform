 ...
 */
package org.finos.fluxnova.bpm.engine.spring.components.registry;
...
/**
 * this class records and manages all known {@link org.finos.fluxnova.bpm.engine.annotations.State} - responding
...
public class ActivitiStateHandlerRegistry extends ReceiveTaskActivityBehavior implements BeanFactoryAware, BeanNameAware, ActivityBehavior, InitializingBean {
	...
	protected String registrationKey(String stateName, String processName) {
		return (org.finos.fluxnova.commons.utils.StringUtil.defaultString(processName) +
				":" + org.finos.fluxnova.commons.utils.StringUtil.defaultString(stateName)).toLowerCase();
	}

	/**
	 * used at runtime to register state handlers as they are registered with the spring context
	 *
	 * @param registration the {@link org.finos.fluxnova.bpm.engine.test.spring.components.registry.ActivitiStateHandlerRegistration}
	 */
	 ...
	 * on specificity of the {@link org.finos.fluxnova.bpm.engine.test.spring.components.registry.ActivitiStateHandlerRegistration}
	 *
	 ...
	 * @return an unambiguous {@link org.finos.fluxnova.bpm.engine.test.spring.components.registry.ActivitiStateHandlerRegistry} or null
	 */
