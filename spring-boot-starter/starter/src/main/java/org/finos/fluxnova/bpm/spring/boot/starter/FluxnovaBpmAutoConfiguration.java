...
import org.finos.fluxnova.bpm.spring.boot.starter.event.ProcessApplicationEventPublisher;
...
@Import({
  FluxnovaBpmConfiguration.class,
  FluxnovaBpmActuatorConfiguration.class,
  FluxnovaBpmPluginConfiguration.class,
  FluxnovaBpmTelemetryConfiguration.class,
...
public class FluxnovaBpmAutoConfiguration {
  ...
  @Bean
  public FluxnovaBpmVersion fluxnovaBpmVersion() {
    return new FluxnovaBpmVersion();
  }
