...
public class IdGeneratorConfiguration {
  ...
  @ConditionalOnProperty(prefix = FluxnovaBpmProperties.PREFIX, name = PROPERTY_NAME, havingValue = STRONG, matchIfMissing = true)
  ...
  @Bean
  @ConditionalOnMissingBean(IdGenerator.class)
  @ConditionalOnProperty(prefix = FluxnovaBpmProperties.PREFIX, name = PROPERTY_NAME, havingValue = PREFIXED)
