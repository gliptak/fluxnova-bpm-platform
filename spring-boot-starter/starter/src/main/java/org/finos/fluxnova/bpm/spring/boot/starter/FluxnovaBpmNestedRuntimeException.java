 ...
 * </p>
 */
public class FluxnovaBpmNestedRuntimeException extends NestedRuntimeException {
   ...
   */
  public FluxnovaBpmNestedRuntimeException(final String msg) {
    super(msg);
  }
   ...
   */
  public FluxnovaBpmNestedRuntimeException(final String msg, final Throwable cause) {
    super(msg, cause);
  }
