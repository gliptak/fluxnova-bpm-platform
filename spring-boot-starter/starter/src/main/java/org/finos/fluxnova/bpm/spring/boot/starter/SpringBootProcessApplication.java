...
import static org.finos.fluxnova.bpm.application.ProcessApplicationInfo.PROP_SERVLET_CONTEXT_PATH;
import static org.finos.fluxnova.bpm.spring.boot.starter.util.GetProcessApplicationNameFromAnnotation.processApplicationNameFromAnnotation;
import static org.finos.fluxnova.bpm.spring.boot.starter.util.SpringBootProcessEngineLogger.LOG;
...
public class SpringBootProcessApplication extends SpringProcessApplication {
  ...
  @Bean
  public static FluxnovaDeploymentConfiguration deploymentConfiguration() {
    return new FluxnovaDeploymentConfiguration() {
      @Override
  ...
  @Autowired
  protected FluxnovaBpmProperties camundaBpmProperties;
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    if (camundaBpmProperties.getGenerateUniqueProcessApplicationName()) {
      setBeanName(FluxnovaBpmProperties.getUniqueName(FluxnovaBpmProperties.UNIQUE_APPLICATION_NAME_PREFIX));
    }
