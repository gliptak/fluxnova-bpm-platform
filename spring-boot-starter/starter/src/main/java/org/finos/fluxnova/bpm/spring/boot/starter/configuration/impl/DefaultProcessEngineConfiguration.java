...
public class DefaultProcessEngineConfiguration extends AbstractFluxnovaConfiguration implements FluxnovaProcessEngineConfiguration {
  ...
  private void setProcessEngineName(SpringProcessEngineConfiguration configuration) {
    ...
    if (!ObjectUtils.isEmpty(processEngineName) && !processEngineName.contains("-")) {
      ...
      if (camundaBpmProperties.getGenerateUniqueProcessEngineName()) {
        ...
        processEngineName = FluxnovaBpmProperties.getUniqueName(camundaBpmProperties.UNIQUE_ENGINE_NAME_PREFIX);
      }
