...
import static org.finos.fluxnova.bpm.spring.boot.starter.property.FluxnovaBpmProperties.PREFIX;
 ...
 */
public class FluxnovaBpmVersion implements Supplier<String> {
  ...
  public FluxnovaBpmVersion() {
    this(ProcessEngine.class.getPackage());
  }

  FluxnovaBpmVersion(final Package pkg) {
