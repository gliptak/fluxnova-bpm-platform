...
@TestPropertySource(properties = {
  "fluxnova.bpm.webapp.indexRedirectEnabled=false",
  "fluxnova.bpm.webapp.csrf.targetOrigin=localhost:8080",
  "fluxnova.bpm.webapp.csrf.denyStatus=405",
  "fluxnova.bpm.webapp.csrf.randomClass=java.util.Random",
  "fluxnova.bpm.webapp.csrf.entryPoints[0]=/api/engine/engine/default/history/task/count",
  "fluxnova.bpm.webapp.csrf.entryPoints[1]=/api/engine/engine/default/history/variable/count"
})
