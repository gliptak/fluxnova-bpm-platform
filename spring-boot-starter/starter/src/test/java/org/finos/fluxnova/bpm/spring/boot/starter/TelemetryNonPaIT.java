...
public class TelemetryNonPaIT extends AbstractFluxnovaAutoConfigurationIT {
  ...
  @Test
  public void shouldAddFluxnovaIntegration() {
    ...
    assertThat(camundaIntegration).containsExactly(FluxnovaIntegration.SPRING_BOOT_STARTER);
  }
