...
@SpringBootTest(
  ...
  properties = {
    "fluxnova.bpm.id-generator=" + PREFIXED,
...
public class PrefixedUuidGeneratorIT {
  ...
  @Autowired
  private FluxnovaBpmProperties properties;
  ...
  public void configured_idGenerator_is_uuid() throws Exception {
    final IdGenerator idGenerator = FluxnovaSpringBootUtil.get(processEngine).getIdGenerator();
