...
public class FluxnovaBpmPropertiesTest {
  ...
  public void initResourcePatterns() {
    final String[] patterns = FluxnovaBpmProperties.initDeploymentResourcePattern();
  ...
  public void restrict_allowed_values_for_dbUpdate() {
    new FluxnovaBpmProperties().getDatabase().setSchemaUpdate(ProcessEngineConfiguration.DB_SCHEMA_UPDATE_TRUE);
    new FluxnovaBpmProperties().getDatabase().setSchemaUpdate(ProcessEngineConfiguration.DB_SCHEMA_UPDATE_FALSE);
    new FluxnovaBpmProperties().getDatabase().setSchemaUpdate(ProcessEngineConfigurationImpl.DB_SCHEMA_UPDATE_CREATE);
