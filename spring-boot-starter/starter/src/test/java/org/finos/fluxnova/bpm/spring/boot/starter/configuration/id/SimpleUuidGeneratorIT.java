...
import static org.finos.fluxnova.bpm.spring.boot.starter.configuration.id.IdGeneratorConfiguration.SIMPLE;

@SpringBootTest(classes = { TestApplication.class }, properties = "fluxnova.bpm.id-generator=" + SIMPLE)
