 ...
 */
package org.finos.fluxnova.bpm.spring.boot.starter.property.headersec;

import org.finos.fluxnova.bpm.spring.boot.starter.property.HeaderSecurityProperties;
...
@TestPropertySource(properties = {
  "fluxnova.bpm.webapp.headerSecurity.xssProtectionValue=aValue",
  "fluxnova.bpm.webapp.headerSecurity.contentSecurityPolicyValue=aValue",
  "fluxnova.bpm.webapp.headerSecurity.contentTypeOptionsValue=aValue",
  "fluxnova.bpm.webapp.headerSecurity.hstsValue=aValue"
})
