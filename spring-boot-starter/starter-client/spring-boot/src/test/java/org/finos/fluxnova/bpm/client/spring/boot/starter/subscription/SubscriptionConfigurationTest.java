 ...
 */
package org.finos.fluxnova.bpm.client.spring.boot.starter.subscription;
...
@TestPropertySource(properties = {
    "fluxnova.bpm.client.subscriptions.topic-one.auto-open=false",
    "fluxnova.bpm.client.subscriptions.topic-one.lock-duration=555",
    "fluxnova.bpm.client.subscriptions.topic-one.variable-names=var-one,var-two",
    "fluxnova.bpm.client.subscriptions.topic-one.local-variables=true",
    "fluxnova.bpm.client.subscriptions.topic-one.business-key=business-key",
    "fluxnova.bpm.client.subscriptions.topic-one.process-definition-id=definition-id",
    "fluxnova.bpm.client.subscriptions.topic-one.process-definition-id-in=id-one,id-two",
    "fluxnova.bpm.client.subscriptions.topic-one.process-definition-key=key",
    "fluxnova.bpm.client.subscriptions.topic-one.process-definition-key-in=key-one,key-two",
    "fluxnova.bpm.client.subscriptions.topic-one.process-definition-version-tag=version-tag",
    "fluxnova.bpm.client.subscriptions.topic-one.process-variables.var-name-foo=var-val-foo",
    "fluxnova.bpm.client.subscriptions.topic-one.process-variables.var-name-bar=var-val-bar",
    "fluxnova.bpm.client.subscriptions.topic-one.without-tenant-id=true",
    "fluxnova.bpm.client.subscriptions.topic-one.tenant-id-in=tenant-id-one,tenant-id-two",
    "fluxnova.bpm.client.subscriptions.topic-one.include-extension-properties=true",

    "fluxnova.bpm.client.subscriptions.topic-two.lock-duration=6666",
})
