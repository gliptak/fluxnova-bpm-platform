...
import org.finos.fluxnova.bpm.spring.boot.starter.security.oauth2.impl.SsoLogoutSuccessHandler;
...
public class FluxnovaSpringSecurityOAuth2AutoConfiguration {
  ...
  private static final Logger logger = LoggerFactory.getLogger(FluxnovaSpringSecurityOAuth2AutoConfiguration.class);
  public static final int CAMUNDA_OAUTH2_ORDER = Ordered.HIGHEST_PRECEDENCE + 100;
  private final OAuth2Properties oAuth2Properties;
  private final String webappPath;

  public FluxnovaSpringSecurityOAuth2AutoConfiguration(FluxnovaBpmProperties properties,
