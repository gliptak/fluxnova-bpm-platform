 ...
 */
public class FluxnovaBpmRestInitializer implements ServletContextInitializer {

  private static final Logger log = LoggerFactory.getLogger(FluxnovaBpmRestInitializer.class);
