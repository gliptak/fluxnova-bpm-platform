 ...
 */
package org.finos.fluxnova.bpm.engine.test.variables;
...
public class FileValueTypeImplTest {
  ...
  public void createValueFromFile() throws URISyntaxException {
    File file = new File(this.getClass().getClassLoader().getResource("org/finos/fluxnova/bpm/engine/test/variables/simpleFile.txt").toURI());
  ...
  public void createValueWithNullProperties() {
    ...
    // given
    file = this.getClass().getClassLoader().getResourceAsStream("org/finos/fluxnova/bpm/engine/test/variables/simpleFile.txt");
